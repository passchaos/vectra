...
and `withRowSoftmaxConcentration` plus `withRowSoftmaxGiniImpurity`/`withRowSoftmaxGini`
expose the quadratic concentration/impurity of the softmax distribution.
