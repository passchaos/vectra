...
logit mass on the same log scale. `withRowSoftmax` appends one probability
...
expose raw and width-normalized quadratic concentration, while
`withRowSoftmaxGiniImpurity`/`withRowSoftmaxGini` return the complementary impurity.
