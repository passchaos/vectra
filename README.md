...
`fillNullColumn`, `fillNaNColumn`, `fillInfColumn`, `fillPositiveInfColumn`, `fillNegativeInfColumn`, `fillZeroColumn`, `fillNonZeroColumn`, `fillFiniteColumn`, `fillNormalColumn`, `fillSubnormalColumn`, `fillNonFiniteColumn`, `coalesceColumns`, `dropNulls`, `filterNullsColumn`, `dropNaNs`, `dropNaNsColumn`, `filterNaNsColumn`, `dropInfs`, `dropInfsColumn`, `filterInfsColumn`, `dropPositiveInfs`, `dropPositiveInfsColumn`, `filterPositiveInfsColumn`, `dropNegativeInfs`, `dropNegativeInfsColumn`, `filterNegativeInfsColumn`, `dropZeros`, `dropZerosColumn`, `filterZerosColumn`, `dropNonZeros`, `dropNonZerosColumn`, `filterNonZerosColumn`, `dropPositives`, `dropPositivesColumn`, `filterPositivesColumn`, `dropNegatives`, `dropNegativesColumn`, `filterNegativesColumn`, `dropFinites`, `dropFinitesColumn`, `filterFinitesColumn`, `dropNormals`, `dropNormalsColumn`, `filterNormalsColumn`, `dropSubnormals`, `dropSubnormalsColumn`, `filterSubnormalsColumn`, `dropNonFinites`, `dropNonFinitesColumn`, `filterNonFinitesColumn`, `isNullColumn`, `isValidColumn`, `isNanColumn`, `isZeroColumn`, `isNonZeroColumn`, `isPositiveColumn`, `isNegativeColumn`, `isInfColumn`, `isPositiveInfColumn`, `isNegativeInfColumn`, `isFiniteColumn`, `isNormalColumn`, `isSubnormalColumn`, `isNonFiniteColumn`, `withRowNullCount`, `withRowValidCount`, `withRowNaNCount`, `withRowInfCount`, `withRowPositiveInfCount`, `withRowNegativeInfCount`, `withRowZeroCount`, `withRowNonZeroCount`, `withRowPositiveCount`, `withRowNegativeCount`, `withRowFiniteCount`, `withRowNormalCount`, `withRowSubnormalCount`, `withRowNonFiniteCount`, `dropRows`, `dropRowRange`, `dropFirstRows`, `dropLastRows`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
