...
with `vx.CudaDeviceOperation`, infer partition launch grids, drive family-selected CUDA launches, model loaded CUDA module bundles, and carry CUDA device-model contracts without owning
