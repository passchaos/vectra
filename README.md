...
payloads.  The current single-key implementations skip null keys for matching,
materialize row pairs on the host for every device, and make unmatched
