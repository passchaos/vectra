...
`DataFrameView.hasArrowProjection`/`toArrowFields`/`toArrowFieldsProjection`/`toArrowSchema`/`toArrowSchemaProjection` plus `DeviceLazyFrame.hasArrowProjection`/`hasSchemaProjection`/`columnDTypesProjection`/`columnDTypeNamesProjection`/`dtypeNamesProjection`/`columnNullableMaskProjection`/`nullableColumnCountProjection`/`nonNullableColumnCountProjection`/`columnSchemasProjection`/`schemaProjection`/`schemaSummaryProjection`/`toArrowFieldsProjection`/`toArrowSchemaProjection` for exporting owning, non-owning view, and lazy source metadata directly (with the older `Device*Arrow`
