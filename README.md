...
`withRowCumulativeL1Norm`/`withRowCumL1Norm`/`withRowPrefixL1Norm`, and
`withRowCumulativeL2Norm`/`withRowCumL2Norm`/`withRowPrefixL2Norm` append
per-input horizontal prefix RMS, L1 norm, and L2 norm diagnostics;
