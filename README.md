...
positive, and negative row diagnostics. `withRowFirstZeroIndex`,
`withRowFirstNaNIndex`/`withRowFirstNanIndex`,
`withRowLastNaNIndex`/`withRowLastNanIndex`, `withRowFirstInfIndex`,
`withRowLastInfIndex`, `withRowFirstZeroIndex`, `withRowLastZeroIndex`,
...
horizontal positions of the first/last NaN, Inf, zero, non-zero, positive, or
negative cell in each row.
