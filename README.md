...
select/positional-select-drop/name-pattern-select/name-pattern-drop/dtype-select/dtype-drop/cast/fill-null/coalesce-column/drop-null/null-predicate-column/literal-column/positioned-literal-column/copy-column/row-index/rename/bulk-rename/move/drop/boolean-column-filter/scalar-filter/filter-mask/sort/reverse/slice/stepped-slice/stride/sample/replacement-sample/take/head/tail operations over either an eager
...
`fillNullColumn`, `coalesceColumns`, `dropNulls`, `isNullColumn`, `isValidColumn`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
