...
device/backend predicates, shape/device comparison, schema helpers, column lookup
by name or index, and `DeviceColumnView` null/memory helpers) for backend bridges,
