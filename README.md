...
`fillNullColumn`, `fillNaNColumn`, `fillInfColumn`, `coalesceColumns`, `dropNulls`, `filterNullsColumn`, `dropNaNs`, `dropNaNsColumn`, `filterNaNsColumn`, `isNullColumn`, `isValidColumn`, `isNanColumn`, `isInfColumn`, `isFiniteColumn`, `withRowNullCount`, `withRowValidCount`, `dropRows`, `dropRowRange`, `dropFirstRows`, `dropLastRows`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
