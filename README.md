...
Vectra keeps CPU/Veyra/Alea as the default build.  To validate the experimental Axiom CUDA bridge for contiguous same-shape f32 add/mul/SAXPY/matmul, run:
