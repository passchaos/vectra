...
lazy `trendProfile`, lazy `changePointProfile`, lazy `rollingChangePointProfile`, lazy `expandingChangePointProfile`, lazy `extremaProfile`, lazy `rollingRangeProfile`, lazy `crossoverProfile`,
