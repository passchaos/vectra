...
`projectionMetadataNbytes`, `predicateMetadataNbytes`, `pushdownMetadataNbytes`, `validateProjection`/`validatePredicate`/`validatePushdown`/`pushdownValid` (including range-predicate dtype checks),
