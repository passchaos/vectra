...
f32 add/sub/mul/div/square/sqrt/exp, f32 matmul/fused matmul+add, f64 same-shape/scalar elementwise plus square/sqrt/exp, DGEMM matmul/matmulAdd, and BFloat16 matmul/fused
