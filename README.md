...
lazy `rollingProfile`, lazy `rollingMomentProfile`, lazy `rollingRankProfile`, lazy `lagProfile`, lazy `expandingProfile`, lazy `expandingMomentProfile`,
