...
`projectionMetadataNbytes`, `predicateMetadataNbytes`, `pushdownMetadataNbytes`, `validateProjection`/`validatePredicate`/`validatePushdown`/`pushdownValid`/`validateCollect`/`collectValid` (including range-predicate dtype and null-predicate nullability checks),
