...
`fillNullColumn`, `fillNaNColumn`, `fillInfColumn`, `coalesceColumns`, `dropNulls`, `filterNullsColumn`, `dropNaNs`, `dropNaNsColumn`, `filterNaNsColumn`, `dropInfs`, `dropInfsColumn`, `filterInfsColumn`, `isNullColumn`, `isValidColumn`, `isNanColumn`, `isInfColumn`, `isFiniteColumn`, `withRowNullCount`, `withRowValidCount`, `withRowNaNCount`, `withRowInfCount`, `dropRows`, `dropRowRange`, `dropFirstRows`, `dropLastRows`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
