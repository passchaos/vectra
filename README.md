...
- Sparse CSR bridge: `CsrMatrix`, `csrFromDense`, `csrFromCompressed`, CSR-to-dense, transpose, row/column stats, and Veyra-backed f64 CSR matvec/matmat/stat kernels.
