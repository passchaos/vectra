...
- Array transforms are object/type methods: `reshape/view`, `reshapeInfer/viewInfer` with one inferred dimension, `flatten/ravel`, `flattenAxes`, `unflatten`, `squeeze/unsqueeze`, `transpose`, `permute`, `swapaxes`, `movedim`, `broadcastTo/expand/expandAs`, `repeat`, `repeatInterleave/repeatInterleaveScalar`, `tile`, `slice/sliceAxis/slice1d`, `split`, `chunk`, `flip/flipAxes`, `roll/rollAxes`, `rot90`, `padConstant`, `padEdge`, `padReflect`, `padWrap`, `padSymmetric`, and type-level `cat/concatenate`, `stack`, `hstack`, `vstack`, `dstack`, `columnStack`; non-copying view helpers include `asView`, safe `asStrided`, PyTorch-like `unfold`, `sliceAxisView`, `sliceView`, `selectView`, `narrowView`, `permuteView`, `swapaxesView`, `movedimView`, `transposeView`, and `broadcastView/expandView`.
