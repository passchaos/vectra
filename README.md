...
extremes is zero.
`withRowHhi`, `withRowHerfindahl`, and `withRowHerfindahlHirschman`
append absolute-value-share concentration `sum((abs(x) / sum_abs)^2)`, yielding
NaN for zero-total-magnitude rows.
