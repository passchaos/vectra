...
lazy `linearFitProfile`, lazy `rollingLinearFitProfile`, lazy `expandingLinearFitProfile`, lazy `errorProfile`, lazy `rollingErrorProfile`, lazy `expandingErrorProfile`, lazy `rollingCorrelationProfile`, lazy `expandingCorrelationProfile`, lazy `validityProfile`,
