...
`isCuda`, `isMps`, `isHostBacked`, `isCudaBacked`, `isMpsBacked`, `isAcceleratorBacked`, `isDeviceBacked`, `isDeviceAvailable`, `sameDevice`, `sameStorage`, `shape`, `sameShape`, `shapeEquals`, `hasShape`, `sameHeight`, `sameWidth`, `isEmpty`,
