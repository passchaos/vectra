...
provide the same sort/hash-groupby API seam used by cuDF and Polars; today they
materialize keys/values through `Array.toOwnedSlice` for all devices and keep
