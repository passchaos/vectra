...
`select`/`appendSelect`/`dropSelected`/`selectAll`/`selectExcept`/`intersectSelect`/`whereRange`/`whereMin`/`whereMax`/`whereBetween`/`whereNull`/`whereIsNull`/`whereIsNotNull`/`whereNotNull`/`collect`/`lazy`/`explain`, and
