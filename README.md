...
select/name-pattern-select/dtype-select/cast/fill-null/drop-null/literal-column/row-index/rename/drop/boolean-column-filter/scalar-filter/filter-mask/sort/reverse/slice/take/head/tail operations over either an eager
...
`selectByNameContains`, `selectByDTypes`, `selectNumeric`, `castColumn`,
