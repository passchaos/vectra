...
`withRowPrefixFiniteCount`, and `withRowCumulativeNonFiniteCount`/
...
prefix rates for NaN, Inf, finite, and non-finite diagnostics.
...
positive, and negative row diagnostics.
