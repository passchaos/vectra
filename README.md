...
`groupByFirst`/`Last`, `groupByNUnique`, and their multi-key `*On` variants, `groupByStats`,
...
`groupByLast`/`groupByLastOn`, and distinct-value `groupByNUnique`/`groupByNUniqueOn`,
