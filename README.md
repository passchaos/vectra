...
select/name-pattern-select/name-pattern-drop/dtype-select/cast/fill-null/drop-null/literal-column/row-index/rename/drop/boolean-column-filter/scalar-filter/filter-mask/sort/reverse/slice/take/head/tail operations over either an eager
...
`dropByNameContains`, `selectByDTypes`, `selectNumeric`, `castColumn`,
