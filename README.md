...
`withRowCumStd`/`withRowPrefixStddev`/`withRowPrefixStd` append
per-input horizontal prefix variance and standard deviation using the supplied
`correction`;
