...
lazy `linearFitProfile`, lazy `rollingLinearFitProfile`, lazy `errorProfile`, lazy `rollingCorrelationProfile`, lazy `expandingCorrelationProfile`, lazy `validityProfile`,
