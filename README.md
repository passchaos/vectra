...
`withColumnAbs`, `withColumnNeg`, `withColumnNegative`, `withColumnSquare`, `withColumnReciprocal`, `withColumnSign`, `withColumnSqrt`, `withColumnRsqrt`, `withColumnCbrt`, `withColumnFloor`, `withColumnCeil`, `withColumnRound`, `withColumnTrunc`, `withColumnDeg2rad`, `withColumnRad2deg`, `withColumnExpit`, `withColumnLogit`, `withColumnSoftplus`, `withColumnLogsigmoid`, `withColumnRelu`, `withColumnLeakyRelu`, `withColumnRelu6`, `withColumnPowScalar`, `withColumnFloorDivScalar`, `withColumnModScalar`, `withColumnRemainderScalar`, `withColumnLogAddExpScalar`, `withColumnLogAddExp2Scalar`, `withColumnXlogyScalar`, `withColumnFmaxScalar`, `withColumnFminScalar`, `withColumnHypotScalar`, `withColumnAtan2Scalar`, `withColumnNextAfterScalar`, `withColumnCopysignScalar`, `withColumnHeavisideScalar`, `withColumnLdexpScalar`, `withColumnLerpScalar`, `withColumnAddcmulScalar`, `withColumnAddcdivScalar`, `withColumnClipArray`, `withColumnWhereScalar`, `withColumnWhere`, `withColumnIsIn`, `withColumnIsInInverted`, `withColumnIsin`, `withColumnIsinInverted`, `withColumnMaskedPutScalar`, `withColumnPutMaskScalar`, `withColumnPutFlat`, `withColumnPutFlatScalar`, `withColumnIndexPut`, `withColumnIndexPutScalar`, `withColumnPutFlatScalarSigned`, `withColumnIndexPutScalarSigned`, `withColumnPutFlatScalarMode`, `withColumnIscloseScalar`, `withColumnIscloseScalarEqualNan`, `allcloseColumnScalar`, `allcloseColumnScalarEqualNan`, `countNonzeroColumn`, `zeroCountColumn`, `countZeroColumn`, `anyZeroColumn`, `allZeroColumn`, `anyNonzeroColumn`, `anyNonZeroColumn`, `allNonzeroColumn`, `allNonZeroColumn`, `zeroRatioColumn`, `nonzeroRatioColumn`, `nonZeroRatioColumn`, `firstZeroIndexColumn`, `lastZeroIndexColumn`, `firstPositiveZeroIndexColumn`, `lastPositiveZeroIndexColumn`, `firstNegativeZeroIndexColumn`, `lastNegativeZeroIndexColumn`, `firstNonzeroIndexColumn`, `lastNonzeroIndexColumn`, `positiveZeroCountColumn`, `negativeZeroCountColumn`, `anyPositiveZeroColumn`, `allPositiveZeroColumn`, `anyNegativeZeroColumn`, `allNegativeZeroColumn`, `positiveZeroRatioColumn`, `negativeZeroRatioColumn`, `positiveCountColumn`, `negativeCountColumn`, `signBitCountColumn`, `anyPositiveColumn`, `allPositiveColumn`, `anyNegativeColumn`, `allNegativeColumn`, `anySignBitColumn`, `allSignBitColumn`, `positiveRatioColumn`, `negativeRatioColumn`, `signBitRatioColumn`, `firstPositiveIndexColumn`, `lastPositiveIndexColumn`, `firstNegativeIndexColumn`, `lastNegativeIndexColumn`, `firstSignBitIndexColumn`, `lastSignBitIndexColumn`, `firstNanIndexColumn`, `firstNaNIndexColumn`, `lastNanIndexColumn`, `lastNaNIndexColumn`, `firstInfIndexColumn`, `lastInfIndexColumn`, `firstPositiveInfIndexColumn`, `lastPositiveInfIndexColumn`, `firstNegativeInfIndexColumn`, `lastNegativeInfIndexColumn`, `firstFiniteIndexColumn`, `lastFiniteIndexColumn`, `firstNormalIndexColumn`, `lastNormalIndexColumn`, `firstSubnormalIndexColumn`, `lastSubnormalIndexColumn`, `firstNonFiniteIndexColumn`, `lastNonFiniteIndexColumn`, `nanCountColumn`, `infCountColumn`, `positiveInfCountColumn`, `negativeInfCountColumn`, `finiteCountColumn`, `normalCountColumn`, `subnormalCountColumn`, `nonFiniteCountColumn`, `anyNanColumn`, `anyNaNColumn`, `allNanColumn`, `allNaNColumn`, `anyInfColumn`, `allInfColumn`, `anyPositiveInfColumn`, `allPositiveInfColumn`, `anyNegativeInfColumn`, `allNegativeInfColumn`, `anyFiniteColumn`, `allFiniteColumn`, `anyNonFiniteColumn`, `allNonFiniteColumn`, `anyNormalColumn`, `allNormalColumn`, `anySubnormalColumn`, `allSubnormalColumn`, `nanRatioColumn`, `infRatioColumn`, `positiveInfRatioColumn`, `negativeInfRatioColumn`, `finiteRatioColumn`, `normalRatioColumn`, `subnormalRatioColumn`, `nonFiniteRatioColumn`, `countDistinctColumn`, `nUniqueColumn`, `nullCountColumn`, `validCountColumn`, `anyNullColumn`, `allNullColumn`, `anyValidColumn`, `allValidColumn`, `nullRatioColumn`, `validRatioColumn`, `firstValidIndexColumn`, `lastValidIndexColumn`, `firstNullIndexColumn`, `lastNullIndexColumn`, `withRowCumulativeFirstValidIndex`, `withRowPrefixFirstValidIndex`, `withRowCumulativeLastValidIndex`, `withRowPrefixLastValidIndex`, `withRowCumulativeFirstNullIndex`, `withRowPrefixFirstNullIndex`, `withRowCumulativeLastNullIndex`, `withRowPrefixLastNullIndex`, `modeColumn`, `sumColumn`, `prodColumn`, `meanColumn`, `medianColumn`, `quantileColumn`, `varianceColumn`, `varColumn`, `stddevColumn`, `stdColumn`, `semColumn`, `cvColumn`, `skewnessColumn`, `skewColumn`, `kurtosisColumn`, `kurtColumn`, `meanAbsColumn`, `rmsColumn`, `l1NormColumn`, `l2NormColumn`, `geometricMeanColumn`, `geoMeanColumn`, `harmonicMeanColumn`, `harmMeanColumn`, `madColumn`, `medianAbsDevColumn`, `iqrColumn`, `minColumn`, `maxColumn`, `ptpColumn`, `argminColumn`, `argmaxColumn`, `anyColumn`, `allColumn`, `anyTrueColumn`, `allTrueColumn`, `anyFalseColumn`, `allFalseColumn`, `countTrueColumn`, `countFalseColumn`, `trueRatioColumn`, `falseRatioColumn`, `firstTrueIndexColumn`, `lastTrueIndexColumn`, `firstFalseIndexColumn`, `lastFalseIndexColumn`, `withRowCumulativeFirstTrueIndex`, `withRowPrefixFirstTrueIndex`, `withRowCumulativeLastTrueIndex`, `withRowPrefixLastTrueIndex`, `withRowCumulativeFirstFalseIndex`, `withRowPrefixFirstFalseIndex`, `withRowCumulativeLastFalseIndex`, `withRowPrefixLastFalseIndex`, `logicalNotColumn`, `notColumn`, `withColumnLogicalAndScalar`, `withColumnLogicalOrScalar`, `withColumnLogicalXorScalar`, `withColumnLogicalNot`, `withColumnNot`, `withColumnLogicalAnd`, `withColumnLogicalOr`, `withColumnLogicalXor`, `withColumnThreshold`, `withColumnHardtanh`, `withColumnMaximumScalar`, `withColumnMinimumScalar`, `withColumnClipMin`, `withColumnClipMax`, `withColumnHardshrink`, `withColumnSoftshrink`, `withColumnTanhshrink`, `withColumnElu`, `withColumnCelu`, `withColumnSoftsign`, `withColumnHardsigmoid`, `withColumnHardswish`, `withColumnSilu`, `withColumnSwish`, `withColumnMish`, `withColumnGelu`, `withColumnSelu`, `withColumnExp`, `withColumnExp2`, `withColumnExpm1`, `withColumnSin`, `withColumnCos`, `withColumnTan`, `withColumnAsin`, `withColumnAcos`, `withColumnAtan`, `withColumnSinh`, `withColumnCosh`, `withColumnTanh`, `withColumnAsinh`, `withColumnAcosh`, `withColumnAtanh`, `withColumnLog`, `withColumnLog1p`, `withColumnLgamma`, `withColumnSinc`, `withColumnLog2`, `withColumnLog10`, `fillNullColumn`, `withColumnFillNull`, `withColumnFillNullScalar`, `nullIfColumn`, `nullIfColumnScalar`, `withColumnNullIf`, `withColumnNullIfScalar`, `nullIfNaNColumn`, `withColumnNullIfNaN`, `nullIfInfColumn`, `withColumnNullIfInf`, `nullIfPositiveInfColumn`, `withColumnNullIfPositiveInf`, `nullIfNegativeInfColumn`, `withColumnNullIfNegativeInf`, `nullIfZeroColumn`, `withColumnNullIfZero`, `nullIfPositiveZeroColumn`, `withColumnNullIfPositiveZero`, `nullIfNegativeZeroColumn`, `withColumnNullIfNegativeZero`, `nullIfNonZeroColumn`, `withColumnNullIfNonZero`, `nullIfPositiveColumn`, `withColumnNullIfPositive`, `nullIfSignBitColumn`, `withColumnNullIfSignBit`, `nullIfNegativeColumn`, `withColumnNullIfNegative`, `nullIfFiniteColumn`, `withColumnNullIfFinite`, `nullIfNormalColumn`, `withColumnNullIfNormal`, `nullIfSubnormalColumn`, `withColumnNullIfSubnormal`, `nullIfNonFiniteColumn`, `withColumnNullIfNonFinite`, `fillNaNColumn`, `withColumnFillNaN`, `withColumnFillNaNScalar`, `withColumnFillInf`, `withColumnFillInfScalar`, `withColumnFillPositiveInf`, `withColumnFillPositiveInfScalar`, `withColumnFillNegativeInf`, `withColumnFillNegativeInfScalar`, `withColumnFillZero`, `withColumnFillZeroScalar`, `withColumnFillPositiveZero`, `withColumnFillPositiveZeroScalar`, `withColumnFillNegativeZero`, `withColumnFillNegativeZeroScalar`, `withColumnFillNonZero`, `withColumnFillNonZeroScalar`, `withColumnFillPositive`, `withColumnFillPositiveScalar`, `withColumnFillSignBit`, `withColumnFillSignBitScalar`, `withColumnFillNegative`, `withColumnFillNegativeScalar`, `withColumnFillFinite`, `withColumnFillFiniteScalar`, `withColumnFillNormal`, `withColumnFillNormalScalar`, `withColumnFillSubnormal`, `withColumnFillSubnormalScalar`, `withColumnFillNonFinite`, `withColumnFillNonFiniteScalar`, `fillNaNColumn`, `fillInfColumn`, `fillPositiveInfColumn`, `fillNegativeInfColumn`, `fillZeroColumn`, `fillPositiveZeroColumn`, `fillNegativeZeroColumn`, `fillNonZeroColumn`, `fillPositiveColumn`, `fillSignBitColumn`, `fillNegativeColumn`, `fillFiniteColumn`, `fillNormalColumn`, `fillSubnormalColumn`, `fillNonFiniteColumn`, `coalesceColumns`, `coalesceColumnsMany`, `coalesceManyColumns`, `coalesceFirstValidColumns`, `dropNulls`, `filterNullsColumn`, `dropNaNs`, `dropNaNsColumn`, `filterNaNsColumn`, `dropInfs`, `dropInfsColumn`, `filterInfsColumn`, `dropPositiveInfs`, `dropPositiveInfsColumn`, `filterPositiveInfsColumn`, `dropNegativeInfs`, `dropNegativeInfsColumn`, `filterNegativeInfsColumn`, `dropZeros`, `dropZerosColumn`, `filterZerosColumn`, `dropPositiveZeros`, `dropPositiveZerosColumn`, `filterPositiveZerosColumn`, `dropNegativeZeros`, `dropNegativeZerosColumn`, `filterNegativeZerosColumn`, `dropNonZeros`, `dropNonZerosColumn`, `filterNonZerosColumn`, `dropPositives`, `dropPositivesColumn`, `filterPositivesColumn`, `dropSignBits`, `dropSignBitsColumn`, `filterSignBitsColumn`, `dropNegatives`, `dropNegativesColumn`, `filterNegativesColumn`, `dropFinites`, `dropFinitesColumn`, `filterFinitesColumn`, `dropNormals`, `dropNormalsColumn`, `filterNormalsColumn`, `dropSubnormals`, `dropSubnormalsColumn`, `filterSubnormalsColumn`, `dropNonFinites`, `dropNonFinitesColumn`, `filterNonFinitesColumn`, `isNullColumn`, `isValidColumn`, `isNanColumn`, `isZeroColumn`, `isPositiveZeroColumn`, `isNegativeZeroColumn`, `isNonZeroColumn`, `isPositiveColumn`, `isSignBitColumn`, `isNegativeColumn`, `isInfColumn`, `isPositiveInfColumn`, `isNegativeInfColumn`, `isFiniteColumn`, `isNormalColumn`, `isSubnormalColumn`, `isNonFiniteColumn`, `withRowNullCount`, `withRowValidCount`, `withRowAnyNull`, `withRowAllNull`, `withRowAnyValid`, `withRowAllValid`, `withRowCumulativeAnyNull`, `withRowCumAnyNull`, `withRowPrefixAnyNull`, `withRowCumulativeAllNull`, `withRowCumAllNull`, `withRowPrefixAllNull`, `withRowCumulativeAnyValid`, `withRowCumAnyValid`, `withRowPrefixAnyValid`, `withRowCumulativeAllValid`, `withRowCumAllValid`, `withRowPrefixAllValid`, `withRowCumulativeNullCount`, `withRowCumNullCount`, `withRowPrefixNullCount`, `withRowCumulativeValidCount`, `withRowCumValidCount`, `withRowPrefixValidCount`, `withRowCumulativeNullRatio`, `withRowCumNullRatio`, `withRowPrefixNullRatio`, `withRowCumulativeValidRatio`, `withRowCumValidRatio`, `withRowPrefixValidRatio`, `withRowNullRatio`, `withRowValidRatio`, `withRowArgMin`, `withRowArgMax`, `withRowCumulativeArgMin`, `withRowCumArgMin`, `withRowPrefixArgMin`, `withRowCumulativeArgMax`, `withRowCumArgMax`, `withRowPrefixArgMax`, `withRowQuantile`, `withRowQuantileRange`, `withRowTrimmedMean`, `withRowWinsorizedMean`, `withRowMedian`, `withRowIqr`, `withRowInterdecileRange`, `withRowIdr`, `withRowMidhinge`, `withRowTrimean`, `withRowBowleySkewness`, `withRowBowleySkew`, `withRowQuartileCoeffDispersion`, `withRowQcd`, `withRowKelleySkewness`, `withRowKelleySkew`, `withRowMad`, `withRowMedianAbsDev`, `withRowMode`, `withRowCumulativeMode`, `withRowCumMode`, `withRowPrefixMode`, `withRowCumulativeModeCount`, `withRowCumModeCount`, `withRowPrefixModeCount`, `withRowCumulativeModeRatio`, `withRowCumModeRatio`, `withRowPrefixModeRatio`, `withRowCumulativeModeMargin`, `withRowCumModeMargin`, `withRowPrefixModeMargin`, `withRowCumulativeModeMarginRatio`, `withRowCumModeMarginRatio`, `withRowPrefixModeMarginRatio`, `withRowEntropy`, `withRowGiniImpurity`, `withRowPerplexity`, `withRowInverseSimpson`, `withRowSimpsonConcentration`, `withRowEvenness`, `withRowModeCount`, `withRowModeRatio`, `withRowModeMargin`, `withRowPairCount`, `withRowWeightedMean`, `withRowWeightedVariance`, `withRowWeightedVar`, `withRowWeightedStddev`, `withRowWeightedStd`, `withRowWeightedCovariance`, `withRowWeightedCorrelation`, `withRowWeightedBeta`, `withRowWeightedQuantile`, `withRowWeightedMedian`, `withRowWeightedIqr`, `withRowWeightedMad`, `withRowWeightedMode`, `withRowWeightedModeWeight`, `withRowWeightedModeRatio`, `withRowWeightedModeMargin`, `withRowWeightedEntropy`, `withRowWeightedGiniImpurity`, `withRowWeightedPerplexity`, `withRowWeightedInverseSimpson`, `withRowWeightedSimpsonConcentration`, `withRowWeightedEvenness`, `withRowDot`, `withRowCosineSimilarity`, `withRowCosine`, `withRowSquaredEuclideanDistance`, `withRowEuclideanDistance`, `withRowManhattanDistance`, `withRowChebyshevDistance`, `withRowCanberraDistance`, `withRowBrayCurtisDistance`, `withRowMeanError`, `withRowBias`, `withRowMae`, `withRowMse`, `withRowRmse`, `withRowMape`, `withRowSmape`, `withRowCovariance`, `withRowCorrelation`, `withRowBeta`, `withRowCountDistinct`, `withRowNUnique`, `withRowCumulativeDistinctCount`, `withRowCumDistinctCount`, `withRowPrefixDistinctCount`, `withRowCumulativeNUnique`, `withRowPrefixNUnique`, `withRowSum`, `withRowMean`, `withRowLogSumExp`, `withRowLogsumexp`, `withRowLogMeanExp`, `withRowLogmeanexp`, `withRowCentered`, `withRowDemean`, `withRowZScore`, `withRowZscore`, `withRowStandardize`, `withRowRobustZScore`, `withRowRobustZscore`, `withRowMadZScore`, `withRowMadZscore`, `withRowAverageRank`, `withRowAverageRanks`, `withRowAvgRank`, `withRowAvgRanks`, `withRowFractionalRank`, `withRowFractionalRanks`, `withRowOrdinalRank`, `withRowOrdinalRanks`, `withRowDenseRank`, `withRowDenseRanks`, `withRowCompetitionRank`, `withRowCompetitionRanks`, `withRowMinRank`, `withRowMinRanks`, `withRowPercentRank`, `withRowPercentRanks`, `withRowPercentileRank`, `withRowPercentileRanks`, `withRowCumeDist`, `withRowCumeDistribution`, `withRowCumulativeDistribution`, `withRowCumulativeSum`, `withRowCumsum`, `withRowCumSum`, `withRowPrefixSum`, `withRowCumulativeMean`, `withRowCummean`, `withRowCumMean`, `withRowPrefixMean`, `withRowCumulativeAverage`, `withRowCumAverage`, `withRowCumAvg`, `withRowPrefixAverage`, `withRowPrefixAvg`, `withRowCumulativeLogSumExp`, `withRowCumulativeLogsumexp`, `withRowCumLogSumExp`, `withRowCumLogsumexp`, `withRowPrefixLogSumExp`, `withRowPrefixLogsumexp`, `withRowCumulativeLogMeanExp`, `withRowCumulativeLogmeanexp`, `withRowCumLogMeanExp`, `withRowCumLogmeanexp`, `withRowPrefixLogMeanExp`, `withRowPrefixLogmeanexp`, `withRowCumulativeGeometricMean`, `withRowCumulativeGeoMean`, `withRowCumGeometricMean`, `withRowCumGeoMean`, `withRowPrefixGeometricMean`, `withRowPrefixGeoMean`, `withRowCumulativeHarmonicMean`, `withRowCumulativeHarmMean`, `withRowCumHarmonicMean`, `withRowCumHarmMean`, `withRowPrefixHarmonicMean`, `withRowPrefixHarmMean`, `withRowCumulativeVariance`, `withRowCumulativeVar`, `withRowCumVariance`, `withRowCumVar`, `withRowPrefixVariance`, `withRowPrefixVar`, `withRowCumulativeStddev`, `withRowCumulativeStd`, `withRowCumStddev`, `withRowCumStd`, `withRowPrefixStddev`, `withRowPrefixStd`, `withRowCumulativeSem`, `withRowCumSem`, `withRowPrefixSem`, `withRowCumulativeCv`, `withRowCumCv`, `withRowPrefixCv`, `withRowCumulativeFano`, `withRowCumFano`, `withRowPrefixFano`, `withRowCumulativeIndexOfDispersion`, `withRowCumIndexOfDispersion`, `withRowPrefixIndexOfDispersion`, `withRowCumulativeSkewness`, `withRowCumulativeSkew`, `withRowCumSkewness`, `withRowCumSkew`, `withRowPrefixSkewness`, `withRowPrefixSkew`, `withRowCumulativeKurtosis`, `withRowCumulativeKurt`, `withRowCumKurtosis`, `withRowCumKurt`, `withRowPrefixKurtosis`, `withRowPrefixKurt`, `withRowCumulativeRms`, `withRowCumRms`, `withRowPrefixRms`, `withRowCumulativeMeanAbs`, `withRowCumulativeMeanAbsolute`, `withRowCumMeanAbs`, `withRowCumMeanAbsolute`, `withRowPrefixMeanAbs`, `withRowPrefixMeanAbsolute`, `withRowCumulativeMeanSquare`, `withRowCumulativeMeanSquared`, `withRowCumMeanSquare`, `withRowCumMeanSquared`, `withRowPrefixMeanSquare`, `withRowPrefixMeanSquared`, `withRowCumulativeMaxAbs`, `withRowCumulativeMaxAbsolute`, `withRowCumulativeLInfNorm`, `withRowCumulativeLinfNorm`, `withRowCumMaxAbs`, `withRowCumMaxAbsolute`, `withRowCumLInfNorm`, `withRowCumLinfNorm`, `withRowPrefixMaxAbs`, `withRowPrefixMaxAbsolute`, `withRowPrefixLInfNorm`, `withRowPrefixLinfNorm`, `withRowCumulativeMinAbs`, `withRowCumulativeMinAbsolute`, `withRowCumMinAbs`, `withRowCumMinAbsolute`, `withRowPrefixMinAbs`, `withRowPrefixMinAbsolute`, `withRowCumulativeL1Norm`, `withRowCumL1Norm`, `withRowPrefixL1Norm`, `withRowCumulativeL2Norm`, `withRowCumL2Norm`, `withRowPrefixL2Norm`, `withRowCumulativeProduct`, `withRowCumprod`, `withRowCumProd`, `withRowPrefixProduct`, `withRowCumulativeMax`, `withRowCummax`, `withRowCumMax`, `withRowPrefixMax`, `withRowCumulativeMin`, `withRowCummin`, `withRowCumMin`, `withRowPrefixMin`, `withRowCumulativeRange`, `withRowCumRange`, `withRowPrefixRange`, `withRowCumulativePtp`, `withRowCumPtp`, `withRowPrefixPtp`, `withRowIqrOutlier`, `withRowIqrOutliers`, `withRowTukeyOutlier`, `withRowTukeyOutliers`, `withRowMaxIndicator`, `withRowMaxIndicators`, `withRowIsMax`, `withRowMaxMask`, `withRowMinIndicator`, `withRowMinIndicators`, `withRowIsMin`, `withRowMinMask`, `withRowTukeyWinsorize`, `withRowTukeyWinsorized`, `withRowIqrWinsorize`, `withRowIqrWinsorized`, `withRowMinMaxScale`, `withRowMinmaxScale`, `withRowL2Normalize`, `withRowL2Normalized`, `withRowL1Normalize`, `withRowL1Normalized`, `withRowSumNormalize`, `withRowProportion`, `withRowShare`, `withRowMeanNormalize`, `withRowMeanNormalized`, `withRowMeanRatio`, `withRowMaxAbsNormalize`, `withRowMaxabsNormalize`, `withRowLInfNormalize`, `withRowLinfNormalize`, `withRowSoftmax`, `withRowLogSoftmax`, `withRowLogsoftmax`, `withRowSoftmin`, `withRowLogSoftmin`, `withRowLogsoftmin`, `withRowSoftmaxEntropy`, `withRowSoftmaxPerplexity`, `withRowSoftmaxConfidence`, `withRowSoftmaxMargin`, `withRowSoftmaxEvenness`, `withRowSoftmaxNormalizedEntropy`, `withRowSoftmaxConcentration`, `withRowSoftmaxNormalizedHhi`, `withRowSoftmaxNormalizedHHI`, `withRowSoftmaxNhhi`, `withRowSoftmaxGiniImpurity`, `withRowSoftmaxGini`, `withRowSoftmaxInverseSimpson`, `withRowSoftmaxSimpsonEvenness`, `withRowSoftmaxSimpsonEven`, `withRowLogitMargin`, `withRowGeometricMean`, `withRowGeoMean`, `withRowMagnitudeGeometricMean`, `withRowAbsGeometricMean`, `withRowMagnitudeGeoMean`, `withRowAbsGeoMean`, `withRowHarmonicMean`, `withRowHarmMean`, `withRowSkewness`, `withRowSkew`,
