...
`dropNumeric`, `dropFloat`, `dropInteger`, `dropBool`, `selectNullableColumns`, `selectNonNullableColumns`, `selectColumnsWithNulls`, `selectColumnsWithoutNulls`, `dropNullableColumns`, `dropNonNullableColumns`, `dropColumnsWithNulls`, `dropColumnsWithoutNulls`, `castColumn`,
`fillNullColumn`, `coalesceColumns`, `dropNulls`, `filterNullsColumn`, `isNullColumn`, `isValidColumn`, `withRowNullCount`, `withRowValidCount`, `dropRows`, `dropRowRange`, `dropFirstRows`, `dropLastRows`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
