...
`ParquetScan.init`/`hasPushdown`/`hasProjection`/`projectionColumnCount`/`projectionNames`/`hasRangePredicate`/`hasNullPredicate`/`select`/`whereRange`/`whereNull`/`collect`/`lazy`/`explain`, and
