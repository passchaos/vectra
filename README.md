...
`fillNullColumn`, `coalesceColumns`, `dropNulls`, `filterNullsColumn`, `dropNaNs`, `dropNaNsColumn`, `filterNaNsColumn`, `isNullColumn`, `isValidColumn`, `isNanColumn`, `isFiniteColumn`, `withRowNullCount`, `withRowValidCount`, `dropRows`, `dropRowRange`, `dropFirstRows`, `dropLastRows`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
