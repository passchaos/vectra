...
- `ArrayView(T)` also exposes common materializing elementwise/broadcast wrappers: `square`, `reciprocal`, `sign/signbit`, `exp/expm1`, `log/log1p/log2/log10`, `sqrt`, `floor/ceil/round/trunc`, `deg2rad/rad2deg`, trigonometric and hyperbolic functions, `relu`, `sigmoid`, `clip`, `pow/floorDiv/mod/remainder`, `maximum/minimum`, `hypot/atan2`, `nextAfter/copysign/heaviside`, `clipArray`, `isNan/isInf/isFinite`, `isclose`, and `allclose`.
