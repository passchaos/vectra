...
`groupByLast`/`groupByLastOn`, null-preserving row-value `groupByFirstRow`/`groupByFirstRowOn` plus `groupByLastRow`/`groupByLastRowOn`, distinct-value `groupByNUnique`/`groupByNUniqueOn`,
