...
also expose grouped `vx.ArrowExport.DataFrame.Arrow`/`DataFrame.Parquet` helpers, `vx.ArrowExport.LazyFrame.Arrow`, plus grouped `vx.ArrowExport.ParquetScan` namespaces (`Lifecycle`, `Device`, `Source`, `File`, `Pushdown`, and `Arrow`) while retaining flat aliases, and `vx.ArrowExport.DataFrame.hasArrowProjection`/`toArrow*`/`fromArrow*`/`fromParquet*`, `Column.toArrow*`,
`ColumnSchema.arrowDataType`/`toArrowField`, `ColumnView.arrowDataType`/`toArrowField`,
`ParquetScan.toArrowSchema`/`toArrowSchemaProjection`/`toArrowFields`/`toArrowFieldsProjection` plus Arrow field inspection (`arrowFieldCount`/`arrowFieldNameAt`/`arrowFieldNames`/`arrowFieldIndex`/`arrowFieldDTypeAt`/`arrowFieldDType`/`arrowFieldDTypes`/`arrowFieldDTypesProjection`/`arrowFieldDTypeNames`/`arrowFieldDTypeNamesProjection`/`arrowFieldDTypeByteSizes`/`arrowFieldDTypeByteSizesProjection`/`arrowFieldDTypeBitSizes`/`arrowFieldDTypeBitSizesProjection`/`arrowFieldDTypeClassMask`/`arrowFieldDTypeClassMaskProjection`/`arrowFieldDTypeClassCount`/`arrowFieldDTypeClassCountProjection`/`numericArrowFieldCount`/`numericArrowFieldCountProjection`/`floatArrowFieldCount`/`floatArrowFieldCountProjection`/`integerArrowFieldCount`/`integerArrowFieldCountProjection`/`boolArrowFieldCount`/`boolArrowFieldCountProjection`/`arrowFieldNullableAt`/`arrowFieldNullable`/`arrowFieldNullableMask`/`arrowFieldNullableMaskProjection`/`nullableArrowFieldCount`/`nullableArrowFieldCountProjection`/`nonNullableArrowFieldCount`/`nonNullableArrowFieldCountProjection`/`arrowFieldNullCount`/`arrowFieldValidCount`/`arrowFieldNullCounts`/`arrowFieldNullCountsProjection`/`arrowFieldValidCounts`/`arrowFieldValidCountsProjection`/`arrowFieldNullRatios`/`arrowFieldNullRatiosProjection`/`arrowFieldValidRatios`/`arrowFieldValidRatiosProjection`/`arrowNullCount`/`arrowNullCountProjection`/`arrowValidCount`/`arrowValidCountProjection`/`arrowNullRatio`/`arrowNullRatioProjection`/`arrowValidRatio`/`arrowValidRatioProjection`/`hasNullableArrowFields`/`allArrowFieldsNullable`, `arrowColumnSchemaAt`/`arrowColumnSchema`/`arrowColumnSchemas`/`arrowColumnSchemasProjection`/`arrowFieldDataNbytes`/`arrowFieldDataNbytesProjection`/`arrowFieldValidityNbytes`/`arrowFieldValidityNbytesProjection`/`arrowFieldTotalNbytes`/`arrowFieldTotalNbytesProjection`/`arrowDataNbytes`/`arrowDataNbytesProjection`/`arrowValidityNbytes`/`arrowValidityNbytesProjection`/`arrowTotalNbytes`/`arrowTotalNbytesProjection`/`arrowSchemaSummary`/`arrowSchemaSummaryProjection`/`arrowSchemaEquals`/`arrowSameSchema`/`arrowSchemaCompatible`/`arrowSchemaEqualsSchemas`/`arrowSchemaEqualsFrame`/`arrowSameSchemaFrame`/`arrowSchemaCompatibleFrame` (schema names are stable for explicit/projection-backed names), `hasArrowField`/`hasAllArrowFields`/`hasAnyArrowField`/`hasArrowProjection`),
...
metadata (`parquetFileSummary`/`DeviceParquetFileSummary`, `parquetRowGroupSummaryAt`/`parquetRowGroupSummaries`/`DeviceParquetRowGroupSummary`, row-group vector helpers (`parquetRowGroupRowCounts`, `parquetRowGroupColumnChunkCounts`, `parquetRowGroupTotalNbytes`, `parquetRowGroupTotalCompressedNbytes`, `parquetRowGroupCompressedNbytes`, `parquetRowGroupUncompressedNbytes`, `parquetRowGroupCompressionRatios`, `parquetRowGroupMetadataCoverageRatios`, `parquetRowGroupMissingMetadataRatios`, `parquetRowGroupColumnIndexCoverageRatios`, `parquetRowGroupOffsetIndexCoverageRatios`, `parquetRowGroupPageIndexCoverageRatios`, `parquetRowGroupBloomFilterCoverageRatios`, `parquetRowGroupSizedBloomFilterCoverageRatios`), shape helpers (`rowCount`/`nRows`, `columnCount`/`width`/`cols`/`nCols`, `cellCount`, `shape`, `hasRows`/`hasColumns`/`hasShape`, `sameHeight`/`sameWidth`/`sameShape`/`shapeEquals`/`sameRowGroups`), `rowGroupCount`, `parquetColumnChunkCount`, `hasRowGroups`, Parquet byte/coverage helpers (`parquetTotalNbytes`, `parquetTotalCompressedNbytes`, `parquetTotalUncompressedNbytes`, `parquetFieldCompressedNbytes`, `parquetFieldCompressedNbytesProjection`, `parquetFieldUncompressedNbytes`, `parquetFieldUncompressedNbytesProjection`, `parquetCompressedNbytes`, `parquetCompressedNbytesProjection`, `parquetUncompressedNbytes`, `parquetUncompressedNbytesProjection`, `parquetFieldCompressionRatios`, `parquetFieldCompressionRatiosProjection`, `parquetCompressionRatio`, `parquetCompressionRatioProjection`, `parquetMetadataCoverageRatio`, `parquetPageIndexCoverageRatio`), `sourceNbytes`/`sourceByteCount`/`nbytes`/`byteCount`, `sourcePtr`/`dataPtr`/`hasSourcePtr`/`sourceEndPtr`,
...
`DataFrameView.hasArrowProjection`/`toArrowFields`/`toArrowFieldsProjection`/`toArrowSchema`/`toArrowSchemaProjection` plus `DeviceLazyFrame.hasArrowProjection`/`hasSchemaProjection`/`columnNullCounts`/`columnNullCountsProjection`/`columnValidCounts`/`columnValidCountsProjection`/`nullCount`/`nullCountProjection`/`validCount`/`validCountProjection`/`nullRatio`/`nullRatioProjection`/`validRatio`/`validRatioProjection`/`anyNull`/`anyNullProjection`/`allNull`/`allNullProjection`/`anyValid`/`anyValidProjection`/`allValid`/`allValidProjection`/`anyNullColumn`/`allNullColumn`/`anyValidColumn`/`allValidColumn`/`columnNullRatios`/`columnNullRatiosProjection`/`columnValidRatios`/`columnValidRatiosProjection`/`columnHasNullsMask`/`columnHasNullsMaskProjection`/`columnsWithNullsCount`/`columnsWithNullsCountProjection`/`columnsWithoutNullsCount`/`columnsWithoutNullsCountProjection`/`columnDTypesProjection`/`columnDTypeNamesProjection`/`dtypeNamesProjection`/`columnDTypeByteSizesProjection`/`columnDTypeBitSizesProjection`/`columnDTypeClassMaskProjection`/projected `columnIs*Mask` aliases/`columnDTypeClassCountProjection`/projection dtype-class count aliases/`columnDataNbytes`/`columnDataNbytesProjection`/`columnValidityNbytes`/`columnValidityNbytesProjection`/`columnTotalNbytes`/`columnTotalNbytesProjection`/`columnMemoryUsage`/`columnMemoryUsageProjection`/`dataNbytes`/`dataNbytesProjection`/`validityNbytes`/`validityNbytesProjection`/`totalNbytes`/`totalNbytesProjection`/`memoryUsageProjection`/`estimatedSizeProjection`/`columnNullableMaskProjection`/`nullableColumnCountProjection`/`nonNullableColumnCountProjection`/`columnSchemasProjection`/`schemaProjection`/`schemaSummaryProjection`/`toArrowFieldsProjection`/`toArrowSchemaProjection` for exporting owning, non-owning view, and lazy source metadata directly (with the older `Device*Arrow`
