...
- Neural/math functions: `neg`, `abs`, `square`, `reciprocal`, `sign/signbit`, `exp/expm1`, `log/log1p`, `sqrt`, `floor`, `ceil`, `round`, `trunc`, `sin`, `cos`, `tan`, `asin`, `acos`, `atan`, `sinh`, `cosh`, `tanh`, `relu`, `sigmoid`, `softmax`, `logsumexp`, `logSoftmax/log_softmax`, `clip`, `isNan/isnan`, `isInf/isinf`, `isFinite/isfinite`.
