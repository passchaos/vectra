...
`dropNumeric`, `dropFloat`, `dropInteger`, `dropBool`, `selectNullableColumns`, `selectNonNullableColumns`, `selectColumnsWithNulls`, `selectColumnsWithoutNulls`, `dropNullableColumns`, `dropNonNullableColumns`, `dropColumnsWithNulls`, `dropColumnsWithoutNulls`, `selectColumnsWithNaNs`, `selectColumnsWithoutNaNs`, `dropColumnsWithNaNs`, `dropColumnsWithoutNaNs`, `selectColumnsWithInfs`, `selectColumnsWithoutInfs`, `dropColumnsWithInfs`, `dropColumnsWithoutInfs`, `selectColumnsWithPositiveInfs`, `selectColumnsWithoutPositiveInfs`, `dropColumnsWithPositiveInfs`, `dropColumnsWithoutPositiveInfs`, `selectColumnsWithNegativeInfs`, `selectColumnsWithoutNegativeInfs`, `dropColumnsWithNegativeInfs`, `dropColumnsWithoutNegativeInfs`, `selectColumnsWithNormals`, `selectColumnsWithoutNormals`, `dropColumnsWithNormals`, `dropColumnsWithoutNormals`, `selectColumnsWithNonFinites`, `selectColumnsWithoutNonFinites`, `dropColumnsWithNonFinites`, `dropColumnsWithoutNonFinites`, `castColumn`,
`fillNullColumn`, `fillNaNColumn`, `fillInfColumn`, `fillPositiveInfColumn`, `fillNegativeInfColumn`, `fillNonFiniteColumn`, `coalesceColumns`, `dropNulls`, `filterNullsColumn`, `dropNaNs`, `dropNaNsColumn`, `filterNaNsColumn`, `dropInfs`, `dropInfsColumn`, `filterInfsColumn`, `dropPositiveInfs`, `dropPositiveInfsColumn`, `filterPositiveInfsColumn`, `dropNegativeInfs`, `dropNegativeInfsColumn`, `filterNegativeInfsColumn`, `dropNormals`, `dropNormalsColumn`, `filterNormalsColumn`, `dropSubnormals`, `dropSubnormalsColumn`, `filterSubnormalsColumn`, `dropNonFinites`, `dropNonFinitesColumn`, `filterNonFinitesColumn`, `isNullColumn`, `isValidColumn`, `isNanColumn`, `isInfColumn`, `isPositiveInfColumn`, `isNegativeInfColumn`, `isFiniteColumn`, `isNormalColumn`, `isSubnormalColumn`, `withRowNullCount`, `withRowValidCount`, `withRowNaNCount`, `withRowInfCount`, `withRowPositiveInfCount`, `withRowNegativeInfCount`, `withRowFiniteCount`, `withRowNormalCount`, `withRowSubnormalCount`, `withRowNonFiniteCount`, `dropRows`, `dropRowRange`, `dropFirstRows`, `dropLastRows`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
