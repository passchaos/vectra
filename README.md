...
`groupByFirst`/`Last`, `groupByNUnique`, `groupByMode`, `groupByMedian`, and their multi-key `*On` variants, `groupByStats`,
...
stable first-tie `groupByMode`/`groupByModeOn`, and interpolated `groupByMedian`/`groupByMedianOn`,
