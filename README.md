...
`explain()`, folds adjacent select/head/tail operations, and executes through
`collect()` today, preserving a future Axiom lowering boundary for query
optimization/fusion.
