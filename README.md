...
- Sparse CSR bridge: `CsrMatrix`, `csrFromDense`, `csrFromCompressed`, CSR-to-dense, transpose, row/column stats, diagonal/trace diagnostics, bandwidth, symmetry checks, and Veyra-backed f64 CSR matvec/matmat/stat kernels.
