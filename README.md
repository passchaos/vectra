...
`withRowPrefixMeanSquared`, `withRowCumulativeL1Norm`/
`withRowCumL1Norm`/`withRowPrefixL1Norm`, and
`withRowCumulativeL2Norm`/`withRowCumL2Norm`/`withRowPrefixL2Norm` append
per-input horizontal prefix RMS, mean absolute value, mean square, L1 norm,
and L2 norm diagnostics;
