...
lazy `trendProfile`, lazy `rollingTrendProfile`, lazy `expandingTrendProfile`, lazy `changePointProfile`, lazy `rollingChangePointProfile`, lazy `expandingChangePointProfile`, lazy `extremaProfile`, lazy `rollingRangeProfile`, lazy `crossoverProfile`, lazy `rollingCrossoverProfile`,
