...
`groupByFirst`/`Last`, `groupByNUnique`, `groupByMode`, and their multi-key `*On` variants, `groupByStats`,
...
and stable first-tie `groupByMode`/`groupByModeOn`,
