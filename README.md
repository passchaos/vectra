...
select/rename/drop/boolean-column-filter/scalar-filter/filter-mask/sort/slice/take/head/tail operations over either an eager
...
Eager schema/expression helpers such as `renameColumn`, `dropColumn`, `compareColumnScalar`,
