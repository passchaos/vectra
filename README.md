...
solve, Cholesky, QR, LU, triangular solve, Frobenius/one/inf/two/nuclear matrix norms, SVD, singular values, matrix rank, condition number, and pseudo-inverse flow through Axiom CPU lowering to Veyra. Supported CUDA owning-array
