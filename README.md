...
`isCuda`, `isMps`, `isHostBacked`, `isCudaBacked`, `isMpsBacked`, `isDeviceBacked`, `isDeviceAvailable`, `sameDevice`, `sameStorage`, `shape`, `sameShape`, `shapeEquals`, `hasShape`, `sameHeight`, `sameWidth`, `isEmpty`,
