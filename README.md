...
`fillNullColumn`, `fillNaNColumn`, `fillInfColumn`, `fillPositiveInfColumn`, `fillNegativeInfColumn`, `fillNonFiniteColumn`, `coalesceColumns`, `dropNulls`, `filterNullsColumn`, `dropNaNs`, `dropNaNsColumn`, `filterNaNsColumn`, `dropInfs`, `dropInfsColumn`, `filterInfsColumn`, `dropPositiveInfs`, `dropPositiveInfsColumn`, `filterPositiveInfsColumn`, `dropNegativeInfs`, `dropNegativeInfsColumn`, `filterNegativeInfsColumn`, `dropNormals`, `dropNormalsColumn`, `filterNormalsColumn`, `dropNonFinites`, `dropNonFinitesColumn`, `filterNonFinitesColumn`, `isNullColumn`, `isValidColumn`, `isNanColumn`, `isInfColumn`, `isPositiveInfColumn`, `isNegativeInfColumn`, `isFiniteColumn`, `isNormalColumn`, `withRowNullCount`, `withRowValidCount`, `withRowNaNCount`, `withRowInfCount`, `withRowPositiveInfCount`, `withRowNegativeInfCount`, `withRowFiniteCount`, `withRowNormalCount`, `withRowNonFiniteCount`, `dropRows`, `dropRowRange`, `dropFirstRows`, `dropLastRows`, `withColumnAt`, `withColumnBefore`, `withColumnAfter`,
