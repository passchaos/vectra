...
pub fn deinit(comptime Self: type, self: *Self, allocator: std.mem.Allocator) void {
    switch (self.*) {
        ...
        .group_cumulative_weighted_mean, .group_cumulative_weighted_mean_square, .group_cumulative_weighted_rms, .group_cumulative_weighted_median, .group_cumulative_weighted_iqr, .group_cumulative_weighted_mad, .group_cumulative_weighted_mode, .group_cumulative_weighted_mode_weight, .group_cumulative_weighted_mode_ratio, .group_cumulative_weighted_mode_margin, .group_cumulative_weighted_mode_margin_ratio, .group_cumulative_weighted_entropy, .group_cumulative_weighted_gini_impurity, .group_cumulative_weighted_perplexity, .group_cumulative_weighted_inverse_simpson, .group_cumulative_weighted_simpson_concentration, .group_cumulative_weighted_evenness, .group_cumulative_weighted_mean_abs, .group_cumulative_weighted_l1_norm, .group_cumulative_weighted_l2_norm, .group_cumulative_weighted_max_abs, .group_cumulative_weighted_min_abs, .group_cumulative_weighted_geometric_mean, .group_cumulative_weighted_harmonic_mean, .group_cumulative_weighted_logsumexp, .group_cumulative_weighted_logmeanexp, .group_cumulative_weighted_variance, .group_cumulative_weighted_stddev, .group_cumulative_weighted_sem, .group_cumulative_weighted_cv, .group_cumulative_weighted_fano => |shift| {
            freeNameList(allocator, shift.names);
            allocator.free(shift.value_name);
