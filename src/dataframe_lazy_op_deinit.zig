...
pub fn deinit(comptime Self: type, self: *Self, allocator: std.mem.Allocator) void {
    switch (self.*) {
        ...
        .drop_nulls, .drop_nans, .drop_infs, .drop_positive_infs, .drop_negative_infs, .drop_non_finites => |names| freeNameList(allocator, names),
        .filter_nulls_column, .filter_nans_column, .filter_infs_column, .filter_positive_infs_column, .filter_negative_infs_column, .filter_non_finites_column => |name| allocator.free(name),
        ...
        .fill_null_column, .fill_nan_column, .fill_inf_column, .fill_positive_inf_column, .fill_negative_inf_column, .fill_non_finite_column => |fill| allocator.free(fill.name),
        ...
        .is_null_column, .is_valid_column, .is_nan_column, .is_finite_column, .is_normal_column, .is_inf_column, .is_positive_inf_column, .is_negative_inf_column => |predicate| {
            allocator.free(predicate.name);
            allocator.free(predicate.output_name);
        },
        .row_null_count, .row_valid_count, .row_nan_count, .row_inf_count, .row_positive_inf_count, .row_negative_inf_count, .row_finite_count, .row_non_finite_count => |row_count| {
