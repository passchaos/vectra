...
pub fn deinit(comptime Self: type, self: *Self, allocator: std.mem.Allocator) void {
    switch (self.*) {
        ...
        .drop_nulls, .drop_nans, .drop_infs, .drop_positive_infs, .drop_negative_infs, .drop_zeros, .drop_non_zeros, .drop_finites, .drop_normals, .drop_subnormals, .drop_non_finites => |names| freeNameList(allocator, names),
        .filter_nulls_column, .filter_nans_column, .filter_infs_column, .filter_positive_infs_column, .filter_negative_infs_column, .filter_zeros_column, .filter_non_zeros_column, .filter_finites_column, .filter_normals_column, .filter_subnormals_column, .filter_non_finites_column => |name| allocator.free(name),
        ...
        .fill_null_column, .fill_nan_column, .fill_inf_column, .fill_positive_inf_column, .fill_negative_inf_column, .fill_zero_column, .fill_non_zero_column, .fill_finite_column, .fill_normal_column, .fill_subnormal_column, .fill_non_finite_column => |fill| allocator.free(fill.name),
        ...
        .row_null_count, .row_valid_count, .row_nan_count, .row_inf_count, .row_positive_inf_count, .row_negative_inf_count, .row_zero_count, .row_non_zero_count, .row_positive_count, .row_negative_count, .row_finite_count, .row_normal_count, .row_subnormal_count, .row_non_finite_count => |row_count| {
