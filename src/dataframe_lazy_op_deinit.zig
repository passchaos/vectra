...
pub fn deinit(comptime Self: type, self: *Self, allocator: std.mem.Allocator) void {
    switch (self.*) {
        ...
        .row_cumulative_weighted_sum, .row_cumulative_weighted_mean, .row_cumulative_weighted_mean_square, .row_cumulative_weighted_rms, .row_cumulative_weighted_mean_abs, .row_cumulative_weighted_l1_norm, .row_cumulative_weighted_l2_norm, .row_cumulative_weighted_min, .row_cumulative_weighted_max, .row_cumulative_weighted_max_abs, .row_cumulative_weighted_min_abs, .row_cumulative_weighted_range, .row_cumulative_weighted_midrange, .row_cumulative_weighted_range_coeff, .row_cumulative_weighted_product, .row_cumulative_weighted_geometric_mean, .row_cumulative_weighted_harmonic_mean, .row_cumulative_weighted_logsumexp, .row_cumulative_weighted_logmeanexp, .row_cumulative_weighted_skewness, .row_cumulative_weighted_kurtosis, .row_cumulative_weighted_weight_sum, .row_cumulative_weighted_positive_count, .row_cumulative_weighted_effective_n => |row_weighted| {
            freeNameList(allocator, row_weighted.value_names);
            freeNameList(allocator, row_weighted.weight_names);
