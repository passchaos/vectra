...
pub fn deinit(comptime Self: type, self: *Self, allocator: std.mem.Allocator) void {
    switch (self.*) {
        ...
        .row_weighted_mean, .row_dot, .row_cosine_similarity, .row_squared_euclidean_distance, .row_euclidean_distance, .row_manhattan_distance, .row_mae, .row_mse, .row_rmse, .row_mape, .row_smape => |row_weighted| {
