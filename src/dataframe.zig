...
const initProfileDataFrame = group_profile_mod.initProfileDataFrame;
...
fn groupByProfileOnTyped(
    ...
    return initProfileDataFrame(DeviceDataFrame, allocator, key_names, output_prefix, key_columns, metrics, device_value);
}
