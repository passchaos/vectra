...
const profile_methods_mod = @import("dataframe/profile.zig");
...
pub const DeviceParquetRowGroupSummary = parquet_scan_summary_mod.DeviceParquetRowGroupSummary;
...
pub const DeviceDataFrame = struct {
    ...
    pub fn isRemoteBacked(self: DeviceDataFrame) bool {
    ...
    pub const withRowWeightedPairWeightSum = table_methods_mod.withRowWeightedPairWeightSum;
    pub const withRowWeightedPairPositiveCount = table_methods_mod.withRowWeightedPairPositiveCount;
    pub const withRowWeightedPairEffectiveN = table_methods_mod.withRowWeightedPairEffectiveN;
    pub const withRowWeightedPairEffectiveCount = table_methods_mod.withRowWeightedPairEffectiveCount;
    pub const withRowCumulativeWeightedPairWeightSum = table_methods_mod.withRowCumulativeWeightedPairWeightSum;
    pub const withRowCumulativeWeightedPairPositiveCount = table_methods_mod.withRowCumulativeWeightedPairPositiveCount;
    pub const withRowCumulativeWeightedPairEffectiveN = table_methods_mod.withRowCumulativeWeightedPairEffectiveN;
    pub const withRowCumulativeWeightedPairEffectiveCount = table_methods_mod.withRowCumulativeWeightedPairEffectiveCount;
    pub const withRowCumWeightedPairWeightSum = table_methods_mod.withRowCumWeightedPairWeightSum;
    pub const withRowPrefixWeightedPairWeightSum = table_methods_mod.withRowPrefixWeightedPairWeightSum;
    pub const withRowCumWeightedPairPositiveCount = table_methods_mod.withRowCumWeightedPairPositiveCount;
    pub const withRowPrefixWeightedPairPositiveCount = table_methods_mod.withRowPrefixWeightedPairPositiveCount;
    pub const withRowCumWeightedPairEffectiveN = table_methods_mod.withRowCumWeightedPairEffectiveN;
    pub const withRowCumWeightedPairEffectiveCount = table_methods_mod.withRowCumWeightedPairEffectiveCount;
    pub const withRowPrefixWeightedPairEffectiveN = table_methods_mod.withRowPrefixWeightedPairEffectiveN;
    pub const withRowPrefixWeightedPairEffectiveCount = table_methods_mod.withRowPrefixWeightedPairEffectiveCount;
    pub const withRowCumulativeWeightedDot = table_methods_mod.withRowCumulativeWeightedDot;
    pub const withRowCumWeightedDot = table_methods_mod.withRowCumWeightedDot;
    pub const withRowPrefixWeightedDot = table_methods_mod.withRowPrefixWeightedDot;
    pub const withRowCumulativeWeightedCosineSimilarity = table_methods_mod.withRowCumulativeWeightedCosineSimilarity;
    pub const withRowCumulativeWeightedCosine = table_methods_mod.withRowCumulativeWeightedCosine;
    pub const withRowCumWeightedCosineSimilarity = table_methods_mod.withRowCumWeightedCosineSimilarity;
    pub const withRowCumWeightedCosine = table_methods_mod.withRowCumWeightedCosine;
    pub const withRowPrefixWeightedCosineSimilarity = table_methods_mod.withRowPrefixWeightedCosineSimilarity;
    pub const withRowPrefixWeightedCosine = table_methods_mod.withRowPrefixWeightedCosine;
    pub const withRowCumulativeWeightedSquaredEuclideanDistance = table_methods_mod.withRowCumulativeWeightedSquaredEuclideanDistance;
    pub const withRowCumulativeWeightedSquaredDistance = table_methods_mod.withRowCumulativeWeightedSquaredDistance;
    pub const withRowCumulativeWeightedSqEuclideanDistance = table_methods_mod.withRowCumulativeWeightedSqEuclideanDistance;
    pub const withRowCumWeightedSquaredEuclideanDistance = table_methods_mod.withRowCumWeightedSquaredEuclideanDistance;
    pub const withRowCumWeightedSquaredDistance = table_methods_mod.withRowCumWeightedSquaredDistance;
    pub const withRowCumWeightedSqEuclideanDistance = table_methods_mod.withRowCumWeightedSqEuclideanDistance;
    pub const withRowPrefixWeightedSquaredEuclideanDistance = table_methods_mod.withRowPrefixWeightedSquaredEuclideanDistance;
    pub const withRowPrefixWeightedSquaredDistance = table_methods_mod.withRowPrefixWeightedSquaredDistance;
    pub const withRowPrefixWeightedSqEuclideanDistance = table_methods_mod.withRowPrefixWeightedSqEuclideanDistance;
    pub const withRowCumulativeWeightedEuclideanDistance = table_methods_mod.withRowCumulativeWeightedEuclideanDistance;
    pub const withRowCumulativeWeightedL2Distance = table_methods_mod.withRowCumulativeWeightedL2Distance;
    pub const withRowCumWeightedEuclideanDistance = table_methods_mod.withRowCumWeightedEuclideanDistance;
    pub const withRowCumWeightedL2Distance = table_methods_mod.withRowCumWeightedL2Distance;
    pub const withRowPrefixWeightedEuclideanDistance = table_methods_mod.withRowPrefixWeightedEuclideanDistance;
    pub const withRowPrefixWeightedL2Distance = table_methods_mod.withRowPrefixWeightedL2Distance;
    pub const withRowCumulativeWeightedManhattanDistance = table_methods_mod.withRowCumulativeWeightedManhattanDistance;
    pub const withRowCumulativeWeightedL1Distance = table_methods_mod.withRowCumulativeWeightedL1Distance;
    pub const withRowCumWeightedManhattanDistance = table_methods_mod.withRowCumWeightedManhattanDistance;
    pub const withRowCumWeightedL1Distance = table_methods_mod.withRowCumWeightedL1Distance;
    pub const withRowPrefixWeightedManhattanDistance = table_methods_mod.withRowPrefixWeightedManhattanDistance;
    pub const withRowPrefixWeightedL1Distance = table_methods_mod.withRowPrefixWeightedL1Distance;
    pub const withRowCumulativeWeightedChebyshevDistance = table_methods_mod.withRowCumulativeWeightedChebyshevDistance;
    pub const withRowCumWeightedChebyshevDistance = table_methods_mod.withRowCumWeightedChebyshevDistance;
    pub const withRowPrefixWeightedChebyshevDistance = table_methods_mod.withRowPrefixWeightedChebyshevDistance;
    pub const withRowCumulativeWeightedCanberraDistance = table_methods_mod.withRowCumulativeWeightedCanberraDistance;
    pub const withRowCumWeightedCanberraDistance = table_methods_mod.withRowCumWeightedCanberraDistance;
    pub const withRowPrefixWeightedCanberraDistance = table_methods_mod.withRowPrefixWeightedCanberraDistance;
    pub const withRowCumulativeWeightedBrayCurtisDistance = table_methods_mod.withRowCumulativeWeightedBrayCurtisDistance;
    pub const withRowCumWeightedBrayCurtisDistance = table_methods_mod.withRowCumWeightedBrayCurtisDistance;
    pub const withRowPrefixWeightedBrayCurtisDistance = table_methods_mod.withRowPrefixWeightedBrayCurtisDistance;
    pub const withRowCumulativeWeightedMeanError = table_methods_mod.withRowCumulativeWeightedMeanError;
    pub const withRowCumulativeWeightedBias = table_methods_mod.withRowCumulativeWeightedBias;
    pub const withRowCumWeightedMeanError = table_methods_mod.withRowCumWeightedMeanError;
    pub const withRowCumWeightedBias = table_methods_mod.withRowCumWeightedBias;
    pub const withRowPrefixWeightedMeanError = table_methods_mod.withRowPrefixWeightedMeanError;
    pub const withRowPrefixWeightedBias = table_methods_mod.withRowPrefixWeightedBias;
    pub const withRowCumulativeWeightedMae = table_methods_mod.withRowCumulativeWeightedMae;
    pub const withRowCumulativeWeightedMAE = table_methods_mod.withRowCumulativeWeightedMAE;
    pub const withRowCumWeightedMae = table_methods_mod.withRowCumWeightedMae;
    pub const withRowCumWeightedMAE = table_methods_mod.withRowCumWeightedMAE;
    pub const withRowPrefixWeightedMae = table_methods_mod.withRowPrefixWeightedMae;
    pub const withRowPrefixWeightedMAE = table_methods_mod.withRowPrefixWeightedMAE;
    pub const withRowCumulativeWeightedMse = table_methods_mod.withRowCumulativeWeightedMse;
    pub const withRowCumulativeWeightedMSE = table_methods_mod.withRowCumulativeWeightedMSE;
    pub const withRowCumWeightedMse = table_methods_mod.withRowCumWeightedMse;
    pub const withRowCumWeightedMSE = table_methods_mod.withRowCumWeightedMSE;
    pub const withRowPrefixWeightedMse = table_methods_mod.withRowPrefixWeightedMse;
    pub const withRowPrefixWeightedMSE = table_methods_mod.withRowPrefixWeightedMSE;
    pub const withRowCumulativeWeightedRmse = table_methods_mod.withRowCumulativeWeightedRmse;
    pub const withRowCumulativeWeightedRMSE = table_methods_mod.withRowCumulativeWeightedRMSE;
    pub const withRowCumWeightedRmse = table_methods_mod.withRowCumWeightedRmse;
    pub const withRowCumWeightedRMSE = table_methods_mod.withRowCumWeightedRMSE;
    pub const withRowPrefixWeightedRmse = table_methods_mod.withRowPrefixWeightedRmse;
    pub const withRowPrefixWeightedRMSE = table_methods_mod.withRowPrefixWeightedRMSE;
    pub const withRowCumulativeWeightedMape = table_methods_mod.withRowCumulativeWeightedMape;
    pub const withRowCumulativeWeightedMAPE = table_methods_mod.withRowCumulativeWeightedMAPE;
    pub const withRowCumWeightedMape = table_methods_mod.withRowCumWeightedMape;
    pub const withRowCumWeightedMAPE = table_methods_mod.withRowCumWeightedMAPE;
    pub const withRowPrefixWeightedMape = table_methods_mod.withRowPrefixWeightedMape;
    pub const withRowPrefixWeightedMAPE = table_methods_mod.withRowPrefixWeightedMAPE;
    pub const withRowCumulativeWeightedSmape = table_methods_mod.withRowCumulativeWeightedSmape;
    pub const withRowCumulativeWeightedSMAPE = table_methods_mod.withRowCumulativeWeightedSMAPE;
    pub const withRowCumWeightedSmape = table_methods_mod.withRowCumWeightedSmape;
    pub const withRowCumWeightedSMAPE = table_methods_mod.withRowCumWeightedSMAPE;
    pub const withRowPrefixWeightedSmape = table_methods_mod.withRowPrefixWeightedSmape;
    pub const withRowPrefixWeightedSMAPE = table_methods_mod.withRowPrefixWeightedSMAPE;
    pub const withRowCumulativeWeightedCovariance = table_methods_mod.withRowCumulativeWeightedCovariance;
    pub const withRowCumulativeWeightedCov = table_methods_mod.withRowCumulativeWeightedCov;
    pub const withRowCumWeightedCovariance = table_methods_mod.withRowCumWeightedCovariance;
    pub const withRowCumWeightedCov = table_methods_mod.withRowCumWeightedCov;
    pub const withRowPrefixWeightedCovariance = table_methods_mod.withRowPrefixWeightedCovariance;
    pub const withRowPrefixWeightedCov = table_methods_mod.withRowPrefixWeightedCov;
    ...
    pub const withRowCumulativeWeightedSum = table_methods_mod.withRowCumulativeWeightedSum;
    pub const withRowCumWeightedSum = table_methods_mod.withRowCumWeightedSum;
    pub const withRowPrefixWeightedSum = table_methods_mod.withRowPrefixWeightedSum;
    pub const withRowCumulativeWeightedMean = table_methods_mod.withRowCumulativeWeightedMean;
    pub const withRowCumWeightedMean = table_methods_mod.withRowCumWeightedMean;
    pub const withRowPrefixWeightedMean = table_methods_mod.withRowPrefixWeightedMean;
    pub const withRowCumulativeWeightedAverage = table_methods_mod.withRowCumulativeWeightedAverage;
    pub const withRowCumulativeWeightedAvg = table_methods_mod.withRowCumulativeWeightedAvg;
    pub const withRowCumWeightedAverage = table_methods_mod.withRowCumWeightedAverage;
    pub const withRowCumWeightedAvg = table_methods_mod.withRowCumWeightedAvg;
    pub const withRowPrefixWeightedAverage = table_methods_mod.withRowPrefixWeightedAverage;
    pub const withRowPrefixWeightedAvg = table_methods_mod.withRowPrefixWeightedAvg;
    pub const withRowCumulativeWeightedMeanSquare = table_methods_mod.withRowCumulativeWeightedMeanSquare;
    pub const withRowCumulativeWeightedMeanSquared = table_methods_mod.withRowCumulativeWeightedMeanSquared;
    pub const withRowCumulativeWeightedMeanSq = table_methods_mod.withRowCumulativeWeightedMeanSq;
    pub const withRowCumWeightedMeanSquare = table_methods_mod.withRowCumWeightedMeanSquare;
    pub const withRowCumWeightedMeanSquared = table_methods_mod.withRowCumWeightedMeanSquared;
    pub const withRowCumWeightedMeanSq = table_methods_mod.withRowCumWeightedMeanSq;
    pub const withRowPrefixWeightedMeanSquare = table_methods_mod.withRowPrefixWeightedMeanSquare;
    pub const withRowPrefixWeightedMeanSquared = table_methods_mod.withRowPrefixWeightedMeanSquared;
    pub const withRowPrefixWeightedMeanSq = table_methods_mod.withRowPrefixWeightedMeanSq;
    pub const withRowCumulativeWeightedRms = table_methods_mod.withRowCumulativeWeightedRms;
    pub const withRowCumulativeWeightedRMS = table_methods_mod.withRowCumulativeWeightedRMS;
    pub const withRowCumWeightedRms = table_methods_mod.withRowCumWeightedRms;
    pub const withRowCumWeightedRMS = table_methods_mod.withRowCumWeightedRMS;
    pub const withRowPrefixWeightedRms = table_methods_mod.withRowPrefixWeightedRms;
    pub const withRowPrefixWeightedRMS = table_methods_mod.withRowPrefixWeightedRMS;
    pub const withRowCumulativeWeightedMeanAbs = table_methods_mod.withRowCumulativeWeightedMeanAbs;
    pub const withRowCumWeightedMeanAbs = table_methods_mod.withRowCumWeightedMeanAbs;
    pub const withRowPrefixWeightedMeanAbs = table_methods_mod.withRowPrefixWeightedMeanAbs;
    pub const withRowCumulativeWeightedL1Norm = table_methods_mod.withRowCumulativeWeightedL1Norm;
    pub const withRowCumulativeWeightedL1 = table_methods_mod.withRowCumulativeWeightedL1;
    pub const withRowCumWeightedL1Norm = table_methods_mod.withRowCumWeightedL1Norm;
    pub const withRowCumWeightedL1 = table_methods_mod.withRowCumWeightedL1;
    pub const withRowPrefixWeightedL1Norm = table_methods_mod.withRowPrefixWeightedL1Norm;
    pub const withRowPrefixWeightedL1 = table_methods_mod.withRowPrefixWeightedL1;
    pub const withRowCumulativeWeightedL2Norm = table_methods_mod.withRowCumulativeWeightedL2Norm;
    pub const withRowCumulativeWeightedL2 = table_methods_mod.withRowCumulativeWeightedL2;
    pub const withRowCumWeightedL2Norm = table_methods_mod.withRowCumWeightedL2Norm;
    pub const withRowCumWeightedL2 = table_methods_mod.withRowCumWeightedL2;
    pub const withRowPrefixWeightedL2Norm = table_methods_mod.withRowPrefixWeightedL2Norm;
    pub const withRowPrefixWeightedL2 = table_methods_mod.withRowPrefixWeightedL2;
    pub const withRowCumulativeWeightedMin = table_methods_mod.withRowCumulativeWeightedMin;
    pub const withRowCumulativeWeightedMinimum = table_methods_mod.withRowCumulativeWeightedMinimum;
    pub const withRowCumulativeWeightedMax = table_methods_mod.withRowCumulativeWeightedMax;
    pub const withRowCumulativeWeightedMaximum = table_methods_mod.withRowCumulativeWeightedMaximum;
    pub const withRowCumulativeWeightedMaxAbs = table_methods_mod.withRowCumulativeWeightedMaxAbs;
    pub const withRowCumulativeWeightedMaximumAbs = table_methods_mod.withRowCumulativeWeightedMaximumAbs;
    pub const withRowCumulativeWeightedMaxAbsolute = table_methods_mod.withRowCumulativeWeightedMaxAbsolute;
    pub const withRowCumulativeWeightedMinAbs = table_methods_mod.withRowCumulativeWeightedMinAbs;
    pub const withRowCumulativeWeightedMinimumAbs = table_methods_mod.withRowCumulativeWeightedMinimumAbs;
    pub const withRowCumulativeWeightedMinAbsolute = table_methods_mod.withRowCumulativeWeightedMinAbsolute;
    pub const withRowCumulativeWeightedRange = table_methods_mod.withRowCumulativeWeightedRange;
    pub const withRowCumulativeWeightedMidrange = table_methods_mod.withRowCumulativeWeightedMidrange;
    pub const withRowCumulativeWeightedRangeCoeff = table_methods_mod.withRowCumulativeWeightedRangeCoeff;
    pub const withRowCumulativeWeightedRangeCoefficient = table_methods_mod.withRowCumulativeWeightedRangeCoefficient;
    pub const withRowCumWeightedMin = table_methods_mod.withRowCumWeightedMin;
    pub const withRowCumWeightedMinimum = table_methods_mod.withRowCumWeightedMinimum;
    pub const withRowCumWeightedMax = table_methods_mod.withRowCumWeightedMax;
    pub const withRowCumWeightedMaximum = table_methods_mod.withRowCumWeightedMaximum;
    pub const withRowCumWeightedMaxAbs = table_methods_mod.withRowCumWeightedMaxAbs;
    pub const withRowCumWeightedMinAbs = table_methods_mod.withRowCumWeightedMinAbs;
    pub const withRowCumWeightedRange = table_methods_mod.withRowCumWeightedRange;
    pub const withRowCumWeightedMidrange = table_methods_mod.withRowCumWeightedMidrange;
    pub const withRowCumWeightedRangeCoeff = table_methods_mod.withRowCumWeightedRangeCoeff;
    pub const withRowCumWeightedRangeCoefficient = table_methods_mod.withRowCumWeightedRangeCoefficient;
    pub const withRowPrefixWeightedMin = table_methods_mod.withRowPrefixWeightedMin;
    pub const withRowPrefixWeightedMinimum = table_methods_mod.withRowPrefixWeightedMinimum;
    pub const withRowPrefixWeightedMax = table_methods_mod.withRowPrefixWeightedMax;
    pub const withRowPrefixWeightedMaximum = table_methods_mod.withRowPrefixWeightedMaximum;
    pub const withRowPrefixWeightedMaxAbs = table_methods_mod.withRowPrefixWeightedMaxAbs;
    pub const withRowPrefixWeightedMinAbs = table_methods_mod.withRowPrefixWeightedMinAbs;
    pub const withRowPrefixWeightedRange = table_methods_mod.withRowPrefixWeightedRange;
    pub const withRowPrefixWeightedMidrange = table_methods_mod.withRowPrefixWeightedMidrange;
    pub const withRowPrefixWeightedRangeCoeff = table_methods_mod.withRowPrefixWeightedRangeCoeff;
    pub const withRowPrefixWeightedRangeCoefficient = table_methods_mod.withRowPrefixWeightedRangeCoefficient;
    pub const withRowCumulativeWeightedProduct = table_methods_mod.withRowCumulativeWeightedProduct;
    pub const withRowCumulativeWeightedProd = table_methods_mod.withRowCumulativeWeightedProd;
    pub const withRowCumulativeWeightedGeometricMean = table_methods_mod.withRowCumulativeWeightedGeometricMean;
    pub const withRowCumulativeWeightedGeoMean = table_methods_mod.withRowCumulativeWeightedGeoMean;
    pub const withRowCumulativeWeightedHarmonicMean = table_methods_mod.withRowCumulativeWeightedHarmonicMean;
    pub const withRowCumulativeWeightedHarmMean = table_methods_mod.withRowCumulativeWeightedHarmMean;
    pub const withRowCumulativeWeightedLogSumExp = table_methods_mod.withRowCumulativeWeightedLogSumExp;
    pub const withRowCumulativeWeightedLogsumexp = table_methods_mod.withRowCumulativeWeightedLogsumexp;
    pub const withRowCumulativeWeightedLogMeanExp = table_methods_mod.withRowCumulativeWeightedLogMeanExp;
    pub const withRowCumulativeWeightedLogmeanexp = table_methods_mod.withRowCumulativeWeightedLogmeanexp;
    pub const withRowCumWeightedProduct = table_methods_mod.withRowCumWeightedProduct;
    pub const withRowCumWeightedProd = table_methods_mod.withRowCumWeightedProd;
    pub const withRowCumWeightedGeometricMean = table_methods_mod.withRowCumWeightedGeometricMean;
    pub const withRowCumWeightedGeoMean = table_methods_mod.withRowCumWeightedGeoMean;
    pub const withRowCumWeightedHarmonicMean = table_methods_mod.withRowCumWeightedHarmonicMean;
    pub const withRowCumWeightedHarmMean = table_methods_mod.withRowCumWeightedHarmMean;
    pub const withRowCumWeightedLogSumExp = table_methods_mod.withRowCumWeightedLogSumExp;
    pub const withRowCumWeightedLogsumexp = table_methods_mod.withRowCumWeightedLogsumexp;
    pub const withRowCumWeightedLogMeanExp = table_methods_mod.withRowCumWeightedLogMeanExp;
    pub const withRowCumWeightedLogmeanexp = table_methods_mod.withRowCumWeightedLogmeanexp;
    pub const withRowPrefixWeightedProduct = table_methods_mod.withRowPrefixWeightedProduct;
    pub const withRowPrefixWeightedProd = table_methods_mod.withRowPrefixWeightedProd;
    pub const withRowPrefixWeightedGeometricMean = table_methods_mod.withRowPrefixWeightedGeometricMean;
    pub const withRowPrefixWeightedGeoMean = table_methods_mod.withRowPrefixWeightedGeoMean;
    pub const withRowPrefixWeightedHarmonicMean = table_methods_mod.withRowPrefixWeightedHarmonicMean;
    pub const withRowPrefixWeightedHarmMean = table_methods_mod.withRowPrefixWeightedHarmMean;
    pub const withRowPrefixWeightedLogSumExp = table_methods_mod.withRowPrefixWeightedLogSumExp;
    pub const withRowPrefixWeightedLogsumexp = table_methods_mod.withRowPrefixWeightedLogsumexp;
    pub const withRowPrefixWeightedLogMeanExp = table_methods_mod.withRowPrefixWeightedLogMeanExp;
    pub const withRowPrefixWeightedLogmeanexp = table_methods_mod.withRowPrefixWeightedLogmeanexp;
    pub const withRowCumulativeWeightedVariance = table_methods_mod.withRowCumulativeWeightedVariance;
    pub const withRowCumulativeWeightedVar = table_methods_mod.withRowCumulativeWeightedVar;
    pub const withRowCumulativeWeightedStddev = table_methods_mod.withRowCumulativeWeightedStddev;
    pub const withRowCumulativeWeightedStd = table_methods_mod.withRowCumulativeWeightedStd;
    pub const withRowCumulativeWeightedSem = table_methods_mod.withRowCumulativeWeightedSem;
    pub const withRowCumulativeWeightedSEM = table_methods_mod.withRowCumulativeWeightedSEM;
    pub const withRowCumulativeWeightedCv = table_methods_mod.withRowCumulativeWeightedCv;
    pub const withRowCumulativeWeightedCV = table_methods_mod.withRowCumulativeWeightedCV;
    pub const withRowCumulativeWeightedFano = table_methods_mod.withRowCumulativeWeightedFano;
    pub const withRowCumWeightedVariance = table_methods_mod.withRowCumWeightedVariance;
    pub const withRowCumWeightedVar = table_methods_mod.withRowCumWeightedVar;
    pub const withRowCumWeightedStddev = table_methods_mod.withRowCumWeightedStddev;
    pub const withRowCumWeightedStd = table_methods_mod.withRowCumWeightedStd;
    pub const withRowCumWeightedSem = table_methods_mod.withRowCumWeightedSem;
    pub const withRowCumWeightedSEM = table_methods_mod.withRowCumWeightedSEM;
    pub const withRowCumWeightedCv = table_methods_mod.withRowCumWeightedCv;
    pub const withRowCumWeightedCV = table_methods_mod.withRowCumWeightedCV;
    pub const withRowCumWeightedFano = table_methods_mod.withRowCumWeightedFano;
    pub const withRowPrefixWeightedVariance = table_methods_mod.withRowPrefixWeightedVariance;
    pub const withRowPrefixWeightedVar = table_methods_mod.withRowPrefixWeightedVar;
    pub const withRowPrefixWeightedStddev = table_methods_mod.withRowPrefixWeightedStddev;
    pub const withRowPrefixWeightedStd = table_methods_mod.withRowPrefixWeightedStd;
    pub const withRowPrefixWeightedSem = table_methods_mod.withRowPrefixWeightedSem;
    pub const withRowPrefixWeightedSEM = table_methods_mod.withRowPrefixWeightedSEM;
    pub const withRowPrefixWeightedCv = table_methods_mod.withRowPrefixWeightedCv;
    pub const withRowPrefixWeightedCV = table_methods_mod.withRowPrefixWeightedCV;
    pub const withRowPrefixWeightedFano = table_methods_mod.withRowPrefixWeightedFano;
    pub const withRowCumulativeWeightedSkewness = table_methods_mod.withRowCumulativeWeightedSkewness;
    pub const withRowCumulativeWeightedSkew = table_methods_mod.withRowCumulativeWeightedSkew;
    pub const withRowCumulativeWeightedKurtosis = table_methods_mod.withRowCumulativeWeightedKurtosis;
    pub const withRowCumulativeWeightedKurt = table_methods_mod.withRowCumulativeWeightedKurt;
    pub const withRowCumWeightedSkewness = table_methods_mod.withRowCumWeightedSkewness;
    pub const withRowCumWeightedSkew = table_methods_mod.withRowCumWeightedSkew;
    pub const withRowCumWeightedKurtosis = table_methods_mod.withRowCumWeightedKurtosis;
    pub const withRowCumWeightedKurt = table_methods_mod.withRowCumWeightedKurt;
    pub const withRowPrefixWeightedSkewness = table_methods_mod.withRowPrefixWeightedSkewness;
    pub const withRowPrefixWeightedSkew = table_methods_mod.withRowPrefixWeightedSkew;
    pub const withRowPrefixWeightedKurtosis = table_methods_mod.withRowPrefixWeightedKurtosis;
    pub const withRowPrefixWeightedKurt = table_methods_mod.withRowPrefixWeightedKurt;
    pub const withRowCumulativeWeightedWeightSum = table_methods_mod.withRowCumulativeWeightedWeightSum;
    pub const withRowCumWeightedWeightSum = table_methods_mod.withRowCumWeightedWeightSum;
    pub const withRowPrefixWeightedWeightSum = table_methods_mod.withRowPrefixWeightedWeightSum;
    pub const withRowCumulativeWeightedPositiveCount = table_methods_mod.withRowCumulativeWeightedPositiveCount;
    pub const withRowCumWeightedPositiveCount = table_methods_mod.withRowCumWeightedPositiveCount;
    pub const withRowPrefixWeightedPositiveCount = table_methods_mod.withRowPrefixWeightedPositiveCount;
    pub const withRowCumulativeWeightedEffectiveN = table_methods_mod.withRowCumulativeWeightedEffectiveN;
    pub const withRowCumWeightedEffectiveN = table_methods_mod.withRowCumWeightedEffectiveN;
    pub const withRowPrefixWeightedEffectiveN = table_methods_mod.withRowPrefixWeightedEffectiveN;
    pub const withRowCumulativeWeightedEffectiveCount = table_methods_mod.withRowCumulativeWeightedEffectiveCount;
    pub const withRowCumWeightedEffectiveCount = table_methods_mod.withRowCumWeightedEffectiveCount;
    pub const withRowPrefixWeightedEffectiveCount = table_methods_mod.withRowPrefixWeightedEffectiveCount;
    ...
    pub const withRowWeightedEffectiveCount = table_methods_mod.withRowWeightedEffectiveCount;
    pub const withRowWeightedMeanSquare = table_methods_mod.withRowWeightedMeanSquare;
    pub const withRowWeightedMeanSquared = table_methods_mod.withRowWeightedMeanSquared;
    pub const withRowWeightedMeanSq = table_methods_mod.withRowWeightedMeanSq;
    pub const withRowWeightedRms = table_methods_mod.withRowWeightedRms;
    pub const withRowWeightedRMS = table_methods_mod.withRowWeightedRMS;
    pub const withRowWeightedMeanAbs = table_methods_mod.withRowWeightedMeanAbs;
    pub const withRowWeightedL1Norm = table_methods_mod.withRowWeightedL1Norm;
    pub const withRowWeightedL1 = table_methods_mod.withRowWeightedL1;
    pub const withRowWeightedL2Norm = table_methods_mod.withRowWeightedL2Norm;
    pub const withRowWeightedL2 = table_methods_mod.withRowWeightedL2;
    pub const withRowWeightedMin = table_methods_mod.withRowWeightedMin;
    pub const withRowWeightedMinimum = table_methods_mod.withRowWeightedMinimum;
    pub const withRowWeightedMax = table_methods_mod.withRowWeightedMax;
    pub const withRowWeightedMaximum = table_methods_mod.withRowWeightedMaximum;
    pub const withRowWeightedMaxAbs = table_methods_mod.withRowWeightedMaxAbs;
    pub const withRowWeightedMaximumAbs = table_methods_mod.withRowWeightedMaximumAbs;
    pub const withRowWeightedMaxAbsolute = table_methods_mod.withRowWeightedMaxAbsolute;
    pub const withRowWeightedMinAbs = table_methods_mod.withRowWeightedMinAbs;
    pub const withRowWeightedMinimumAbs = table_methods_mod.withRowWeightedMinimumAbs;
    pub const withRowWeightedMinAbsolute = table_methods_mod.withRowWeightedMinAbsolute;
    pub const withRowWeightedRange = table_methods_mod.withRowWeightedRange;
    pub const withRowWeightedMidrange = table_methods_mod.withRowWeightedMidrange;
    pub const withRowWeightedRangeCoeff = table_methods_mod.withRowWeightedRangeCoeff;
    pub const withRowWeightedRangeCoefficient = table_methods_mod.withRowWeightedRangeCoefficient;
    pub const withRowWeightedProduct = table_methods_mod.withRowWeightedProduct;
    pub const withRowWeightedProd = table_methods_mod.withRowWeightedProd;
    pub const withRowWeightedGeometricMean = table_methods_mod.withRowWeightedGeometricMean;
    pub const withRowWeightedGeoMean = table_methods_mod.withRowWeightedGeoMean;
    pub const withRowWeightedHarmonicMean = table_methods_mod.withRowWeightedHarmonicMean;
    pub const withRowWeightedHarmMean = table_methods_mod.withRowWeightedHarmMean;
    pub const withRowWeightedLogSumExp = table_methods_mod.withRowWeightedLogSumExp;
    pub const withRowWeightedLogsumexp = table_methods_mod.withRowWeightedLogsumexp;
    pub const withRowWeightedLogMeanExp = table_methods_mod.withRowWeightedLogMeanExp;
    pub const withRowWeightedLogmeanexp = table_methods_mod.withRowWeightedLogmeanexp;
    ...
    pub const withRowWeightedSem = table_methods_mod.withRowWeightedSem;
    pub const withRowWeightedSEM = table_methods_mod.withRowWeightedSEM;
    pub const withRowWeightedCv = table_methods_mod.withRowWeightedCv;
    pub const withRowWeightedCV = table_methods_mod.withRowWeightedCV;
    pub const withRowWeightedFano = table_methods_mod.withRowWeightedFano;
    pub const withRowWeightedSkewness = table_methods_mod.withRowWeightedSkewness;
    pub const withRowWeightedSkew = table_methods_mod.withRowWeightedSkew;
    pub const withRowWeightedKurtosis = table_methods_mod.withRowWeightedKurtosis;
    pub const withRowWeightedKurt = table_methods_mod.withRowWeightedKurt;
    pub const withRowWeightedDot = table_methods_mod.withRowWeightedDot;
    pub const withRowWeightedCosineSimilarity = table_methods_mod.withRowWeightedCosineSimilarity;
    pub const withRowWeightedCosine = table_methods_mod.withRowWeightedCosine;
    pub const withRowWeightedSquaredEuclideanDistance = table_methods_mod.withRowWeightedSquaredEuclideanDistance;
    pub const withRowWeightedSquaredDistance = table_methods_mod.withRowWeightedSquaredDistance;
    pub const withRowWeightedSqEuclideanDistance = table_methods_mod.withRowWeightedSqEuclideanDistance;
    pub const withRowWeightedEuclideanDistance = table_methods_mod.withRowWeightedEuclideanDistance;
    pub const withRowWeightedL2Distance = table_methods_mod.withRowWeightedL2Distance;
    pub const withRowWeightedManhattanDistance = table_methods_mod.withRowWeightedManhattanDistance;
    pub const withRowWeightedL1Distance = table_methods_mod.withRowWeightedL1Distance;
    pub const withRowWeightedChebyshevDistance = table_methods_mod.withRowWeightedChebyshevDistance;
    pub const withRowWeightedCanberraDistance = table_methods_mod.withRowWeightedCanberraDistance;
    pub const withRowWeightedBrayCurtisDistance = table_methods_mod.withRowWeightedBrayCurtisDistance;
    pub const withRowWeightedMeanError = table_methods_mod.withRowWeightedMeanError;
    pub const withRowWeightedBias = table_methods_mod.withRowWeightedBias;
    pub const withRowWeightedMae = table_methods_mod.withRowWeightedMae;
    pub const withRowWeightedMAE = table_methods_mod.withRowWeightedMAE;
    pub const withRowWeightedMse = table_methods_mod.withRowWeightedMse;
    pub const withRowWeightedMSE = table_methods_mod.withRowWeightedMSE;
    pub const withRowWeightedRmse = table_methods_mod.withRowWeightedRmse;
    pub const withRowWeightedRMSE = table_methods_mod.withRowWeightedRMSE;
    pub const withRowWeightedMape = table_methods_mod.withRowWeightedMape;
    pub const withRowWeightedMAPE = table_methods_mod.withRowWeightedMAPE;
    pub const withRowWeightedSmape = table_methods_mod.withRowWeightedSmape;
    pub const withRowWeightedSMAPE = table_methods_mod.withRowWeightedSMAPE;
    pub const withRowWeightedCovariance = table_methods_mod.withRowWeightedCovariance;
    pub const withRowWeightedCov = table_methods_mod.withRowWeightedCov;
    pub const withRowWeightedCorrelation = table_methods_mod.withRowWeightedCorrelation;
    pub const withRowWeightedCorr = table_methods_mod.withRowWeightedCorr;
    ...
    pub const withRowWeightedIQR = table_methods_mod.withRowWeightedIQR;
    pub const withRowCumulativeWeightedQuantile = table_methods_mod.withRowCumulativeWeightedQuantile;
    pub const withRowCumWeightedQuantile = table_methods_mod.withRowCumWeightedQuantile;
    pub const withRowPrefixWeightedQuantile = table_methods_mod.withRowPrefixWeightedQuantile;
    pub const withRowCumulativeWeightedMedian = table_methods_mod.withRowCumulativeWeightedMedian;
    pub const withRowCumWeightedMedian = table_methods_mod.withRowCumWeightedMedian;
    pub const withRowPrefixWeightedMedian = table_methods_mod.withRowPrefixWeightedMedian;
    pub const withRowCumulativeWeightedIqr = table_methods_mod.withRowCumulativeWeightedIqr;
    pub const withRowCumulativeWeightedIQR = table_methods_mod.withRowCumulativeWeightedIQR;
    pub const withRowCumWeightedIqr = table_methods_mod.withRowCumWeightedIqr;
    pub const withRowCumWeightedIQR = table_methods_mod.withRowCumWeightedIQR;
    pub const withRowPrefixWeightedIqr = table_methods_mod.withRowPrefixWeightedIqr;
    pub const withRowPrefixWeightedIQR = table_methods_mod.withRowPrefixWeightedIQR;
    pub const withRowCumulativeWeightedMad = table_methods_mod.withRowCumulativeWeightedMad;
    pub const withRowCumulativeWeightedMAD = table_methods_mod.withRowCumulativeWeightedMAD;
    pub const withRowCumWeightedMad = table_methods_mod.withRowCumWeightedMad;
    pub const withRowCumWeightedMAD = table_methods_mod.withRowCumWeightedMAD;
    pub const withRowPrefixWeightedMad = table_methods_mod.withRowPrefixWeightedMad;
    pub const withRowPrefixWeightedMAD = table_methods_mod.withRowPrefixWeightedMAD;
    pub const withRowCumulativeWeightedTrimmedMean = table_methods_mod.withRowCumulativeWeightedTrimmedMean;
    pub const withRowCumWeightedTrimmedMean = table_methods_mod.withRowCumWeightedTrimmedMean;
    pub const withRowPrefixWeightedTrimmedMean = table_methods_mod.withRowPrefixWeightedTrimmedMean;
    pub const withRowCumulativeWeightedWinsorizedMean = table_methods_mod.withRowCumulativeWeightedWinsorizedMean;
    pub const withRowCumWeightedWinsorizedMean = table_methods_mod.withRowCumWeightedWinsorizedMean;
    pub const withRowPrefixWeightedWinsorizedMean = table_methods_mod.withRowPrefixWeightedWinsorizedMean;
    pub const withRowCumulativeWeightedInterdecileRange = table_methods_mod.withRowCumulativeWeightedInterdecileRange;
    pub const withRowCumulativeWeightedIdr = table_methods_mod.withRowCumulativeWeightedIdr;
    pub const withRowCumulativeWeightedIDR = table_methods_mod.withRowCumulativeWeightedIDR;
    pub const withRowCumWeightedInterdecileRange = table_methods_mod.withRowCumWeightedInterdecileRange;
    pub const withRowCumWeightedIdr = table_methods_mod.withRowCumWeightedIdr;
    pub const withRowCumWeightedIDR = table_methods_mod.withRowCumWeightedIDR;
    pub const withRowPrefixWeightedInterdecileRange = table_methods_mod.withRowPrefixWeightedInterdecileRange;
    pub const withRowPrefixWeightedIdr = table_methods_mod.withRowPrefixWeightedIdr;
    pub const withRowPrefixWeightedIDR = table_methods_mod.withRowPrefixWeightedIDR;
    pub const withRowCumulativeWeightedMidhinge = table_methods_mod.withRowCumulativeWeightedMidhinge;
    pub const withRowCumWeightedMidhinge = table_methods_mod.withRowCumWeightedMidhinge;
    pub const withRowPrefixWeightedMidhinge = table_methods_mod.withRowPrefixWeightedMidhinge;
    pub const withRowCumulativeWeightedTrimean = table_methods_mod.withRowCumulativeWeightedTrimean;
    pub const withRowCumWeightedTrimean = table_methods_mod.withRowCumWeightedTrimean;
    pub const withRowPrefixWeightedTrimean = table_methods_mod.withRowPrefixWeightedTrimean;
    pub const withRowCumulativeWeightedBowleySkewness = table_methods_mod.withRowCumulativeWeightedBowleySkewness;
    pub const withRowCumulativeWeightedBowleySkew = table_methods_mod.withRowCumulativeWeightedBowleySkew;
    pub const withRowCumWeightedBowleySkewness = table_methods_mod.withRowCumWeightedBowleySkewness;
    pub const withRowCumWeightedBowleySkew = table_methods_mod.withRowCumWeightedBowleySkew;
    pub const withRowPrefixWeightedBowleySkewness = table_methods_mod.withRowPrefixWeightedBowleySkewness;
    pub const withRowPrefixWeightedBowleySkew = table_methods_mod.withRowPrefixWeightedBowleySkew;
    pub const withRowCumulativeWeightedQuartileCoeffDispersion = table_methods_mod.withRowCumulativeWeightedQuartileCoeffDispersion;
    pub const withRowCumulativeWeightedQcd = table_methods_mod.withRowCumulativeWeightedQcd;
    pub const withRowCumulativeWeightedQCD = table_methods_mod.withRowCumulativeWeightedQCD;
    pub const withRowCumWeightedQuartileCoeffDispersion = table_methods_mod.withRowCumWeightedQuartileCoeffDispersion;
    pub const withRowCumWeightedQcd = table_methods_mod.withRowCumWeightedQcd;
    pub const withRowCumWeightedQCD = table_methods_mod.withRowCumWeightedQCD;
    pub const withRowPrefixWeightedQuartileCoeffDispersion = table_methods_mod.withRowPrefixWeightedQuartileCoeffDispersion;
    pub const withRowPrefixWeightedQcd = table_methods_mod.withRowPrefixWeightedQcd;
    pub const withRowPrefixWeightedQCD = table_methods_mod.withRowPrefixWeightedQCD;
    pub const withRowCumulativeWeightedKelleySkewness = table_methods_mod.withRowCumulativeWeightedKelleySkewness;
    pub const withRowCumulativeWeightedKelleySkew = table_methods_mod.withRowCumulativeWeightedKelleySkew;
    pub const withRowCumWeightedKelleySkewness = table_methods_mod.withRowCumWeightedKelleySkewness;
    pub const withRowCumWeightedKelleySkew = table_methods_mod.withRowCumWeightedKelleySkew;
    pub const withRowPrefixWeightedKelleySkewness = table_methods_mod.withRowPrefixWeightedKelleySkewness;
    pub const withRowPrefixWeightedKelleySkew = table_methods_mod.withRowPrefixWeightedKelleySkew;
    pub const withRowCumulativeWeightedMode = table_methods_mod.withRowCumulativeWeightedMode;
    pub const withRowCumWeightedMode = table_methods_mod.withRowCumWeightedMode;
    pub const withRowPrefixWeightedMode = table_methods_mod.withRowPrefixWeightedMode;
    pub const withRowCumulativeWeightedModeWeight = table_methods_mod.withRowCumulativeWeightedModeWeight;
    pub const withRowCumWeightedModeWeight = table_methods_mod.withRowCumWeightedModeWeight;
    pub const withRowPrefixWeightedModeWeight = table_methods_mod.withRowPrefixWeightedModeWeight;
    pub const withRowCumulativeWeightedModeRatio = table_methods_mod.withRowCumulativeWeightedModeRatio;
    pub const withRowCumWeightedModeRatio = table_methods_mod.withRowCumWeightedModeRatio;
    pub const withRowPrefixWeightedModeRatio = table_methods_mod.withRowPrefixWeightedModeRatio;
    pub const withRowCumulativeWeightedModeMargin = table_methods_mod.withRowCumulativeWeightedModeMargin;
    pub const withRowCumWeightedModeMargin = table_methods_mod.withRowCumWeightedModeMargin;
    pub const withRowPrefixWeightedModeMargin = table_methods_mod.withRowPrefixWeightedModeMargin;
    pub const withRowCumulativeWeightedModeMarginRatio = table_methods_mod.withRowCumulativeWeightedModeMarginRatio;
    pub const withRowCumWeightedModeMarginRatio = table_methods_mod.withRowCumWeightedModeMarginRatio;
    pub const withRowPrefixWeightedModeMarginRatio = table_methods_mod.withRowPrefixWeightedModeMarginRatio;
    pub const withRowCumulativeWeightedEntropy = table_methods_mod.withRowCumulativeWeightedEntropy;
    pub const withRowCumWeightedEntropy = table_methods_mod.withRowCumWeightedEntropy;
    pub const withRowPrefixWeightedEntropy = table_methods_mod.withRowPrefixWeightedEntropy;
    pub const withRowCumulativeWeightedGiniImpurity = table_methods_mod.withRowCumulativeWeightedGiniImpurity;
    pub const withRowCumulativeWeightedGini = table_methods_mod.withRowCumulativeWeightedGini;
    pub const withRowCumWeightedGiniImpurity = table_methods_mod.withRowCumWeightedGiniImpurity;
    pub const withRowCumWeightedGini = table_methods_mod.withRowCumWeightedGini;
    pub const withRowPrefixWeightedGiniImpurity = table_methods_mod.withRowPrefixWeightedGiniImpurity;
    pub const withRowPrefixWeightedGini = table_methods_mod.withRowPrefixWeightedGini;
    pub const withRowCumulativeWeightedPerplexity = table_methods_mod.withRowCumulativeWeightedPerplexity;
    pub const withRowCumWeightedPerplexity = table_methods_mod.withRowCumWeightedPerplexity;
    pub const withRowPrefixWeightedPerplexity = table_methods_mod.withRowPrefixWeightedPerplexity;
    pub const withRowCumulativeWeightedInverseSimpson = table_methods_mod.withRowCumulativeWeightedInverseSimpson;
    pub const withRowCumWeightedInverseSimpson = table_methods_mod.withRowCumWeightedInverseSimpson;
    pub const withRowPrefixWeightedInverseSimpson = table_methods_mod.withRowPrefixWeightedInverseSimpson;
    pub const withRowCumulativeWeightedSimpsonConcentration = table_methods_mod.withRowCumulativeWeightedSimpsonConcentration;
    pub const withRowCumulativeWeightedConcentration = table_methods_mod.withRowCumulativeWeightedConcentration;
    pub const withRowCumWeightedSimpsonConcentration = table_methods_mod.withRowCumWeightedSimpsonConcentration;
    pub const withRowCumWeightedConcentration = table_methods_mod.withRowCumWeightedConcentration;
    pub const withRowPrefixWeightedSimpsonConcentration = table_methods_mod.withRowPrefixWeightedSimpsonConcentration;
    pub const withRowPrefixWeightedConcentration = table_methods_mod.withRowPrefixWeightedConcentration;
    pub const withRowCumulativeWeightedEvenness = table_methods_mod.withRowCumulativeWeightedEvenness;
    pub const withRowCumWeightedEvenness = table_methods_mod.withRowCumWeightedEvenness;
    pub const withRowPrefixWeightedEvenness = table_methods_mod.withRowPrefixWeightedEvenness;
    pub const withRowCumulativeWeightedMeanAbsDev = table_methods_mod.withRowCumulativeWeightedMeanAbsDev;
    pub const withRowCumulativeWeightedMeanAbsDevRatio = table_methods_mod.withRowCumulativeWeightedMeanAbsDevRatio;
    pub const withRowCumulativeWeightedMeanAbsoluteDeviation = table_methods_mod.withRowCumulativeWeightedMeanAbsoluteDeviation;
    pub const withRowCumulativeWeightedMadRatio = table_methods_mod.withRowCumulativeWeightedMadRatio;
    pub const withRowCumulativeWeightedGiniMeanDiff = table_methods_mod.withRowCumulativeWeightedGiniMeanDiff;
    pub const withRowCumulativeWeightedGiniCoefficient = table_methods_mod.withRowCumulativeWeightedGiniCoefficient;
    pub const withRowCumulativeWeightedGiniCoeff = table_methods_mod.withRowCumulativeWeightedGiniCoeff;
    pub const withRowCumWeightedMeanAbsDev = table_methods_mod.withRowCumWeightedMeanAbsDev;
    pub const withRowCumWeightedMeanAbsDevRatio = table_methods_mod.withRowCumWeightedMeanAbsDevRatio;
    pub const withRowCumWeightedMeanAbsoluteDeviation = table_methods_mod.withRowCumWeightedMeanAbsoluteDeviation;
    pub const withRowCumWeightedMadRatio = table_methods_mod.withRowCumWeightedMadRatio;
    pub const withRowCumWeightedGiniMeanDiff = table_methods_mod.withRowCumWeightedGiniMeanDiff;
    pub const withRowCumWeightedGiniCoefficient = table_methods_mod.withRowCumWeightedGiniCoefficient;
    pub const withRowCumWeightedGiniCoeff = table_methods_mod.withRowCumWeightedGiniCoeff;
    pub const withRowPrefixWeightedMeanAbsDev = table_methods_mod.withRowPrefixWeightedMeanAbsDev;
    pub const withRowPrefixWeightedMeanAbsDevRatio = table_methods_mod.withRowPrefixWeightedMeanAbsDevRatio;
    pub const withRowPrefixWeightedMeanAbsoluteDeviation = table_methods_mod.withRowPrefixWeightedMeanAbsoluteDeviation;
    pub const withRowPrefixWeightedMadRatio = table_methods_mod.withRowPrefixWeightedMadRatio;
    pub const withRowPrefixWeightedGiniMeanDiff = table_methods_mod.withRowPrefixWeightedGiniMeanDiff;
    pub const withRowPrefixWeightedGiniCoefficient = table_methods_mod.withRowPrefixWeightedGiniCoefficient;
    pub const withRowPrefixWeightedGiniCoeff = table_methods_mod.withRowPrefixWeightedGiniCoeff;
    pub const withRowWeightedMad = table_methods_mod.withRowWeightedMad;
    pub const withRowWeightedMAD = table_methods_mod.withRowWeightedMAD;
    pub const withRowWeightedTrimmedMean = table_methods_mod.withRowWeightedTrimmedMean;
    pub const withRowWeightedWinsorizedMean = table_methods_mod.withRowWeightedWinsorizedMean;
    pub const withRowWeightedInterdecileRange = table_methods_mod.withRowWeightedInterdecileRange;
    pub const withRowWeightedIdr = table_methods_mod.withRowWeightedIdr;
    pub const withRowWeightedIDR = table_methods_mod.withRowWeightedIDR;
    pub const withRowWeightedMidhinge = table_methods_mod.withRowWeightedMidhinge;
    pub const withRowWeightedTrimean = table_methods_mod.withRowWeightedTrimean;
    pub const withRowWeightedBowleySkewness = table_methods_mod.withRowWeightedBowleySkewness;
    pub const withRowWeightedBowleySkew = table_methods_mod.withRowWeightedBowleySkew;
    pub const withRowWeightedQuartileCoeffDispersion = table_methods_mod.withRowWeightedQuartileCoeffDispersion;
    pub const withRowWeightedQcd = table_methods_mod.withRowWeightedQcd;
    pub const withRowWeightedQCD = table_methods_mod.withRowWeightedQCD;
    pub const withRowWeightedKelleySkewness = table_methods_mod.withRowWeightedKelleySkewness;
    pub const withRowWeightedKelleySkew = table_methods_mod.withRowWeightedKelleySkew;
    ...
    pub const withRowWeightedGini = table_methods_mod.withRowWeightedGini;
    ...
    pub const withRowWeightedConcentration = table_methods_mod.withRowWeightedConcentration;
    pub const withRowWeightedEvenness = table_methods_mod.withRowWeightedEvenness;
    pub const withRowWeightedMeanAbsDev = table_methods_mod.withRowWeightedMeanAbsDev;
    pub const withRowWeightedMeanAbsoluteDeviation = table_methods_mod.withRowWeightedMeanAbsoluteDeviation;
    pub const withRowWeightedMeanAbsDevRatio = table_methods_mod.withRowWeightedMeanAbsDevRatio;
    pub const withRowWeightedMadRatio = table_methods_mod.withRowWeightedMadRatio;
    pub const withRowWeightedGiniMeanDiff = table_methods_mod.withRowWeightedGiniMeanDiff;
    pub const withRowWeightedGiniCoefficient = table_methods_mod.withRowWeightedGiniCoefficient;
    pub const withRowWeightedGiniCoeff = table_methods_mod.withRowWeightedGiniCoeff;
    ...
    pub const withGroupCumulativeEntropy = relation_methods_mod.withGroupCumulativeEntropy;
    pub const withGroupCumulativeEntropyOn = relation_methods_mod.withGroupCumulativeEntropyOn;
    pub const withGroupCumulativeGiniImpurity = relation_methods_mod.withGroupCumulativeGiniImpurity;
    pub const withGroupCumulativeGiniImpurityOn = relation_methods_mod.withGroupCumulativeGiniImpurityOn;
    pub const withGroupCumulativePerplexity = relation_methods_mod.withGroupCumulativePerplexity;
    pub const withGroupCumulativePerplexityOn = relation_methods_mod.withGroupCumulativePerplexityOn;
    pub const withGroupCumulativeInverseSimpson = relation_methods_mod.withGroupCumulativeInverseSimpson;
    pub const withGroupCumulativeInverseSimpsonOn = relation_methods_mod.withGroupCumulativeInverseSimpsonOn;
    pub const withGroupCumulativeSimpsonConcentration = relation_methods_mod.withGroupCumulativeSimpsonConcentration;
    pub const withGroupCumulativeSimpsonConcentrationOn = relation_methods_mod.withGroupCumulativeSimpsonConcentrationOn;
    pub const withGroupCumulativeEvenness = relation_methods_mod.withGroupCumulativeEvenness;
    pub const withGroupCumulativeEvennessOn = relation_methods_mod.withGroupCumulativeEvennessOn;
    pub const withGroupCumulativeGini = relation_methods_mod.withGroupCumulativeGini;
    pub const withGroupCumulativeGiniOn = relation_methods_mod.withGroupCumulativeGiniOn;
    pub const withGroupCumulativeConcentration = relation_methods_mod.withGroupCumulativeConcentration;
    pub const withGroupCumulativeConcentrationOn = relation_methods_mod.withGroupCumulativeConcentrationOn;
    pub const withGroupCumEntropy = relation_methods_mod.withGroupCumEntropy;
    pub const withGroupCumEntropyOn = relation_methods_mod.withGroupCumEntropyOn;
    pub const withGroupCumGiniImpurity = relation_methods_mod.withGroupCumGiniImpurity;
    pub const withGroupCumGiniImpurityOn = relation_methods_mod.withGroupCumGiniImpurityOn;
    pub const withGroupCumPerplexity = relation_methods_mod.withGroupCumPerplexity;
    pub const withGroupCumPerplexityOn = relation_methods_mod.withGroupCumPerplexityOn;
    pub const withGroupCumInverseSimpson = relation_methods_mod.withGroupCumInverseSimpson;
    pub const withGroupCumInverseSimpsonOn = relation_methods_mod.withGroupCumInverseSimpsonOn;
    pub const withGroupCumSimpsonConcentration = relation_methods_mod.withGroupCumSimpsonConcentration;
    pub const withGroupCumSimpsonConcentrationOn = relation_methods_mod.withGroupCumSimpsonConcentrationOn;
    pub const withGroupCumEvenness = relation_methods_mod.withGroupCumEvenness;
    pub const withGroupCumEvennessOn = relation_methods_mod.withGroupCumEvennessOn;
    pub const withGroupCumGini = relation_methods_mod.withGroupCumGini;
    pub const withGroupCumGiniOn = relation_methods_mod.withGroupCumGiniOn;
    pub const withGroupCumConcentration = relation_methods_mod.withGroupCumConcentration;
    pub const withGroupCumConcentrationOn = relation_methods_mod.withGroupCumConcentrationOn;
    pub const withGroupCumulativeMeanAbsDev = relation_methods_mod.withGroupCumulativeMeanAbsDev;
    pub const withGroupCumulativeMeanAbsDevOn = relation_methods_mod.withGroupCumulativeMeanAbsDevOn;
    pub const withGroupCumulativeMeanAbsDevRatio = relation_methods_mod.withGroupCumulativeMeanAbsDevRatio;
    pub const withGroupCumulativeMeanAbsDevRatioOn = relation_methods_mod.withGroupCumulativeMeanAbsDevRatioOn;
    pub const withGroupCumulativeGiniMeanDiff = relation_methods_mod.withGroupCumulativeGiniMeanDiff;
    pub const withGroupCumulativeGiniMeanDiffOn = relation_methods_mod.withGroupCumulativeGiniMeanDiffOn;
    pub const withGroupCumulativeGiniCoefficient = relation_methods_mod.withGroupCumulativeGiniCoefficient;
    pub const withGroupCumulativeGiniCoefficientOn = relation_methods_mod.withGroupCumulativeGiniCoefficientOn;
    pub const withGroupCumulativeMeanAbsoluteDeviation = relation_methods_mod.withGroupCumulativeMeanAbsoluteDeviation;
    pub const withGroupCumulativeMeanAbsoluteDeviationOn = relation_methods_mod.withGroupCumulativeMeanAbsoluteDeviationOn;
    pub const withGroupCumulativeGiniCoeff = relation_methods_mod.withGroupCumulativeGiniCoeff;
    pub const withGroupCumulativeGiniCoeffOn = relation_methods_mod.withGroupCumulativeGiniCoeffOn;
    pub const withGroupCumMeanAbsDev = relation_methods_mod.withGroupCumMeanAbsDev;
    pub const withGroupCumMeanAbsDevOn = relation_methods_mod.withGroupCumMeanAbsDevOn;
    pub const withGroupCumMeanAbsDevRatio = relation_methods_mod.withGroupCumMeanAbsDevRatio;
    pub const withGroupCumMeanAbsDevRatioOn = relation_methods_mod.withGroupCumMeanAbsDevRatioOn;
    pub const withGroupCumGiniMeanDiff = relation_methods_mod.withGroupCumGiniMeanDiff;
    pub const withGroupCumGiniMeanDiffOn = relation_methods_mod.withGroupCumGiniMeanDiffOn;
    pub const withGroupCumGiniCoefficient = relation_methods_mod.withGroupCumGiniCoefficient;
    pub const withGroupCumGiniCoefficientOn = relation_methods_mod.withGroupCumGiniCoefficientOn;
    pub const withGroupCumMeanAbsoluteDeviation = relation_methods_mod.withGroupCumMeanAbsoluteDeviation;
    pub const withGroupCumMeanAbsoluteDeviationOn = relation_methods_mod.withGroupCumMeanAbsoluteDeviationOn;
    pub const withGroupCumGiniCoeff = relation_methods_mod.withGroupCumGiniCoeff;
    pub const withGroupCumGiniCoeffOn = relation_methods_mod.withGroupCumGiniCoeffOn;
    pub const withGroupCumulativeMedian = relation_methods_mod.withGroupCumulativeMedian;
    pub const withGroupCumulativeMedianOn = relation_methods_mod.withGroupCumulativeMedianOn;
    pub const withGroupCumulativeQuantile = relation_methods_mod.withGroupCumulativeQuantile;
    pub const withGroupCumulativeQuantileOn = relation_methods_mod.withGroupCumulativeQuantileOn;
    pub const withGroupCumQuantile = relation_methods_mod.withGroupCumQuantile;
    pub const withGroupCumQuantileOn = relation_methods_mod.withGroupCumQuantileOn;
    pub const withGroupCumMedian = relation_methods_mod.withGroupCumMedian;
    pub const withGroupCumMedianOn = relation_methods_mod.withGroupCumMedianOn;
    pub const withGroupCumulativeIqr = relation_methods_mod.withGroupCumulativeIqr;
    pub const withGroupCumulativeIqrOn = relation_methods_mod.withGroupCumulativeIqrOn;
    pub const withGroupCumulativeIQR = relation_methods_mod.withGroupCumulativeIQR;
    pub const withGroupCumulativeIQROn = relation_methods_mod.withGroupCumulativeIQROn;
    pub const withGroupCumIqr = relation_methods_mod.withGroupCumIqr;
    pub const withGroupCumIqrOn = relation_methods_mod.withGroupCumIqrOn;
    pub const withGroupCumIQR = relation_methods_mod.withGroupCumIQR;
    pub const withGroupCumIQROn = relation_methods_mod.withGroupCumIQROn;
    pub const withGroupCumulativeMad = relation_methods_mod.withGroupCumulativeMad;
    pub const withGroupCumulativeMadOn = relation_methods_mod.withGroupCumulativeMadOn;
    pub const withGroupCumulativeMAD = relation_methods_mod.withGroupCumulativeMAD;
    pub const withGroupCumulativeMADOn = relation_methods_mod.withGroupCumulativeMADOn;
    pub const withGroupCumulativeMedianAbsDev = relation_methods_mod.withGroupCumulativeMedianAbsDev;
    pub const withGroupCumulativeMedianAbsDevOn = relation_methods_mod.withGroupCumulativeMedianAbsDevOn;
    pub const withGroupCumMad = relation_methods_mod.withGroupCumMad;
    pub const withGroupCumMadOn = relation_methods_mod.withGroupCumMadOn;
    pub const withGroupCumMAD = relation_methods_mod.withGroupCumMAD;
    pub const withGroupCumMADOn = relation_methods_mod.withGroupCumMADOn;
    pub const withGroupCumMedianAbsDev = relation_methods_mod.withGroupCumMedianAbsDev;
    pub const withGroupCumMedianAbsDevOn = relation_methods_mod.withGroupCumMedianAbsDevOn;
    pub const withGroupCumulativeTrimmedMean = relation_methods_mod.withGroupCumulativeTrimmedMean;
    pub const withGroupCumulativeTrimmedMeanOn = relation_methods_mod.withGroupCumulativeTrimmedMeanOn;
    pub const withGroupCumTrimmedMean = relation_methods_mod.withGroupCumTrimmedMean;
    pub const withGroupCumTrimmedMeanOn = relation_methods_mod.withGroupCumTrimmedMeanOn;
    pub const withGroupCumulativeWinsorizedMean = relation_methods_mod.withGroupCumulativeWinsorizedMean;
    pub const withGroupCumulativeWinsorizedMeanOn = relation_methods_mod.withGroupCumulativeWinsorizedMeanOn;
    pub const withGroupCumWinsorizedMean = relation_methods_mod.withGroupCumWinsorizedMean;
    pub const withGroupCumWinsorizedMeanOn = relation_methods_mod.withGroupCumWinsorizedMeanOn;
    pub const withGroupCumulativeInterdecileRange = relation_methods_mod.withGroupCumulativeInterdecileRange;
    pub const withGroupCumulativeInterdecileRangeOn = relation_methods_mod.withGroupCumulativeInterdecileRangeOn;
    pub const withGroupCumulativeIdr = relation_methods_mod.withGroupCumulativeIdr;
    pub const withGroupCumulativeIdrOn = relation_methods_mod.withGroupCumulativeIdrOn;
    pub const withGroupCumulativeIDR = relation_methods_mod.withGroupCumulativeIDR;
    pub const withGroupCumulativeIDROn = relation_methods_mod.withGroupCumulativeIDROn;
    pub const withGroupCumIdr = relation_methods_mod.withGroupCumIdr;
    pub const withGroupCumIdrOn = relation_methods_mod.withGroupCumIdrOn;
    pub const withGroupCumIDR = relation_methods_mod.withGroupCumIDR;
    pub const withGroupCumIDROn = relation_methods_mod.withGroupCumIDROn;
    pub const withGroupCumulativeMidhinge = relation_methods_mod.withGroupCumulativeMidhinge;
    pub const withGroupCumulativeMidhingeOn = relation_methods_mod.withGroupCumulativeMidhingeOn;
    pub const withGroupCumMidhinge = relation_methods_mod.withGroupCumMidhinge;
    pub const withGroupCumMidhingeOn = relation_methods_mod.withGroupCumMidhingeOn;
    pub const withGroupCumulativeTrimean = relation_methods_mod.withGroupCumulativeTrimean;
    pub const withGroupCumulativeTrimeanOn = relation_methods_mod.withGroupCumulativeTrimeanOn;
    pub const withGroupCumTrimean = relation_methods_mod.withGroupCumTrimean;
    pub const withGroupCumTrimeanOn = relation_methods_mod.withGroupCumTrimeanOn;
    pub const withGroupCumulativeBowleySkewness = relation_methods_mod.withGroupCumulativeBowleySkewness;
    pub const withGroupCumulativeBowleySkewnessOn = relation_methods_mod.withGroupCumulativeBowleySkewnessOn;
    pub const withGroupCumulativeBowleySkew = relation_methods_mod.withGroupCumulativeBowleySkew;
    pub const withGroupCumulativeBowleySkewOn = relation_methods_mod.withGroupCumulativeBowleySkewOn;
    pub const withGroupCumBowleySkewness = relation_methods_mod.withGroupCumBowleySkewness;
    pub const withGroupCumBowleySkewnessOn = relation_methods_mod.withGroupCumBowleySkewnessOn;
    pub const withGroupCumBowleySkew = relation_methods_mod.withGroupCumBowleySkew;
    pub const withGroupCumBowleySkewOn = relation_methods_mod.withGroupCumBowleySkewOn;
    pub const withGroupCumulativeQuartileCoeffDispersion = relation_methods_mod.withGroupCumulativeQuartileCoeffDispersion;
    pub const withGroupCumulativeQuartileCoeffDispersionOn = relation_methods_mod.withGroupCumulativeQuartileCoeffDispersionOn;
    pub const withGroupCumulativeQcd = relation_methods_mod.withGroupCumulativeQcd;
    pub const withGroupCumulativeQcdOn = relation_methods_mod.withGroupCumulativeQcdOn;
    pub const withGroupCumulativeQCD = relation_methods_mod.withGroupCumulativeQCD;
    pub const withGroupCumulativeQCDOn = relation_methods_mod.withGroupCumulativeQCDOn;
    pub const withGroupCumQuartileCoeffDispersion = relation_methods_mod.withGroupCumQuartileCoeffDispersion;
    pub const withGroupCumQuartileCoeffDispersionOn = relation_methods_mod.withGroupCumQuartileCoeffDispersionOn;
    pub const withGroupCumQcd = relation_methods_mod.withGroupCumQcd;
    pub const withGroupCumQcdOn = relation_methods_mod.withGroupCumQcdOn;
    pub const withGroupCumQCD = relation_methods_mod.withGroupCumQCD;
    pub const withGroupCumQCDOn = relation_methods_mod.withGroupCumQCDOn;
    pub const withGroupCumulativeKelleySkewness = relation_methods_mod.withGroupCumulativeKelleySkewness;
    pub const withGroupCumulativeKelleySkewnessOn = relation_methods_mod.withGroupCumulativeKelleySkewnessOn;
    pub const withGroupCumulativeKelleySkew = relation_methods_mod.withGroupCumulativeKelleySkew;
    pub const withGroupCumulativeKelleySkewOn = relation_methods_mod.withGroupCumulativeKelleySkewOn;
    pub const withGroupCumKelleySkewness = relation_methods_mod.withGroupCumKelleySkewness;
    pub const withGroupCumKelleySkewnessOn = relation_methods_mod.withGroupCumKelleySkewnessOn;
    pub const withGroupCumKelleySkew = relation_methods_mod.withGroupCumKelleySkew;
    pub const withGroupCumKelleySkewOn = relation_methods_mod.withGroupCumKelleySkewOn;
    ...
    pub const withGroupCumulativeWeightedMean = relation_methods_mod.withGroupCumulativeWeightedMean;
    pub const withGroupCumulativeWeightedMeanOn = relation_methods_mod.withGroupCumulativeWeightedMeanOn;
    pub const withGroupCumulativeWeightedSum = relation_methods_mod.withGroupCumulativeWeightedSum;
    pub const withGroupCumulativeWeightedSumOn = relation_methods_mod.withGroupCumulativeWeightedSumOn;
    pub const withGroupCumulativeWeightedProduct = relation_methods_mod.withGroupCumulativeWeightedProduct;
    pub const withGroupCumulativeWeightedProductOn = relation_methods_mod.withGroupCumulativeWeightedProductOn;
    pub const withGroupCumulativeWeightedWeightSum = relation_methods_mod.withGroupCumulativeWeightedWeightSum;
    pub const withGroupCumulativeWeightedWeightSumOn = relation_methods_mod.withGroupCumulativeWeightedWeightSumOn;
    pub const withGroupCumulativeWeightedPositiveCount = relation_methods_mod.withGroupCumulativeWeightedPositiveCount;
    pub const withGroupCumulativeWeightedPositiveCountOn = relation_methods_mod.withGroupCumulativeWeightedPositiveCountOn;
    pub const withGroupCumulativeWeightedEffectiveN = relation_methods_mod.withGroupCumulativeWeightedEffectiveN;
    pub const withGroupCumulativeWeightedEffectiveNOn = relation_methods_mod.withGroupCumulativeWeightedEffectiveNOn;
    pub const withGroupCumulativeWeightedEffectiveCount = relation_methods_mod.withGroupCumulativeWeightedEffectiveCount;
    pub const withGroupCumulativeWeightedEffectiveCountOn = relation_methods_mod.withGroupCumulativeWeightedEffectiveCountOn;
    pub const withGroupCumulativeWeightedTrimmedMean = relation_methods_mod.withGroupCumulativeWeightedTrimmedMean;
    pub const withGroupCumulativeWeightedTrimmedMeanOn = relation_methods_mod.withGroupCumulativeWeightedTrimmedMeanOn;
    pub const withGroupCumulativeWeightedWinsorizedMean = relation_methods_mod.withGroupCumulativeWeightedWinsorizedMean;
    pub const withGroupCumulativeWeightedWinsorizedMeanOn = relation_methods_mod.withGroupCumulativeWeightedWinsorizedMeanOn;
    pub const withGroupCumulativeWeightedProd = relation_methods_mod.withGroupCumulativeWeightedProd;
    pub const withGroupCumulativeWeightedProdOn = relation_methods_mod.withGroupCumulativeWeightedProdOn;
    pub const withGroupCumWeightedMean = relation_methods_mod.withGroupCumWeightedMean;
    pub const withGroupCumWeightedMeanOn = relation_methods_mod.withGroupCumWeightedMeanOn;
    pub const withGroupCumWeightedSum = relation_methods_mod.withGroupCumWeightedSum;
    pub const withGroupCumWeightedSumOn = relation_methods_mod.withGroupCumWeightedSumOn;
    pub const withGroupCumWeightedProduct = relation_methods_mod.withGroupCumWeightedProduct;
    pub const withGroupCumWeightedProductOn = relation_methods_mod.withGroupCumWeightedProductOn;
    pub const withGroupCumWeightedWeightSum = relation_methods_mod.withGroupCumWeightedWeightSum;
    pub const withGroupCumWeightedWeightSumOn = relation_methods_mod.withGroupCumWeightedWeightSumOn;
    pub const withGroupCumWeightedPositiveCount = relation_methods_mod.withGroupCumWeightedPositiveCount;
    pub const withGroupCumWeightedPositiveCountOn = relation_methods_mod.withGroupCumWeightedPositiveCountOn;
    pub const withGroupCumWeightedEffectiveN = relation_methods_mod.withGroupCumWeightedEffectiveN;
    pub const withGroupCumWeightedEffectiveNOn = relation_methods_mod.withGroupCumWeightedEffectiveNOn;
    pub const withGroupCumWeightedEffectiveCount = relation_methods_mod.withGroupCumWeightedEffectiveCount;
    pub const withGroupCumWeightedEffectiveCountOn = relation_methods_mod.withGroupCumWeightedEffectiveCountOn;
    pub const withGroupCumWeightedTrimmedMean = relation_methods_mod.withGroupCumWeightedTrimmedMean;
    pub const withGroupCumWeightedTrimmedMeanOn = relation_methods_mod.withGroupCumWeightedTrimmedMeanOn;
    pub const withGroupCumWeightedWinsorizedMean = relation_methods_mod.withGroupCumWeightedWinsorizedMean;
    pub const withGroupCumWeightedWinsorizedMeanOn = relation_methods_mod.withGroupCumWeightedWinsorizedMeanOn;
    pub const withGroupCumulativeWeightedInterdecileRange = relation_methods_mod.withGroupCumulativeWeightedInterdecileRange;
    pub const withGroupCumulativeWeightedInterdecileRangeOn = relation_methods_mod.withGroupCumulativeWeightedInterdecileRangeOn;
    pub const withGroupCumulativeWeightedIdr = relation_methods_mod.withGroupCumulativeWeightedIdr;
    pub const withGroupCumulativeWeightedIdrOn = relation_methods_mod.withGroupCumulativeWeightedIdrOn;
    pub const withGroupCumulativeWeightedIDR = relation_methods_mod.withGroupCumulativeWeightedIDR;
    pub const withGroupCumulativeWeightedIDROn = relation_methods_mod.withGroupCumulativeWeightedIDROn;
    pub const withGroupCumulativeWeightedMidhinge = relation_methods_mod.withGroupCumulativeWeightedMidhinge;
    pub const withGroupCumulativeWeightedMidhingeOn = relation_methods_mod.withGroupCumulativeWeightedMidhingeOn;
    pub const withGroupCumulativeWeightedTrimean = relation_methods_mod.withGroupCumulativeWeightedTrimean;
    pub const withGroupCumulativeWeightedTrimeanOn = relation_methods_mod.withGroupCumulativeWeightedTrimeanOn;
    pub const withGroupCumulativeWeightedBowleySkewness = relation_methods_mod.withGroupCumulativeWeightedBowleySkewness;
    pub const withGroupCumulativeWeightedBowleySkewnessOn = relation_methods_mod.withGroupCumulativeWeightedBowleySkewnessOn;
    pub const withGroupCumulativeWeightedBowleySkew = relation_methods_mod.withGroupCumulativeWeightedBowleySkew;
    pub const withGroupCumulativeWeightedBowleySkewOn = relation_methods_mod.withGroupCumulativeWeightedBowleySkewOn;
    pub const withGroupCumulativeWeightedQuartileCoeffDispersion = relation_methods_mod.withGroupCumulativeWeightedQuartileCoeffDispersion;
    pub const withGroupCumulativeWeightedQuartileCoeffDispersionOn = relation_methods_mod.withGroupCumulativeWeightedQuartileCoeffDispersionOn;
    pub const withGroupCumulativeWeightedQcd = relation_methods_mod.withGroupCumulativeWeightedQcd;
    pub const withGroupCumulativeWeightedQcdOn = relation_methods_mod.withGroupCumulativeWeightedQcdOn;
    pub const withGroupCumulativeWeightedQCD = relation_methods_mod.withGroupCumulativeWeightedQCD;
    pub const withGroupCumulativeWeightedQCDOn = relation_methods_mod.withGroupCumulativeWeightedQCDOn;
    pub const withGroupCumulativeWeightedKelleySkewness = relation_methods_mod.withGroupCumulativeWeightedKelleySkewness;
    pub const withGroupCumulativeWeightedKelleySkewnessOn = relation_methods_mod.withGroupCumulativeWeightedKelleySkewnessOn;
    pub const withGroupCumulativeWeightedKelleySkew = relation_methods_mod.withGroupCumulativeWeightedKelleySkew;
    pub const withGroupCumulativeWeightedKelleySkewOn = relation_methods_mod.withGroupCumulativeWeightedKelleySkewOn;
    pub const withGroupCumWeightedIdr = relation_methods_mod.withGroupCumWeightedIdr;
    pub const withGroupCumWeightedIdrOn = relation_methods_mod.withGroupCumWeightedIdrOn;
    pub const withGroupCumWeightedIDR = relation_methods_mod.withGroupCumWeightedIDR;
    pub const withGroupCumWeightedIDROn = relation_methods_mod.withGroupCumWeightedIDROn;
    pub const withGroupCumWeightedMidhinge = relation_methods_mod.withGroupCumWeightedMidhinge;
    pub const withGroupCumWeightedMidhingeOn = relation_methods_mod.withGroupCumWeightedMidhingeOn;
    pub const withGroupCumWeightedTrimean = relation_methods_mod.withGroupCumWeightedTrimean;
    pub const withGroupCumWeightedTrimeanOn = relation_methods_mod.withGroupCumWeightedTrimeanOn;
    pub const withGroupCumWeightedBowleySkewness = relation_methods_mod.withGroupCumWeightedBowleySkewness;
    pub const withGroupCumWeightedBowleySkewnessOn = relation_methods_mod.withGroupCumWeightedBowleySkewnessOn;
    pub const withGroupCumWeightedBowleySkew = relation_methods_mod.withGroupCumWeightedBowleySkew;
    pub const withGroupCumWeightedBowleySkewOn = relation_methods_mod.withGroupCumWeightedBowleySkewOn;
    pub const withGroupCumWeightedQuartileCoeffDispersion = relation_methods_mod.withGroupCumWeightedQuartileCoeffDispersion;
    pub const withGroupCumWeightedQuartileCoeffDispersionOn = relation_methods_mod.withGroupCumWeightedQuartileCoeffDispersionOn;
    pub const withGroupCumWeightedQcd = relation_methods_mod.withGroupCumWeightedQcd;
    pub const withGroupCumWeightedQcdOn = relation_methods_mod.withGroupCumWeightedQcdOn;
    pub const withGroupCumWeightedQCD = relation_methods_mod.withGroupCumWeightedQCD;
    pub const withGroupCumWeightedQCDOn = relation_methods_mod.withGroupCumWeightedQCDOn;
    pub const withGroupCumWeightedKelleySkewness = relation_methods_mod.withGroupCumWeightedKelleySkewness;
    pub const withGroupCumWeightedKelleySkewnessOn = relation_methods_mod.withGroupCumWeightedKelleySkewnessOn;
    pub const withGroupCumWeightedKelleySkew = relation_methods_mod.withGroupCumWeightedKelleySkew;
    pub const withGroupCumWeightedKelleySkewOn = relation_methods_mod.withGroupCumWeightedKelleySkewOn;
    pub const withGroupCumWeightedProd = relation_methods_mod.withGroupCumWeightedProd;
    pub const withGroupCumWeightedProdOn = relation_methods_mod.withGroupCumWeightedProdOn;
    pub const withGroupCumulativeWeightedMedian = relation_methods_mod.withGroupCumulativeWeightedMedian;
    pub const withGroupCumulativeWeightedMedianOn = relation_methods_mod.withGroupCumulativeWeightedMedianOn;
    pub const withGroupCumulativeWeightedQuantile = relation_methods_mod.withGroupCumulativeWeightedQuantile;
    pub const withGroupCumulativeWeightedQuantileOn = relation_methods_mod.withGroupCumulativeWeightedQuantileOn;
    pub const withGroupCumWeightedMedian = relation_methods_mod.withGroupCumWeightedMedian;
    pub const withGroupCumWeightedMedianOn = relation_methods_mod.withGroupCumWeightedMedianOn;
    pub const withGroupCumWeightedQuantile = relation_methods_mod.withGroupCumWeightedQuantile;
    pub const withGroupCumWeightedQuantileOn = relation_methods_mod.withGroupCumWeightedQuantileOn;
    pub const withGroupCumulativeWeightedIqr = relation_methods_mod.withGroupCumulativeWeightedIqr;
    pub const withGroupCumulativeWeightedIqrOn = relation_methods_mod.withGroupCumulativeWeightedIqrOn;
    pub const withGroupCumulativeWeightedIQR = relation_methods_mod.withGroupCumulativeWeightedIQR;
    pub const withGroupCumulativeWeightedIQROn = relation_methods_mod.withGroupCumulativeWeightedIQROn;
    pub const withGroupCumulativeWeightedMad = relation_methods_mod.withGroupCumulativeWeightedMad;
    pub const withGroupCumulativeWeightedMadOn = relation_methods_mod.withGroupCumulativeWeightedMadOn;
    pub const withGroupCumulativeWeightedMAD = relation_methods_mod.withGroupCumulativeWeightedMAD;
    pub const withGroupCumulativeWeightedMADOn = relation_methods_mod.withGroupCumulativeWeightedMADOn;
    pub const withGroupCumulativeWeightedMedianAbsDev = relation_methods_mod.withGroupCumulativeWeightedMedianAbsDev;
    pub const withGroupCumulativeWeightedMedianAbsDevOn = relation_methods_mod.withGroupCumulativeWeightedMedianAbsDevOn;
    pub const withGroupCumWeightedIqr = relation_methods_mod.withGroupCumWeightedIqr;
    pub const withGroupCumWeightedIqrOn = relation_methods_mod.withGroupCumWeightedIqrOn;
    pub const withGroupCumWeightedIQR = relation_methods_mod.withGroupCumWeightedIQR;
    pub const withGroupCumWeightedIQROn = relation_methods_mod.withGroupCumWeightedIQROn;
    pub const withGroupCumWeightedMad = relation_methods_mod.withGroupCumWeightedMad;
    pub const withGroupCumWeightedMadOn = relation_methods_mod.withGroupCumWeightedMadOn;
    pub const withGroupCumWeightedMAD = relation_methods_mod.withGroupCumWeightedMAD;
    pub const withGroupCumWeightedMADOn = relation_methods_mod.withGroupCumWeightedMADOn;
    pub const withGroupCumWeightedMedianAbsDev = relation_methods_mod.withGroupCumWeightedMedianAbsDev;
    pub const withGroupCumWeightedMedianAbsDevOn = relation_methods_mod.withGroupCumWeightedMedianAbsDevOn;
    pub const withGroupCumulativeWeightedMode = relation_methods_mod.withGroupCumulativeWeightedMode;
    pub const withGroupCumulativeWeightedModeOn = relation_methods_mod.withGroupCumulativeWeightedModeOn;
    pub const withGroupCumulativeWeightedModeWeight = relation_methods_mod.withGroupCumulativeWeightedModeWeight;
    pub const withGroupCumulativeWeightedModeWeightOn = relation_methods_mod.withGroupCumulativeWeightedModeWeightOn;
    pub const withGroupCumulativeWeightedModeRatio = relation_methods_mod.withGroupCumulativeWeightedModeRatio;
    pub const withGroupCumulativeWeightedModeRatioOn = relation_methods_mod.withGroupCumulativeWeightedModeRatioOn;
    pub const withGroupCumulativeWeightedModeMargin = relation_methods_mod.withGroupCumulativeWeightedModeMargin;
    pub const withGroupCumulativeWeightedModeMarginOn = relation_methods_mod.withGroupCumulativeWeightedModeMarginOn;
    pub const withGroupCumulativeWeightedModeMarginRatio = relation_methods_mod.withGroupCumulativeWeightedModeMarginRatio;
    pub const withGroupCumulativeWeightedModeMarginRatioOn = relation_methods_mod.withGroupCumulativeWeightedModeMarginRatioOn;
    pub const withGroupCumWeightedMode = relation_methods_mod.withGroupCumWeightedMode;
    pub const withGroupCumWeightedModeOn = relation_methods_mod.withGroupCumWeightedModeOn;
    pub const withGroupCumWeightedModeWeight = relation_methods_mod.withGroupCumWeightedModeWeight;
    pub const withGroupCumWeightedModeWeightOn = relation_methods_mod.withGroupCumWeightedModeWeightOn;
    pub const withGroupCumWeightedModeRatio = relation_methods_mod.withGroupCumWeightedModeRatio;
    pub const withGroupCumWeightedModeRatioOn = relation_methods_mod.withGroupCumWeightedModeRatioOn;
    pub const withGroupCumWeightedModeMargin = relation_methods_mod.withGroupCumWeightedModeMargin;
    pub const withGroupCumWeightedModeMarginOn = relation_methods_mod.withGroupCumWeightedModeMarginOn;
    pub const withGroupCumWeightedModeMarginRatio = relation_methods_mod.withGroupCumWeightedModeMarginRatio;
    pub const withGroupCumWeightedModeMarginRatioOn = relation_methods_mod.withGroupCumWeightedModeMarginRatioOn;
    pub const withGroupCumulativeWeightedEntropy = relation_methods_mod.withGroupCumulativeWeightedEntropy;
    pub const withGroupCumulativeWeightedEntropyOn = relation_methods_mod.withGroupCumulativeWeightedEntropyOn;
    pub const withGroupCumulativeWeightedGiniImpurity = relation_methods_mod.withGroupCumulativeWeightedGiniImpurity;
    pub const withGroupCumulativeWeightedGiniImpurityOn = relation_methods_mod.withGroupCumulativeWeightedGiniImpurityOn;
    pub const withGroupCumulativeWeightedGini = relation_methods_mod.withGroupCumulativeWeightedGini;
    pub const withGroupCumulativeWeightedGiniOn = relation_methods_mod.withGroupCumulativeWeightedGiniOn;
    pub const withGroupCumulativeWeightedPerplexity = relation_methods_mod.withGroupCumulativeWeightedPerplexity;
    pub const withGroupCumulativeWeightedPerplexityOn = relation_methods_mod.withGroupCumulativeWeightedPerplexityOn;
    pub const withGroupCumulativeWeightedInverseSimpson = relation_methods_mod.withGroupCumulativeWeightedInverseSimpson;
    pub const withGroupCumulativeWeightedInverseSimpsonOn = relation_methods_mod.withGroupCumulativeWeightedInverseSimpsonOn;
    pub const withGroupCumulativeWeightedSimpsonConcentration = relation_methods_mod.withGroupCumulativeWeightedSimpsonConcentration;
    pub const withGroupCumulativeWeightedSimpsonConcentrationOn = relation_methods_mod.withGroupCumulativeWeightedSimpsonConcentrationOn;
    pub const withGroupCumulativeWeightedConcentration = relation_methods_mod.withGroupCumulativeWeightedConcentration;
    pub const withGroupCumulativeWeightedConcentrationOn = relation_methods_mod.withGroupCumulativeWeightedConcentrationOn;
    pub const withGroupCumulativeWeightedEvenness = relation_methods_mod.withGroupCumulativeWeightedEvenness;
    pub const withGroupCumulativeWeightedEvennessOn = relation_methods_mod.withGroupCumulativeWeightedEvennessOn;
    pub const withGroupCumulativeWeightedMeanAbsDev = relation_methods_mod.withGroupCumulativeWeightedMeanAbsDev;
    pub const withGroupCumulativeWeightedMeanAbsDevOn = relation_methods_mod.withGroupCumulativeWeightedMeanAbsDevOn;
    pub const withGroupCumulativeWeightedMeanAbsDevRatio = relation_methods_mod.withGroupCumulativeWeightedMeanAbsDevRatio;
    pub const withGroupCumulativeWeightedMeanAbsDevRatioOn = relation_methods_mod.withGroupCumulativeWeightedMeanAbsDevRatioOn;
    pub const withGroupCumulativeWeightedMeanAbsoluteDeviation = relation_methods_mod.withGroupCumulativeWeightedMeanAbsoluteDeviation;
    pub const withGroupCumulativeWeightedMeanAbsoluteDeviationOn = relation_methods_mod.withGroupCumulativeWeightedMeanAbsoluteDeviationOn;
    pub const withGroupCumulativeWeightedGiniMeanDiff = relation_methods_mod.withGroupCumulativeWeightedGiniMeanDiff;
    pub const withGroupCumulativeWeightedGiniMeanDiffOn = relation_methods_mod.withGroupCumulativeWeightedGiniMeanDiffOn;
    pub const withGroupCumulativeWeightedGiniCoefficient = relation_methods_mod.withGroupCumulativeWeightedGiniCoefficient;
    pub const withGroupCumulativeWeightedGiniCoefficientOn = relation_methods_mod.withGroupCumulativeWeightedGiniCoefficientOn;
    pub const withGroupCumulativeWeightedGiniCoeff = relation_methods_mod.withGroupCumulativeWeightedGiniCoeff;
    pub const withGroupCumulativeWeightedGiniCoeffOn = relation_methods_mod.withGroupCumulativeWeightedGiniCoeffOn;
    pub const withGroupCumWeightedEntropy = relation_methods_mod.withGroupCumWeightedEntropy;
    pub const withGroupCumWeightedEntropyOn = relation_methods_mod.withGroupCumWeightedEntropyOn;
    pub const withGroupCumWeightedGiniImpurity = relation_methods_mod.withGroupCumWeightedGiniImpurity;
    pub const withGroupCumWeightedGiniImpurityOn = relation_methods_mod.withGroupCumWeightedGiniImpurityOn;
    pub const withGroupCumWeightedGini = relation_methods_mod.withGroupCumWeightedGini;
    pub const withGroupCumWeightedGiniOn = relation_methods_mod.withGroupCumWeightedGiniOn;
    pub const withGroupCumWeightedPerplexity = relation_methods_mod.withGroupCumWeightedPerplexity;
    pub const withGroupCumWeightedPerplexityOn = relation_methods_mod.withGroupCumWeightedPerplexityOn;
    pub const withGroupCumWeightedInverseSimpson = relation_methods_mod.withGroupCumWeightedInverseSimpson;
    pub const withGroupCumWeightedInverseSimpsonOn = relation_methods_mod.withGroupCumWeightedInverseSimpsonOn;
    pub const withGroupCumWeightedSimpsonConcentration = relation_methods_mod.withGroupCumWeightedSimpsonConcentration;
    pub const withGroupCumWeightedSimpsonConcentrationOn = relation_methods_mod.withGroupCumWeightedSimpsonConcentrationOn;
    pub const withGroupCumWeightedConcentration = relation_methods_mod.withGroupCumWeightedConcentration;
    pub const withGroupCumWeightedConcentrationOn = relation_methods_mod.withGroupCumWeightedConcentrationOn;
    pub const withGroupCumWeightedEvenness = relation_methods_mod.withGroupCumWeightedEvenness;
    pub const withGroupCumWeightedEvennessOn = relation_methods_mod.withGroupCumWeightedEvennessOn;
    pub const withGroupCumWeightedMeanAbsDev = relation_methods_mod.withGroupCumWeightedMeanAbsDev;
    pub const withGroupCumWeightedMeanAbsDevOn = relation_methods_mod.withGroupCumWeightedMeanAbsDevOn;
    pub const withGroupCumWeightedMeanAbsDevRatio = relation_methods_mod.withGroupCumWeightedMeanAbsDevRatio;
    pub const withGroupCumWeightedMeanAbsDevRatioOn = relation_methods_mod.withGroupCumWeightedMeanAbsDevRatioOn;
    pub const withGroupCumWeightedMeanAbsoluteDeviation = relation_methods_mod.withGroupCumWeightedMeanAbsoluteDeviation;
    pub const withGroupCumWeightedMeanAbsoluteDeviationOn = relation_methods_mod.withGroupCumWeightedMeanAbsoluteDeviationOn;
    pub const withGroupCumWeightedGiniMeanDiff = relation_methods_mod.withGroupCumWeightedGiniMeanDiff;
    pub const withGroupCumWeightedGiniMeanDiffOn = relation_methods_mod.withGroupCumWeightedGiniMeanDiffOn;
    pub const withGroupCumWeightedGiniCoefficient = relation_methods_mod.withGroupCumWeightedGiniCoefficient;
    pub const withGroupCumWeightedGiniCoefficientOn = relation_methods_mod.withGroupCumWeightedGiniCoefficientOn;
    pub const withGroupCumWeightedGiniCoeff = relation_methods_mod.withGroupCumWeightedGiniCoeff;
    pub const withGroupCumWeightedGiniCoeffOn = relation_methods_mod.withGroupCumWeightedGiniCoeffOn;
    pub const withGroupCumulativeWeightedDot = relation_methods_mod.withGroupCumulativeWeightedDot;
    pub const withGroupCumulativeWeightedDotOn = relation_methods_mod.withGroupCumulativeWeightedDotOn;
    pub const withGroupCumWeightedDot = relation_methods_mod.withGroupCumWeightedDot;
    pub const withGroupCumWeightedDotOn = relation_methods_mod.withGroupCumWeightedDotOn;
    pub const withGroupCumulativeWeightedCosineSimilarity = relation_methods_mod.withGroupCumulativeWeightedCosineSimilarity;
    pub const withGroupCumulativeWeightedCosineSimilarityOn = relation_methods_mod.withGroupCumulativeWeightedCosineSimilarityOn;
    pub const withGroupCumWeightedCosineSimilarity = relation_methods_mod.withGroupCumWeightedCosineSimilarity;
    pub const withGroupCumWeightedCosineSimilarityOn = relation_methods_mod.withGroupCumWeightedCosineSimilarityOn;
    pub const withGroupCumulativeWeightedSquaredEuclideanDistance = relation_methods_mod.withGroupCumulativeWeightedSquaredEuclideanDistance;
    pub const withGroupCumulativeWeightedSquaredEuclideanDistanceOn = relation_methods_mod.withGroupCumulativeWeightedSquaredEuclideanDistanceOn;
    pub const withGroupCumWeightedSquaredEuclideanDistance = relation_methods_mod.withGroupCumWeightedSquaredEuclideanDistance;
    pub const withGroupCumWeightedSquaredEuclideanDistanceOn = relation_methods_mod.withGroupCumWeightedSquaredEuclideanDistanceOn;
    pub const withGroupCumulativeWeightedEuclideanDistance = relation_methods_mod.withGroupCumulativeWeightedEuclideanDistance;
    pub const withGroupCumulativeWeightedEuclideanDistanceOn = relation_methods_mod.withGroupCumulativeWeightedEuclideanDistanceOn;
    pub const withGroupCumWeightedEuclideanDistance = relation_methods_mod.withGroupCumWeightedEuclideanDistance;
    pub const withGroupCumWeightedEuclideanDistanceOn = relation_methods_mod.withGroupCumWeightedEuclideanDistanceOn;
    pub const withGroupCumulativeWeightedManhattanDistance = relation_methods_mod.withGroupCumulativeWeightedManhattanDistance;
    pub const withGroupCumulativeWeightedManhattanDistanceOn = relation_methods_mod.withGroupCumulativeWeightedManhattanDistanceOn;
    pub const withGroupCumWeightedManhattanDistance = relation_methods_mod.withGroupCumWeightedManhattanDistance;
    pub const withGroupCumWeightedManhattanDistanceOn = relation_methods_mod.withGroupCumWeightedManhattanDistanceOn;
    pub const withGroupCumulativeWeightedChebyshevDistance = relation_methods_mod.withGroupCumulativeWeightedChebyshevDistance;
    pub const withGroupCumulativeWeightedChebyshevDistanceOn = relation_methods_mod.withGroupCumulativeWeightedChebyshevDistanceOn;
    pub const withGroupCumWeightedChebyshevDistance = relation_methods_mod.withGroupCumWeightedChebyshevDistance;
    pub const withGroupCumWeightedChebyshevDistanceOn = relation_methods_mod.withGroupCumWeightedChebyshevDistanceOn;
    pub const withGroupCumulativeWeightedCanberraDistance = relation_methods_mod.withGroupCumulativeWeightedCanberraDistance;
    pub const withGroupCumulativeWeightedCanberraDistanceOn = relation_methods_mod.withGroupCumulativeWeightedCanberraDistanceOn;
    pub const withGroupCumWeightedCanberraDistance = relation_methods_mod.withGroupCumWeightedCanberraDistance;
    pub const withGroupCumWeightedCanberraDistanceOn = relation_methods_mod.withGroupCumWeightedCanberraDistanceOn;
    pub const withGroupCumulativeWeightedBrayCurtisDistance = relation_methods_mod.withGroupCumulativeWeightedBrayCurtisDistance;
    pub const withGroupCumulativeWeightedBrayCurtisDistanceOn = relation_methods_mod.withGroupCumulativeWeightedBrayCurtisDistanceOn;
    pub const withGroupCumWeightedBrayCurtisDistance = relation_methods_mod.withGroupCumWeightedBrayCurtisDistance;
    pub const withGroupCumWeightedBrayCurtisDistanceOn = relation_methods_mod.withGroupCumWeightedBrayCurtisDistanceOn;
    pub const withGroupCumulativeWeightedMeanError = relation_methods_mod.withGroupCumulativeWeightedMeanError;
    pub const withGroupCumulativeWeightedMeanErrorOn = relation_methods_mod.withGroupCumulativeWeightedMeanErrorOn;
    pub const withGroupCumWeightedMeanError = relation_methods_mod.withGroupCumWeightedMeanError;
    pub const withGroupCumWeightedMeanErrorOn = relation_methods_mod.withGroupCumWeightedMeanErrorOn;
    pub const withGroupCumulativeWeightedMae = relation_methods_mod.withGroupCumulativeWeightedMae;
    pub const withGroupCumulativeWeightedMaeOn = relation_methods_mod.withGroupCumulativeWeightedMaeOn;
    pub const withGroupCumWeightedMae = relation_methods_mod.withGroupCumWeightedMae;
    pub const withGroupCumWeightedMaeOn = relation_methods_mod.withGroupCumWeightedMaeOn;
    pub const withGroupCumulativeWeightedMse = relation_methods_mod.withGroupCumulativeWeightedMse;
    pub const withGroupCumulativeWeightedMseOn = relation_methods_mod.withGroupCumulativeWeightedMseOn;
    pub const withGroupCumWeightedMse = relation_methods_mod.withGroupCumWeightedMse;
    pub const withGroupCumWeightedMseOn = relation_methods_mod.withGroupCumWeightedMseOn;
    pub const withGroupCumulativeWeightedRmse = relation_methods_mod.withGroupCumulativeWeightedRmse;
    pub const withGroupCumulativeWeightedRmseOn = relation_methods_mod.withGroupCumulativeWeightedRmseOn;
    pub const withGroupCumWeightedRmse = relation_methods_mod.withGroupCumWeightedRmse;
    pub const withGroupCumWeightedRmseOn = relation_methods_mod.withGroupCumWeightedRmseOn;
    pub const withGroupCumulativeWeightedMape = relation_methods_mod.withGroupCumulativeWeightedMape;
    pub const withGroupCumulativeWeightedMapeOn = relation_methods_mod.withGroupCumulativeWeightedMapeOn;
    pub const withGroupCumWeightedMape = relation_methods_mod.withGroupCumWeightedMape;
    pub const withGroupCumWeightedMapeOn = relation_methods_mod.withGroupCumWeightedMapeOn;
    pub const withGroupCumulativeWeightedSmape = relation_methods_mod.withGroupCumulativeWeightedSmape;
    pub const withGroupCumulativeWeightedSmapeOn = relation_methods_mod.withGroupCumulativeWeightedSmapeOn;
    pub const withGroupCumWeightedSmape = relation_methods_mod.withGroupCumWeightedSmape;
    pub const withGroupCumWeightedSmapeOn = relation_methods_mod.withGroupCumWeightedSmapeOn;
    pub const withGroupCumulativeWeightedCosine = relation_methods_mod.withGroupCumulativeWeightedCosine;
    pub const withGroupCumulativeWeightedCosineOn = relation_methods_mod.withGroupCumulativeWeightedCosineOn;
    pub const withGroupCumulativeWeightedBias = relation_methods_mod.withGroupCumulativeWeightedBias;
    pub const withGroupCumulativeWeightedBiasOn = relation_methods_mod.withGroupCumulativeWeightedBiasOn;
    pub const withGroupCumWeightedCosine = relation_methods_mod.withGroupCumWeightedCosine;
    pub const withGroupCumWeightedCosineOn = relation_methods_mod.withGroupCumWeightedCosineOn;
    pub const withGroupCumWeightedBias = relation_methods_mod.withGroupCumWeightedBias;
    pub const withGroupCumWeightedBiasOn = relation_methods_mod.withGroupCumWeightedBiasOn;
    pub const withGroupCumulativeWeightedCovariance = relation_methods_mod.withGroupCumulativeWeightedCovariance;
    pub const withGroupCumulativeWeightedCovarianceOn = relation_methods_mod.withGroupCumulativeWeightedCovarianceOn;
    pub const withGroupCumulativeWeightedCov = relation_methods_mod.withGroupCumulativeWeightedCov;
    pub const withGroupCumulativeWeightedCovOn = relation_methods_mod.withGroupCumulativeWeightedCovOn;
    pub const withGroupCumulativeWeightedCorrelation = relation_methods_mod.withGroupCumulativeWeightedCorrelation;
    pub const withGroupCumulativeWeightedCorrelationOn = relation_methods_mod.withGroupCumulativeWeightedCorrelationOn;
    pub const withGroupCumulativeWeightedCorr = relation_methods_mod.withGroupCumulativeWeightedCorr;
    pub const withGroupCumulativeWeightedCorrOn = relation_methods_mod.withGroupCumulativeWeightedCorrOn;
    pub const withGroupCumulativeWeightedBeta = relation_methods_mod.withGroupCumulativeWeightedBeta;
    pub const withGroupCumulativeWeightedBetaOn = relation_methods_mod.withGroupCumulativeWeightedBetaOn;
    pub const withGroupCumWeightedCovariance = relation_methods_mod.withGroupCumWeightedCovariance;
    pub const withGroupCumWeightedCovarianceOn = relation_methods_mod.withGroupCumWeightedCovarianceOn;
    pub const withGroupCumWeightedCov = relation_methods_mod.withGroupCumWeightedCov;
    pub const withGroupCumWeightedCovOn = relation_methods_mod.withGroupCumWeightedCovOn;
    pub const withGroupCumWeightedCorrelation = relation_methods_mod.withGroupCumWeightedCorrelation;
    pub const withGroupCumWeightedCorrelationOn = relation_methods_mod.withGroupCumWeightedCorrelationOn;
    pub const withGroupCumWeightedCorr = relation_methods_mod.withGroupCumWeightedCorr;
    pub const withGroupCumWeightedCorrOn = relation_methods_mod.withGroupCumWeightedCorrOn;
    pub const withGroupCumWeightedBeta = relation_methods_mod.withGroupCumWeightedBeta;
    pub const withGroupCumWeightedBetaOn = relation_methods_mod.withGroupCumWeightedBetaOn;
    pub const withGroupCumulativeWeightedSem = relation_methods_mod.withGroupCumulativeWeightedSem;
    pub const withGroupCumulativeWeightedSemOn = relation_methods_mod.withGroupCumulativeWeightedSemOn;
    pub const withGroupCumWeightedSem = relation_methods_mod.withGroupCumWeightedSem;
    pub const withGroupCumWeightedSemOn = relation_methods_mod.withGroupCumWeightedSemOn;
    pub const withGroupCumulativeWeightedCv = relation_methods_mod.withGroupCumulativeWeightedCv;
    pub const withGroupCumulativeWeightedCvOn = relation_methods_mod.withGroupCumulativeWeightedCvOn;
    pub const withGroupCumWeightedCv = relation_methods_mod.withGroupCumWeightedCv;
    pub const withGroupCumWeightedCvOn = relation_methods_mod.withGroupCumWeightedCvOn;
    pub const withGroupCumulativeWeightedFano = relation_methods_mod.withGroupCumulativeWeightedFano;
    pub const withGroupCumulativeWeightedFanoOn = relation_methods_mod.withGroupCumulativeWeightedFanoOn;
    pub const withGroupCumulativeWeightedSkewness = relation_methods_mod.withGroupCumulativeWeightedSkewness;
    pub const withGroupCumulativeWeightedSkewnessOn = relation_methods_mod.withGroupCumulativeWeightedSkewnessOn;
    pub const withGroupCumulativeWeightedSkew = relation_methods_mod.withGroupCumulativeWeightedSkew;
    pub const withGroupCumulativeWeightedSkewOn = relation_methods_mod.withGroupCumulativeWeightedSkewOn;
    pub const withGroupCumulativeWeightedKurtosis = relation_methods_mod.withGroupCumulativeWeightedKurtosis;
    pub const withGroupCumulativeWeightedKurtosisOn = relation_methods_mod.withGroupCumulativeWeightedKurtosisOn;
    pub const withGroupCumulativeWeightedKurt = relation_methods_mod.withGroupCumulativeWeightedKurt;
    pub const withGroupCumulativeWeightedKurtOn = relation_methods_mod.withGroupCumulativeWeightedKurtOn;
    pub const withGroupCumWeightedFano = relation_methods_mod.withGroupCumWeightedFano;
    pub const withGroupCumWeightedFanoOn = relation_methods_mod.withGroupCumWeightedFanoOn;
    pub const withGroupCumWeightedSkewness = relation_methods_mod.withGroupCumWeightedSkewness;
    pub const withGroupCumWeightedSkewnessOn = relation_methods_mod.withGroupCumWeightedSkewnessOn;
    pub const withGroupCumWeightedSkew = relation_methods_mod.withGroupCumWeightedSkew;
    pub const withGroupCumWeightedSkewOn = relation_methods_mod.withGroupCumWeightedSkewOn;
    pub const withGroupCumWeightedKurtosis = relation_methods_mod.withGroupCumWeightedKurtosis;
    pub const withGroupCumWeightedKurtosisOn = relation_methods_mod.withGroupCumWeightedKurtosisOn;
    pub const withGroupCumWeightedKurt = relation_methods_mod.withGroupCumWeightedKurt;
    pub const withGroupCumWeightedKurtOn = relation_methods_mod.withGroupCumWeightedKurtOn;
    pub const withGroupCumulativeWeightedSEM = relation_methods_mod.withGroupCumulativeWeightedSEM;
    pub const withGroupCumulativeWeightedSEMOn = relation_methods_mod.withGroupCumulativeWeightedSEMOn;
    pub const withGroupCumulativeWeightedCV = relation_methods_mod.withGroupCumulativeWeightedCV;
    pub const withGroupCumulativeWeightedCVOn = relation_methods_mod.withGroupCumulativeWeightedCVOn;
    ...
    pub const withGroupCumWeightedCV = relation_methods_mod.withGroupCumWeightedCV;
    pub const withGroupCumWeightedCVOn = relation_methods_mod.withGroupCumWeightedCVOn;
    pub const withGroupCumulativeWeightedMeanSquare = relation_methods_mod.withGroupCumulativeWeightedMeanSquare;
    pub const withGroupCumulativeWeightedMeanSquareOn = relation_methods_mod.withGroupCumulativeWeightedMeanSquareOn;
    pub const withGroupCumulativeWeightedRms = relation_methods_mod.withGroupCumulativeWeightedRms;
    pub const withGroupCumulativeWeightedRmsOn = relation_methods_mod.withGroupCumulativeWeightedRmsOn;
    pub const withGroupCumulativeWeightedMeanSquared = relation_methods_mod.withGroupCumulativeWeightedMeanSquared;
    pub const withGroupCumulativeWeightedMeanSquaredOn = relation_methods_mod.withGroupCumulativeWeightedMeanSquaredOn;
    pub const withGroupCumulativeWeightedMeanSq = relation_methods_mod.withGroupCumulativeWeightedMeanSq;
    pub const withGroupCumulativeWeightedMeanSqOn = relation_methods_mod.withGroupCumulativeWeightedMeanSqOn;
    pub const withGroupCumulativeWeightedRMS = relation_methods_mod.withGroupCumulativeWeightedRMS;
    pub const withGroupCumulativeWeightedRMSOn = relation_methods_mod.withGroupCumulativeWeightedRMSOn;
    pub const withGroupCumWeightedMeanSquare = relation_methods_mod.withGroupCumWeightedMeanSquare;
    pub const withGroupCumWeightedMeanSquareOn = relation_methods_mod.withGroupCumWeightedMeanSquareOn;
    pub const withGroupCumWeightedMeanSquared = relation_methods_mod.withGroupCumWeightedMeanSquared;
    pub const withGroupCumWeightedMeanSquaredOn = relation_methods_mod.withGroupCumWeightedMeanSquaredOn;
    pub const withGroupCumWeightedMeanSq = relation_methods_mod.withGroupCumWeightedMeanSq;
    pub const withGroupCumWeightedMeanSqOn = relation_methods_mod.withGroupCumWeightedMeanSqOn;
    pub const withGroupCumWeightedRms = relation_methods_mod.withGroupCumWeightedRms;
    pub const withGroupCumWeightedRmsOn = relation_methods_mod.withGroupCumWeightedRmsOn;
    pub const withGroupCumWeightedRMS = relation_methods_mod.withGroupCumWeightedRMS;
    pub const withGroupCumWeightedRMSOn = relation_methods_mod.withGroupCumWeightedRMSOn;
    pub const withGroupCumulativeWeightedMin = relation_methods_mod.withGroupCumulativeWeightedMin;
    pub const withGroupCumulativeWeightedMinOn = relation_methods_mod.withGroupCumulativeWeightedMinOn;
    pub const withGroupCumulativeWeightedMinimum = relation_methods_mod.withGroupCumulativeWeightedMinimum;
    pub const withGroupCumulativeWeightedMinimumOn = relation_methods_mod.withGroupCumulativeWeightedMinimumOn;
    pub const withGroupCumulativeWeightedMax = relation_methods_mod.withGroupCumulativeWeightedMax;
    pub const withGroupCumulativeWeightedMaxOn = relation_methods_mod.withGroupCumulativeWeightedMaxOn;
    pub const withGroupCumulativeWeightedMaximum = relation_methods_mod.withGroupCumulativeWeightedMaximum;
    pub const withGroupCumulativeWeightedMaximumOn = relation_methods_mod.withGroupCumulativeWeightedMaximumOn;
    pub const withGroupCumWeightedMin = relation_methods_mod.withGroupCumWeightedMin;
    pub const withGroupCumWeightedMinOn = relation_methods_mod.withGroupCumWeightedMinOn;
    pub const withGroupCumWeightedMinimum = relation_methods_mod.withGroupCumWeightedMinimum;
    pub const withGroupCumWeightedMinimumOn = relation_methods_mod.withGroupCumWeightedMinimumOn;
    pub const withGroupCumWeightedMax = relation_methods_mod.withGroupCumWeightedMax;
    pub const withGroupCumWeightedMaxOn = relation_methods_mod.withGroupCumWeightedMaxOn;
    pub const withGroupCumWeightedMaximum = relation_methods_mod.withGroupCumWeightedMaximum;
    pub const withGroupCumWeightedMaximumOn = relation_methods_mod.withGroupCumWeightedMaximumOn;
    pub const withGroupCumulativeWeightedMeanAbs = relation_methods_mod.withGroupCumulativeWeightedMeanAbs;
    pub const withGroupCumulativeWeightedMeanAbsOn = relation_methods_mod.withGroupCumulativeWeightedMeanAbsOn;
    pub const withGroupCumulativeWeightedL1Norm = relation_methods_mod.withGroupCumulativeWeightedL1Norm;
    pub const withGroupCumulativeWeightedL1NormOn = relation_methods_mod.withGroupCumulativeWeightedL1NormOn;
    pub const withGroupCumulativeWeightedL2Norm = relation_methods_mod.withGroupCumulativeWeightedL2Norm;
    pub const withGroupCumulativeWeightedL2NormOn = relation_methods_mod.withGroupCumulativeWeightedL2NormOn;
    pub const withGroupCumulativeWeightedMaxAbs = relation_methods_mod.withGroupCumulativeWeightedMaxAbs;
    pub const withGroupCumulativeWeightedMaxAbsOn = relation_methods_mod.withGroupCumulativeWeightedMaxAbsOn;
    pub const withGroupCumulativeWeightedMinAbs = relation_methods_mod.withGroupCumulativeWeightedMinAbs;
    pub const withGroupCumulativeWeightedMinAbsOn = relation_methods_mod.withGroupCumulativeWeightedMinAbsOn;
    pub const withGroupCumulativeWeightedL1 = relation_methods_mod.withGroupCumulativeWeightedL1;
    pub const withGroupCumulativeWeightedL1On = relation_methods_mod.withGroupCumulativeWeightedL1On;
    pub const withGroupCumulativeWeightedL2 = relation_methods_mod.withGroupCumulativeWeightedL2;
    pub const withGroupCumulativeWeightedL2On = relation_methods_mod.withGroupCumulativeWeightedL2On;
    pub const withGroupCumulativeWeightedMaxAbsolute = relation_methods_mod.withGroupCumulativeWeightedMaxAbsolute;
    pub const withGroupCumulativeWeightedMaxAbsoluteOn = relation_methods_mod.withGroupCumulativeWeightedMaxAbsoluteOn;
    pub const withGroupCumulativeWeightedMinAbsolute = relation_methods_mod.withGroupCumulativeWeightedMinAbsolute;
    pub const withGroupCumulativeWeightedMinAbsoluteOn = relation_methods_mod.withGroupCumulativeWeightedMinAbsoluteOn;
    pub const withGroupCumWeightedMeanAbs = relation_methods_mod.withGroupCumWeightedMeanAbs;
    pub const withGroupCumWeightedMeanAbsOn = relation_methods_mod.withGroupCumWeightedMeanAbsOn;
    pub const withGroupCumWeightedL1Norm = relation_methods_mod.withGroupCumWeightedL1Norm;
    pub const withGroupCumWeightedL1NormOn = relation_methods_mod.withGroupCumWeightedL1NormOn;
    pub const withGroupCumWeightedL1 = relation_methods_mod.withGroupCumWeightedL1;
    pub const withGroupCumWeightedL1On = relation_methods_mod.withGroupCumWeightedL1On;
    pub const withGroupCumWeightedL2Norm = relation_methods_mod.withGroupCumWeightedL2Norm;
    pub const withGroupCumWeightedL2NormOn = relation_methods_mod.withGroupCumWeightedL2NormOn;
    pub const withGroupCumWeightedL2 = relation_methods_mod.withGroupCumWeightedL2;
    pub const withGroupCumWeightedL2On = relation_methods_mod.withGroupCumWeightedL2On;
    pub const withGroupCumWeightedMaxAbs = relation_methods_mod.withGroupCumWeightedMaxAbs;
    pub const withGroupCumWeightedMaxAbsOn = relation_methods_mod.withGroupCumWeightedMaxAbsOn;
    pub const withGroupCumWeightedMinAbs = relation_methods_mod.withGroupCumWeightedMinAbs;
    pub const withGroupCumWeightedMinAbsOn = relation_methods_mod.withGroupCumWeightedMinAbsOn;
    pub const withGroupCumulativeWeightedGeometricMean = relation_methods_mod.withGroupCumulativeWeightedGeometricMean;
    pub const withGroupCumulativeWeightedGeometricMeanOn = relation_methods_mod.withGroupCumulativeWeightedGeometricMeanOn;
    pub const withGroupCumulativeWeightedGeoMean = relation_methods_mod.withGroupCumulativeWeightedGeoMean;
    pub const withGroupCumulativeWeightedGeoMeanOn = relation_methods_mod.withGroupCumulativeWeightedGeoMeanOn;
    pub const withGroupCumulativeWeightedHarmonicMean = relation_methods_mod.withGroupCumulativeWeightedHarmonicMean;
    pub const withGroupCumulativeWeightedHarmonicMeanOn = relation_methods_mod.withGroupCumulativeWeightedHarmonicMeanOn;
    pub const withGroupCumulativeWeightedHarmMean = relation_methods_mod.withGroupCumulativeWeightedHarmMean;
    pub const withGroupCumulativeWeightedHarmMeanOn = relation_methods_mod.withGroupCumulativeWeightedHarmMeanOn;
    pub const withGroupCumulativeWeightedLogSumExp = relation_methods_mod.withGroupCumulativeWeightedLogSumExp;
    pub const withGroupCumulativeWeightedLogSumExpOn = relation_methods_mod.withGroupCumulativeWeightedLogSumExpOn;
    pub const withGroupCumulativeWeightedLogsumexp = relation_methods_mod.withGroupCumulativeWeightedLogsumexp;
    pub const withGroupCumulativeWeightedLogsumexpOn = relation_methods_mod.withGroupCumulativeWeightedLogsumexpOn;
    pub const withGroupCumulativeWeightedLogMeanExp = relation_methods_mod.withGroupCumulativeWeightedLogMeanExp;
    pub const withGroupCumulativeWeightedLogMeanExpOn = relation_methods_mod.withGroupCumulativeWeightedLogMeanExpOn;
    pub const withGroupCumulativeWeightedLogmeanexp = relation_methods_mod.withGroupCumulativeWeightedLogmeanexp;
    pub const withGroupCumulativeWeightedLogmeanexpOn = relation_methods_mod.withGroupCumulativeWeightedLogmeanexpOn;
    pub const withGroupCumulativeWeightedRange = relation_methods_mod.withGroupCumulativeWeightedRange;
    pub const withGroupCumulativeWeightedRangeOn = relation_methods_mod.withGroupCumulativeWeightedRangeOn;
    pub const withGroupCumulativeWeightedMidrange = relation_methods_mod.withGroupCumulativeWeightedMidrange;
    pub const withGroupCumulativeWeightedMidrangeOn = relation_methods_mod.withGroupCumulativeWeightedMidrangeOn;
    pub const withGroupCumulativeWeightedRangeCoeff = relation_methods_mod.withGroupCumulativeWeightedRangeCoeff;
    pub const withGroupCumulativeWeightedRangeCoeffOn = relation_methods_mod.withGroupCumulativeWeightedRangeCoeffOn;
    pub const withGroupCumulativeWeightedRangeCoefficient = relation_methods_mod.withGroupCumulativeWeightedRangeCoefficient;
    pub const withGroupCumulativeWeightedRangeCoefficientOn = relation_methods_mod.withGroupCumulativeWeightedRangeCoefficientOn;
    pub const withGroupCumWeightedGeometricMean = relation_methods_mod.withGroupCumWeightedGeometricMean;
    pub const withGroupCumWeightedGeometricMeanOn = relation_methods_mod.withGroupCumWeightedGeometricMeanOn;
    pub const withGroupCumWeightedGeoMean = relation_methods_mod.withGroupCumWeightedGeoMean;
    pub const withGroupCumWeightedGeoMeanOn = relation_methods_mod.withGroupCumWeightedGeoMeanOn;
    pub const withGroupCumWeightedHarmonicMean = relation_methods_mod.withGroupCumWeightedHarmonicMean;
    pub const withGroupCumWeightedHarmonicMeanOn = relation_methods_mod.withGroupCumWeightedHarmonicMeanOn;
    pub const withGroupCumWeightedHarmMean = relation_methods_mod.withGroupCumWeightedHarmMean;
    pub const withGroupCumWeightedHarmMeanOn = relation_methods_mod.withGroupCumWeightedHarmMeanOn;
    pub const withGroupCumWeightedLogSumExp = relation_methods_mod.withGroupCumWeightedLogSumExp;
    pub const withGroupCumWeightedLogSumExpOn = relation_methods_mod.withGroupCumWeightedLogSumExpOn;
    pub const withGroupCumWeightedLogsumexp = relation_methods_mod.withGroupCumWeightedLogsumexp;
    pub const withGroupCumWeightedLogsumexpOn = relation_methods_mod.withGroupCumWeightedLogsumexpOn;
    pub const withGroupCumWeightedLogMeanExp = relation_methods_mod.withGroupCumWeightedLogMeanExp;
    pub const withGroupCumWeightedLogMeanExpOn = relation_methods_mod.withGroupCumWeightedLogMeanExpOn;
    pub const withGroupCumWeightedLogmeanexp = relation_methods_mod.withGroupCumWeightedLogmeanexp;
    pub const withGroupCumWeightedLogmeanexpOn = relation_methods_mod.withGroupCumWeightedLogmeanexpOn;
    pub const withGroupCumWeightedRange = relation_methods_mod.withGroupCumWeightedRange;
    pub const withGroupCumWeightedRangeOn = relation_methods_mod.withGroupCumWeightedRangeOn;
    pub const withGroupCumWeightedMidrange = relation_methods_mod.withGroupCumWeightedMidrange;
    pub const withGroupCumWeightedMidrangeOn = relation_methods_mod.withGroupCumWeightedMidrangeOn;
    pub const withGroupCumWeightedRangeCoeff = relation_methods_mod.withGroupCumWeightedRangeCoeff;
    pub const withGroupCumWeightedRangeCoeffOn = relation_methods_mod.withGroupCumWeightedRangeCoeffOn;
    pub const withGroupCumWeightedRangeCoefficient = relation_methods_mod.withGroupCumWeightedRangeCoefficient;
    pub const withGroupCumWeightedRangeCoefficientOn = relation_methods_mod.withGroupCumWeightedRangeCoefficientOn;
    pub const withGroupCumulativeWeightedVariance = relation_methods_mod.withGroupCumulativeWeightedVariance;
    pub const withGroupCumulativeWeightedVarianceOn = relation_methods_mod.withGroupCumulativeWeightedVarianceOn;
    pub const withGroupCumulativeWeightedVar = relation_methods_mod.withGroupCumulativeWeightedVar;
    pub const withGroupCumulativeWeightedVarOn = relation_methods_mod.withGroupCumulativeWeightedVarOn;
    pub const withGroupCumulativeWeightedStddev = relation_methods_mod.withGroupCumulativeWeightedStddev;
    pub const withGroupCumulativeWeightedStddevOn = relation_methods_mod.withGroupCumulativeWeightedStddevOn;
    pub const withGroupCumulativeWeightedStd = relation_methods_mod.withGroupCumulativeWeightedStd;
    pub const withGroupCumulativeWeightedStdOn = relation_methods_mod.withGroupCumulativeWeightedStdOn;
    pub const withGroupCumWeightedVariance = relation_methods_mod.withGroupCumWeightedVariance;
    pub const withGroupCumWeightedVarianceOn = relation_methods_mod.withGroupCumWeightedVarianceOn;
    pub const withGroupCumWeightedVar = relation_methods_mod.withGroupCumWeightedVar;
    pub const withGroupCumWeightedVarOn = relation_methods_mod.withGroupCumWeightedVarOn;
    pub const withGroupCumWeightedStddev = relation_methods_mod.withGroupCumWeightedStddev;
    pub const withGroupCumWeightedStddevOn = relation_methods_mod.withGroupCumWeightedStddevOn;
    pub const withGroupCumWeightedStd = relation_methods_mod.withGroupCumWeightedStd;
    pub const withGroupCumWeightedStdOn = relation_methods_mod.withGroupCumWeightedStdOn;
    ...
    pub const groupByWeightedSum = relation_methods_mod.groupByWeightedSum;
    pub const groupByWeightedSumOn = relation_methods_mod.groupByWeightedSumOn;
    pub const groupByWeightedProduct = relation_methods_mod.groupByWeightedProduct;
    pub const groupByWeightedProductOn = relation_methods_mod.groupByWeightedProductOn;
    pub const groupByWeightedWeightSum = relation_methods_mod.groupByWeightedWeightSum;
    pub const groupByWeightedWeightSumOn = relation_methods_mod.groupByWeightedWeightSumOn;
    pub const groupByWeightedPositiveCount = relation_methods_mod.groupByWeightedPositiveCount;
    pub const groupByWeightedPositiveCountOn = relation_methods_mod.groupByWeightedPositiveCountOn;
    pub const groupByWeightedEffectiveN = relation_methods_mod.groupByWeightedEffectiveN;
    pub const groupByWeightedEffectiveNOn = relation_methods_mod.groupByWeightedEffectiveNOn;
    pub const groupByWeightedEffectiveCount = relation_methods_mod.groupByWeightedEffectiveCount;
    pub const groupByWeightedEffectiveCountOn = relation_methods_mod.groupByWeightedEffectiveCountOn;
    pub const groupByWeightedProd = relation_methods_mod.groupByWeightedProd;
    pub const groupByWeightedProdOn = relation_methods_mod.groupByWeightedProdOn;
    pub const groupByWeightedMeanSquare = relation_methods_mod.groupByWeightedMeanSquare;
    pub const groupByWeightedMeanSquareOn = relation_methods_mod.groupByWeightedMeanSquareOn;
    pub const groupByWeightedRms = relation_methods_mod.groupByWeightedRms;
    pub const groupByWeightedRmsOn = relation_methods_mod.groupByWeightedRmsOn;
    pub const groupByWeightedMeanSquared = relation_methods_mod.groupByWeightedMeanSquared;
    pub const groupByWeightedMeanSquaredOn = relation_methods_mod.groupByWeightedMeanSquaredOn;
    pub const groupByWeightedMeanSq = relation_methods_mod.groupByWeightedMeanSq;
    pub const groupByWeightedMeanSqOn = relation_methods_mod.groupByWeightedMeanSqOn;
    pub const groupByWeightedRMS = relation_methods_mod.groupByWeightedRMS;
    pub const groupByWeightedRMSOn = relation_methods_mod.groupByWeightedRMSOn;
    pub const groupByWeightedMin = relation_methods_mod.groupByWeightedMin;
    pub const groupByWeightedMinOn = relation_methods_mod.groupByWeightedMinOn;
    pub const groupByWeightedMinimum = relation_methods_mod.groupByWeightedMinimum;
    pub const groupByWeightedMinimumOn = relation_methods_mod.groupByWeightedMinimumOn;
    pub const groupByWeightedMax = relation_methods_mod.groupByWeightedMax;
    pub const groupByWeightedMaxOn = relation_methods_mod.groupByWeightedMaxOn;
    pub const groupByWeightedMaximum = relation_methods_mod.groupByWeightedMaximum;
    pub const groupByWeightedMaximumOn = relation_methods_mod.groupByWeightedMaximumOn;
    pub const groupByWeightedMeanAbs = relation_methods_mod.groupByWeightedMeanAbs;
    pub const groupByWeightedMeanAbsOn = relation_methods_mod.groupByWeightedMeanAbsOn;
    pub const groupByWeightedL1Norm = relation_methods_mod.groupByWeightedL1Norm;
    pub const groupByWeightedL1NormOn = relation_methods_mod.groupByWeightedL1NormOn;
    pub const groupByWeightedL2Norm = relation_methods_mod.groupByWeightedL2Norm;
    pub const groupByWeightedL2NormOn = relation_methods_mod.groupByWeightedL2NormOn;
    pub const groupByWeightedMaxAbs = relation_methods_mod.groupByWeightedMaxAbs;
    pub const groupByWeightedMaxAbsOn = relation_methods_mod.groupByWeightedMaxAbsOn;
    pub const groupByWeightedMinAbs = relation_methods_mod.groupByWeightedMinAbs;
    pub const groupByWeightedMinAbsOn = relation_methods_mod.groupByWeightedMinAbsOn;
    pub const groupByWeightedL1 = relation_methods_mod.groupByWeightedL1;
    pub const groupByWeightedL1On = relation_methods_mod.groupByWeightedL1On;
    pub const groupByWeightedL2 = relation_methods_mod.groupByWeightedL2;
    pub const groupByWeightedL2On = relation_methods_mod.groupByWeightedL2On;
    pub const groupByWeightedMaxAbsolute = relation_methods_mod.groupByWeightedMaxAbsolute;
    pub const groupByWeightedMaxAbsoluteOn = relation_methods_mod.groupByWeightedMaxAbsoluteOn;
    pub const groupByWeightedMinAbsolute = relation_methods_mod.groupByWeightedMinAbsolute;
    pub const groupByWeightedMinAbsoluteOn = relation_methods_mod.groupByWeightedMinAbsoluteOn;
    pub const groupByWeightedGeometricMean = relation_methods_mod.groupByWeightedGeometricMean;
    pub const groupByWeightedGeometricMeanOn = relation_methods_mod.groupByWeightedGeometricMeanOn;
    pub const groupByWeightedGeoMean = relation_methods_mod.groupByWeightedGeoMean;
    pub const groupByWeightedGeoMeanOn = relation_methods_mod.groupByWeightedGeoMeanOn;
    pub const groupByWeightedHarmonicMean = relation_methods_mod.groupByWeightedHarmonicMean;
    pub const groupByWeightedHarmonicMeanOn = relation_methods_mod.groupByWeightedHarmonicMeanOn;
    pub const groupByWeightedHarmMean = relation_methods_mod.groupByWeightedHarmMean;
    pub const groupByWeightedHarmMeanOn = relation_methods_mod.groupByWeightedHarmMeanOn;
    pub const groupByWeightedLogSumExp = relation_methods_mod.groupByWeightedLogSumExp;
    pub const groupByWeightedLogSumExpOn = relation_methods_mod.groupByWeightedLogSumExpOn;
    pub const groupByWeightedLogsumexp = relation_methods_mod.groupByWeightedLogsumexp;
    pub const groupByWeightedLogsumexpOn = relation_methods_mod.groupByWeightedLogsumexpOn;
    pub const groupByWeightedLogMeanExp = relation_methods_mod.groupByWeightedLogMeanExp;
    pub const groupByWeightedLogMeanExpOn = relation_methods_mod.groupByWeightedLogMeanExpOn;
    pub const groupByWeightedLogmeanexp = relation_methods_mod.groupByWeightedLogmeanexp;
    pub const groupByWeightedLogmeanexpOn = relation_methods_mod.groupByWeightedLogmeanexpOn;
    pub const groupByWeightedRange = relation_methods_mod.groupByWeightedRange;
    pub const groupByWeightedRangeOn = relation_methods_mod.groupByWeightedRangeOn;
    pub const groupByWeightedMidrange = relation_methods_mod.groupByWeightedMidrange;
    pub const groupByWeightedMidrangeOn = relation_methods_mod.groupByWeightedMidrangeOn;
    pub const groupByWeightedRangeCoeff = relation_methods_mod.groupByWeightedRangeCoeff;
    pub const groupByWeightedRangeCoeffOn = relation_methods_mod.groupByWeightedRangeCoeffOn;
    pub const groupByWeightedRangeCoefficient = relation_methods_mod.groupByWeightedRangeCoefficient;
    pub const groupByWeightedRangeCoefficientOn = relation_methods_mod.groupByWeightedRangeCoefficientOn;
    ...
    pub const groupByWeightedSem = relation_methods_mod.groupByWeightedSem;
    pub const groupByWeightedSemOn = relation_methods_mod.groupByWeightedSemOn;
    pub const groupByWeightedCv = relation_methods_mod.groupByWeightedCv;
    pub const groupByWeightedCvOn = relation_methods_mod.groupByWeightedCvOn;
    pub const groupByWeightedFano = relation_methods_mod.groupByWeightedFano;
    pub const groupByWeightedFanoOn = relation_methods_mod.groupByWeightedFanoOn;
    pub const groupByWeightedSkewness = relation_methods_mod.groupByWeightedSkewness;
    pub const groupByWeightedSkewnessOn = relation_methods_mod.groupByWeightedSkewnessOn;
    pub const groupByWeightedSkew = relation_methods_mod.groupByWeightedSkew;
    pub const groupByWeightedSkewOn = relation_methods_mod.groupByWeightedSkewOn;
    pub const groupByWeightedKurtosis = relation_methods_mod.groupByWeightedKurtosis;
    pub const groupByWeightedKurtosisOn = relation_methods_mod.groupByWeightedKurtosisOn;
    pub const groupByWeightedKurt = relation_methods_mod.groupByWeightedKurt;
    pub const groupByWeightedKurtOn = relation_methods_mod.groupByWeightedKurtOn;
    pub const groupByWeightedSEM = relation_methods_mod.groupByWeightedSEM;
    pub const groupByWeightedSEMOn = relation_methods_mod.groupByWeightedSEMOn;
    pub const groupByWeightedCV = relation_methods_mod.groupByWeightedCV;
    pub const groupByWeightedCVOn = relation_methods_mod.groupByWeightedCVOn;
    ...
    pub const groupByWeightedMAD = relation_methods_mod.groupByWeightedMAD;
    pub const groupByWeightedMADOn = relation_methods_mod.groupByWeightedMADOn;
    pub const groupByWeightedTrimmedMean = relation_methods_mod.groupByWeightedTrimmedMean;
    pub const groupByWeightedTrimmedMeanOn = relation_methods_mod.groupByWeightedTrimmedMeanOn;
    pub const groupByWeightedWinsorizedMean = relation_methods_mod.groupByWeightedWinsorizedMean;
    pub const groupByWeightedWinsorizedMeanOn = relation_methods_mod.groupByWeightedWinsorizedMeanOn;
    ...
    pub const groupByWeightedMeanAbsDev = relation_methods_mod.groupByWeightedMeanAbsDev;
    pub const groupByWeightedMeanAbsDevOn = relation_methods_mod.groupByWeightedMeanAbsDevOn;
    pub const groupByWeightedMeanAbsDevRatio = relation_methods_mod.groupByWeightedMeanAbsDevRatio;
    pub const groupByWeightedMeanAbsDevRatioOn = relation_methods_mod.groupByWeightedMeanAbsDevRatioOn;
    pub const groupByWeightedMeanAbsoluteDeviation = relation_methods_mod.groupByWeightedMeanAbsoluteDeviation;
    pub const groupByWeightedMeanAbsoluteDeviationOn = relation_methods_mod.groupByWeightedMeanAbsoluteDeviationOn;
    pub const groupByWeightedGiniMeanDiff = relation_methods_mod.groupByWeightedGiniMeanDiff;
    pub const groupByWeightedGiniMeanDiffOn = relation_methods_mod.groupByWeightedGiniMeanDiffOn;
    pub const groupByWeightedGiniCoefficient = relation_methods_mod.groupByWeightedGiniCoefficient;
    pub const groupByWeightedGiniCoefficientOn = relation_methods_mod.groupByWeightedGiniCoefficientOn;
    pub const groupByWeightedGiniCoeff = relation_methods_mod.groupByWeightedGiniCoeff;
    pub const groupByWeightedGiniCoeffOn = relation_methods_mod.groupByWeightedGiniCoeffOn;
    pub const groupByWeightedInterdecileRange = relation_methods_mod.groupByWeightedInterdecileRange;
    pub const groupByWeightedInterdecileRangeOn = relation_methods_mod.groupByWeightedInterdecileRangeOn;
    pub const groupByWeightedIdr = relation_methods_mod.groupByWeightedIdr;
    pub const groupByWeightedIdrOn = relation_methods_mod.groupByWeightedIdrOn;
    pub const groupByWeightedIDR = relation_methods_mod.groupByWeightedIDR;
    pub const groupByWeightedIDROn = relation_methods_mod.groupByWeightedIDROn;
    pub const groupByWeightedMidhinge = relation_methods_mod.groupByWeightedMidhinge;
    pub const groupByWeightedMidhingeOn = relation_methods_mod.groupByWeightedMidhingeOn;
    pub const groupByWeightedTrimean = relation_methods_mod.groupByWeightedTrimean;
    pub const groupByWeightedTrimeanOn = relation_methods_mod.groupByWeightedTrimeanOn;
    pub const groupByWeightedBowleySkewness = relation_methods_mod.groupByWeightedBowleySkewness;
    pub const groupByWeightedBowleySkewnessOn = relation_methods_mod.groupByWeightedBowleySkewnessOn;
    pub const groupByWeightedBowleySkew = relation_methods_mod.groupByWeightedBowleySkew;
    pub const groupByWeightedBowleySkewOn = relation_methods_mod.groupByWeightedBowleySkewOn;
    pub const groupByWeightedQuartileCoeffDispersion = relation_methods_mod.groupByWeightedQuartileCoeffDispersion;
    pub const groupByWeightedQuartileCoeffDispersionOn = relation_methods_mod.groupByWeightedQuartileCoeffDispersionOn;
    pub const groupByWeightedQcd = relation_methods_mod.groupByWeightedQcd;
    pub const groupByWeightedQcdOn = relation_methods_mod.groupByWeightedQcdOn;
    pub const groupByWeightedQCD = relation_methods_mod.groupByWeightedQCD;
    pub const groupByWeightedQCDOn = relation_methods_mod.groupByWeightedQCDOn;
    pub const groupByWeightedKelleySkewness = relation_methods_mod.groupByWeightedKelleySkewness;
    pub const groupByWeightedKelleySkewnessOn = relation_methods_mod.groupByWeightedKelleySkewnessOn;
    pub const groupByWeightedKelleySkew = relation_methods_mod.groupByWeightedKelleySkew;
    pub const groupByWeightedKelleySkewOn = relation_methods_mod.groupByWeightedKelleySkewOn;
