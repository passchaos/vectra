...
test "device dataframe groupby aggregations on fixed-width columns" {
    ...
    const weighted_product_expected = [_]f64{ std.math.exp(std.math.log(f64, std.math.e, @as(f64, 10.0)) + 3.0 * std.math.log(f64, std.math.e, @as(f64, 20.0)) + 2.0 * std.math.log(f64, std.math.e, @as(f64, 30.0))), std.math.exp(std.math.log(f64, std.math.e, @as(f64, 5.0)) + std.math.log(f64, std.math.e, @as(f64, 15.0))), std.math.nan(f64) };
    var weighted_product = try weighted_table.groupByWeightedProduct("bucket", "value", "weight", "value_weighted_product");
    ...
    const weighted_mean_abs_expected = [_]f64{ 65.0 / 3.0, 10.0, std.math.nan(f64) };
    const weighted_l1_expected = [_]f64{ 130.0, 20.0, std.math.nan(f64) };
    const weighted_l2_expected = [_]f64{ std.math.sqrt(@as(f64, 3100.0)), std.math.sqrt(@as(f64, 250.0)), std.math.nan(f64) };
    const weighted_max_abs_expected = [_]f64{ 30.0, 15.0, std.math.nan(f64) };
    const weighted_min_abs_expected = [_]f64{ 10.0, 5.0, std.math.nan(f64) };
    const weighted_min_expected = [_]f64{ 10.0, 5.0, std.math.nan(f64) };
    const weighted_max_expected = [_]f64{ 30.0, 15.0, std.math.nan(f64) };

    var weighted_mean_abs = try weighted_table.groupByWeightedMeanAbs("bucket", "value", "weight", "value_weighted_mean_abs");
    defer weighted_mean_abs.deinit();
    try expectF64ColumnApproxOrNan(weighted_mean_abs, gpa, "value_weighted_mean_abs", &weighted_mean_abs_expected);

    var weighted_l1 = try weighted_table.groupByWeightedL1("bucket", "value", "weight", "value_weighted_l1");
    defer weighted_l1.deinit();
    try expectF64ColumnApproxOrNan(weighted_l1, gpa, "value_weighted_l1", &weighted_l1_expected);

    var weighted_l2 = try weighted_table.groupByWeightedL2Norm("bucket", "value", "weight", "value_weighted_l2");
    defer weighted_l2.deinit();
    try expectF64ColumnApproxOrNan(weighted_l2, gpa, "value_weighted_l2", &weighted_l2_expected);

    var weighted_max_abs = try weighted_table.groupByWeightedMaxAbs("bucket", "value", "weight", "value_weighted_max_abs");
    defer weighted_max_abs.deinit();
    try expectF64ColumnApproxOrNan(weighted_max_abs, gpa, "value_weighted_max_abs", &weighted_max_abs_expected);

    var weighted_min_abs = try weighted_table.groupByWeightedMinAbs("bucket", "value", "weight", "value_weighted_min_abs");
    defer weighted_min_abs.deinit();
    try expectF64ColumnApproxOrNan(weighted_min_abs, gpa, "value_weighted_min_abs", &weighted_min_abs_expected);

    var weighted_min = try weighted_table.groupByWeightedMin("bucket", "value", "weight", "value_weighted_min");
    defer weighted_min.deinit();
    try expectF64ColumnApproxOrNan(weighted_min, gpa, "value_weighted_min", &weighted_min_expected);

    var weighted_max = try weighted_table.groupByWeightedMax("bucket", "value", "weight", "value_weighted_max");
    defer weighted_max.deinit();
    try expectF64ColumnApproxOrNan(weighted_max, gpa, "value_weighted_max", &weighted_max_expected);

    const weighted_geometric_expected = [_]f64{ std.math.exp((std.math.log(f64, std.math.e, @as(f64, 10.0)) + 3.0 * std.math.log(f64, std.math.e, @as(f64, 20.0)) + 2.0 * std.math.log(f64, std.math.e, @as(f64, 30.0))) / 6.0), std.math.exp((std.math.log(f64, std.math.e, @as(f64, 5.0)) + std.math.log(f64, std.math.e, @as(f64, 15.0))) / 2.0), std.math.nan(f64) };
    const weighted_harmonic_expected = [_]f64{ 6.0 / (1.0 / 10.0 + 3.0 / 20.0 + 2.0 / 30.0), 2.0 / (1.0 / 5.0 + 1.0 / 15.0), std.math.nan(f64) };
    const weighted_logsumexp_bucket1 = 30.0 + std.math.log(f64, std.math.e, 2.0 + 3.0 * std.math.exp(@as(f64, -10.0)) + std.math.exp(@as(f64, -20.0)));
    ...
    try expectF64ColumnApproxOrNan(weighted_geometric, gpa, "value_weighted_geometric", &weighted_geometric_expected);

    var weighted_harmonic = try weighted_table.groupByWeightedHarmonicMean("bucket", "value", "weight", "value_weighted_harmonic");
    defer weighted_harmonic.deinit();
    try expectF64ColumnApproxOrNan(weighted_harmonic, gpa, "value_weighted_harmonic", &weighted_harmonic_expected);

    var weighted_logsumexp = try weighted_table.groupByWeightedLogSumExp("bucket", "value", "weight", "value_weighted_logsumexp");
    defer weighted_logsumexp.deinit();
    try expectF64ColumnApproxOrNan(weighted_logsumexp, gpa, "value_weighted_logsumexp", &weighted_logsumexp_expected);
    ...
    try std.testing.expectError(error.InvalidShape, negative_weight_table.groupByWeightedProduct("bucket", "value", "weight", "bad_weighted_product"));
    ...
    try std.testing.expectError(error.InvalidShape, negative_weight_table.withGroupCumulativeWeightedSkewness("bucket", "value", "weight", "bad_weighted_cum_skew"));
    try std.testing.expectError(error.InvalidShape, negative_weight_table.withGroupCumulativeWeightedKurtosis("bucket", "value", "weight", "bad_weighted_cum_kurt"));
    ...
    var group_cum_weighted_product = try weighted_table.withGroupCumulativeWeightedProduct("bucket", "value", "weight", "value_weighted_cum_product");
    ...
    const group_cum_weighted_mode_validity = [_]bool{ true, true, true, true, true, false, true, true };
    const group_cum_weighted_mode_expected = [_]f64{ 10.0, 20.0, 20.0, 5.0, 5.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_mode_weight_expected = [_]f64{ 1.0, 3.0, 3.0, 1.0, 1.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_mode_ratio_expected = [_]f64{ 1.0, 0.75, 0.5, 1.0, 0.5, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_mode_margin_expected = [_]f64{ 1.0, 2.0, 1.0, 1.0, 0.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_mode_margin_ratio_expected = [_]f64{ 1.0, 0.5, 1.0 / 6.0, 1.0, 0.0, 0.0, std.math.nan(f64), std.math.nan(f64) };

    var group_cum_weighted_mode = try weighted_table.withGroupCumulativeWeightedMode("bucket", "value", "weight", "value_weighted_cum_mode");
    defer group_cum_weighted_mode.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_mode, gpa, "value_weighted_cum_mode", &group_cum_weighted_mode_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_mode_weight = try weighted_table.withGroupCumulativeWeightedModeWeight("bucket", "value", "weight", "value_weighted_cum_mode_weight");
    defer group_cum_weighted_mode_weight.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_mode_weight, gpa, "value_weighted_cum_mode_weight", &group_cum_weighted_mode_weight_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_mode_ratio = try weighted_table.withGroupCumulativeWeightedModeRatio("bucket", "value", "weight", "value_weighted_cum_mode_ratio");
    defer group_cum_weighted_mode_ratio.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_mode_ratio, gpa, "value_weighted_cum_mode_ratio", &group_cum_weighted_mode_ratio_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_mode_margin = try weighted_table.withGroupCumulativeWeightedModeMargin("bucket", "value", "weight", "value_weighted_cum_mode_margin");
    defer group_cum_weighted_mode_margin.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_mode_margin, gpa, "value_weighted_cum_mode_margin", &group_cum_weighted_mode_margin_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_mode_margin_ratio = try weighted_table.withGroupCumulativeWeightedModeMarginRatio("bucket", "value", "weight", "value_weighted_cum_mode_margin_ratio");
    defer group_cum_weighted_mode_margin_ratio.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_mode_margin_ratio, gpa, "value_weighted_cum_mode_margin_ratio", &group_cum_weighted_mode_margin_ratio_expected, &group_cum_weighted_mode_validity);

    var cumulative_weighted_mode_plan = try DeviceLazyFrame.init(gpa, weighted_table);
    defer cumulative_weighted_mode_plan.deinit();
    try cumulative_weighted_mode_plan.withGroupCumulativeWeightedMode("bucket", "value", "weight", "value_weighted_cum_mode_lazy");
    try cumulative_weighted_mode_plan.withGroupCumulativeWeightedModeWeight("bucket", "value", "weight", "value_weighted_cum_mode_weight_lazy");
    try cumulative_weighted_mode_plan.withGroupCumulativeWeightedModeRatio("bucket", "value", "weight", "value_weighted_cum_mode_ratio_lazy");
    try cumulative_weighted_mode_plan.withGroupCumulativeWeightedModeMargin("bucket", "value", "weight", "value_weighted_cum_mode_margin_lazy");
    try cumulative_weighted_mode_plan.withGroupCumulativeWeightedModeMarginRatio("bucket", "value", "weight", "value_weighted_cum_mode_margin_ratio_lazy");
    const cumulative_weighted_mode_explained = try cumulative_weighted_mode_plan.explain(gpa);
    defer gpa.free(cumulative_weighted_mode_explained);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_mode_explained, "group_cumulative_weighted_mode([bucket], value=value, weight=weight->value_weighted_cum_mode_lazy)") != null);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_mode_explained, "group_cumulative_weighted_mode_margin_ratio([bucket], value=value, weight=weight->value_weighted_cum_mode_margin_ratio_lazy)") != null);
    var lazy_cumulative_weighted_modes = try cumulative_weighted_mode_plan.collect();
    defer lazy_cumulative_weighted_modes.deinit();
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_modes, gpa, "value_weighted_cum_mode_lazy", &group_cum_weighted_mode_expected, &group_cum_weighted_mode_validity);
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_modes, gpa, "value_weighted_cum_mode_weight_lazy", &group_cum_weighted_mode_weight_expected, &group_cum_weighted_mode_validity);
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_modes, gpa, "value_weighted_cum_mode_ratio_lazy", &group_cum_weighted_mode_ratio_expected, &group_cum_weighted_mode_validity);
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_modes, gpa, "value_weighted_cum_mode_margin_lazy", &group_cum_weighted_mode_margin_expected, &group_cum_weighted_mode_validity);
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_modes, gpa, "value_weighted_cum_mode_margin_ratio_lazy", &group_cum_weighted_mode_margin_ratio_expected, &group_cum_weighted_mode_validity);

    const weighted_entropy_12 = -(@as(f64, 0.25) * std.math.log(f64, std.math.e, @as(f64, 0.25)) + @as(f64, 0.75) * std.math.log(f64, std.math.e, @as(f64, 0.75)));
    const weighted_entropy_123 = -(@as(f64, 1.0 / 6.0) * std.math.log(f64, std.math.e, @as(f64, 1.0 / 6.0)) + @as(f64, 0.5) * std.math.log(f64, std.math.e, @as(f64, 0.5)) + @as(f64, 1.0 / 3.0) * std.math.log(f64, std.math.e, @as(f64, 1.0 / 3.0)));
    const ln2 = std.math.log(f64, std.math.e, @as(f64, 2.0));
    const ln3 = std.math.log(f64, std.math.e, @as(f64, 3.0));
    const group_cum_weighted_entropy_expected = [_]f64{ 0.0, weighted_entropy_12, weighted_entropy_123, 0.0, ln2, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_gini_expected = [_]f64{ 0.0, 0.375, 11.0 / 18.0, 0.0, 0.5, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_perplexity_expected = [_]f64{ 1.0, std.math.exp(weighted_entropy_12), std.math.exp(weighted_entropy_123), 1.0, 2.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    ...
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_entropy, gpa, "value_weighted_cum_entropy", &group_cum_weighted_entropy_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_gini = try weighted_table.withGroupCumulativeWeightedGini("bucket", "value", "weight", "value_weighted_cum_gini");
    defer group_cum_weighted_gini.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_gini, gpa, "value_weighted_cum_gini", &group_cum_weighted_gini_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_perplexity = try weighted_table.withGroupCumulativeWeightedPerplexity("bucket", "value", "weight", "value_weighted_cum_perplexity");
    defer group_cum_weighted_perplexity.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_perplexity, gpa, "value_weighted_cum_perplexity", &group_cum_weighted_perplexity_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_inverse = try weighted_table.withGroupCumulativeWeightedInverseSimpson("bucket", "value", "weight", "value_weighted_cum_inverse");
    defer group_cum_weighted_inverse.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_inverse, gpa, "value_weighted_cum_inverse", &group_cum_weighted_inverse_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_concentration = try weighted_table.withGroupCumulativeWeightedConcentration("bucket", "value", "weight", "value_weighted_cum_concentration");
    defer group_cum_weighted_concentration.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_concentration, gpa, "value_weighted_cum_concentration", &group_cum_weighted_concentration_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_evenness = try weighted_table.withGroupCumulativeWeightedEvenness("bucket", "value", "weight", "value_weighted_cum_evenness");
    ...
    try cumulative_weighted_distribution_plan.withGroupCumulativeWeightedGini("bucket", "value", "weight", "value_weighted_cum_gini_lazy");
    try cumulative_weighted_distribution_plan.withGroupCumulativeWeightedPerplexity("bucket", "value", "weight", "value_weighted_cum_perplexity_lazy");
    ...
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_distribution, gpa, "value_weighted_cum_gini_lazy", &group_cum_weighted_gini_expected, &group_cum_weighted_mode_validity);
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_distribution, gpa, "value_weighted_cum_perplexity_lazy", &group_cum_weighted_perplexity_expected, &group_cum_weighted_mode_validity);
    ...
    const group_cum_weighted_cov_expected = [_]f64{ 0.0, -0.1875, 3.25, 0.0, -1.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_corr_expected = [_]f64{ std.math.nan(f64), -1.0, 19.5 / std.math.sqrt(@as(f64, 7.5 * 61.5)), std.math.nan(f64), -1.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_beta_expected = [_]f64{ std.math.nan(f64), -1.0, 2.6, std.math.nan(f64), -1.0, 0.0, std.math.nan(f64), std.math.nan(f64) };

    var group_cum_weighted_cov = try weighted_table.withGroupCumulativeWeightedCov("bucket", "lhs", "rhs", "weight", "lhs_rhs_weighted_cum_cov", 0.0);
    defer group_cum_weighted_cov.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_cov, gpa, "lhs_rhs_weighted_cum_cov", &group_cum_weighted_cov_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_corr = try weighted_table.withGroupCumulativeWeightedCorrelation("bucket", "lhs", "rhs", "weight", "lhs_rhs_weighted_cum_corr", 0.0);
    defer group_cum_weighted_corr.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_corr, gpa, "lhs_rhs_weighted_cum_corr", &group_cum_weighted_corr_expected, &group_cum_weighted_mode_validity);

    var group_cum_weighted_beta = try weighted_table.withGroupCumulativeWeightedBeta("bucket", "lhs", "rhs", "weight", "lhs_rhs_weighted_cum_beta", 0.0);
    defer group_cum_weighted_beta.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_beta, gpa, "lhs_rhs_weighted_cum_beta", &group_cum_weighted_beta_expected, &group_cum_weighted_mode_validity);

    var cumulative_weighted_pair_plan = try DeviceLazyFrame.init(gpa, weighted_table);
    defer cumulative_weighted_pair_plan.deinit();
    try cumulative_weighted_pair_plan.withGroupCumulativeWeightedCov("bucket", "lhs", "rhs", "weight", "lhs_rhs_weighted_cum_cov_lazy", 0.0);
    try cumulative_weighted_pair_plan.withGroupCumulativeWeightedCorr("bucket", "lhs", "rhs", "weight", "lhs_rhs_weighted_cum_corr_lazy", 0.0);
    try cumulative_weighted_pair_plan.withGroupCumulativeWeightedBeta("bucket", "lhs", "rhs", "weight", "lhs_rhs_weighted_cum_beta_lazy", 0.0);
    const cumulative_weighted_pair_explained = try cumulative_weighted_pair_plan.explain(gpa);
    defer gpa.free(cumulative_weighted_pair_explained);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_pair_explained, "group_cumulative_weighted_covariance([bucket], lhs=lhs, rhs=rhs, weight=weight->lhs_rhs_weighted_cum_cov_lazy)") != null);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_pair_explained, "group_cumulative_weighted_beta([bucket], lhs=lhs, rhs=rhs, weight=weight->lhs_rhs_weighted_cum_beta_lazy)") != null);
    var lazy_cumulative_weighted_pair = try cumulative_weighted_pair_plan.collect();
    defer lazy_cumulative_weighted_pair.deinit();
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_pair, gpa, "lhs_rhs_weighted_cum_cov_lazy", &group_cum_weighted_cov_expected, &group_cum_weighted_mode_validity);
    ...
    const group_cum_weighted_mean_abs_expected = [_]f64{ 10.0, 17.5, 65.0 / 3.0, 5.0, 10.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_l1_expected = [_]f64{ 10.0, 70.0, 130.0, 5.0, 20.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_l2_expected = [_]f64{ 10.0, std.math.sqrt(@as(f64, 1300.0)), std.math.sqrt(@as(f64, 3100.0)), 5.0, std.math.sqrt(@as(f64, 250.0)), 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_min_expected = [_]f64{ 10.0, 10.0, 10.0, 5.0, 5.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_max_expected = [_]f64{ 10.0, 20.0, 30.0, 5.0, 15.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_max_abs_expected = [_]f64{ 10.0, 20.0, 30.0, 5.0, 15.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_min_abs_expected = [_]f64{ 10.0, 10.0, 10.0, 5.0, 5.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_geometric_expected = [_]f64{ 10.0, std.math.exp((std.math.log(f64, std.math.e, @as(f64, 10.0)) + 3.0 * std.math.log(f64, std.math.e, @as(f64, 20.0))) / 4.0), weighted_geometric_expected[0], 5.0, std.math.sqrt(@as(f64, 75.0)), 0.0, std.math.nan(f64), std.math.nan(f64) };
    ...
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_mean_abs, gpa, "value_weighted_cum_mean_abs", &group_cum_weighted_mean_abs_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_l1 = try weighted_table.withGroupCumulativeWeightedL1("bucket", "value", "weight", "value_weighted_cum_l1");
    defer group_cum_weighted_l1.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_l1, gpa, "value_weighted_cum_l1", &group_cum_weighted_l1_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_l2 = try weighted_table.withGroupCumulativeWeightedL2Norm("bucket", "value", "weight", "value_weighted_cum_l2");
    defer group_cum_weighted_l2.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_l2, gpa, "value_weighted_cum_l2", &group_cum_weighted_l2_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_min = try weighted_table.withGroupCumulativeWeightedMin("bucket", "value", "weight", "value_weighted_cum_min");
    defer group_cum_weighted_min.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_min, gpa, "value_weighted_cum_min", &group_cum_weighted_min_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_max = try weighted_table.withGroupCumulativeWeightedMax("bucket", "value", "weight", "value_weighted_cum_max");
    defer group_cum_weighted_max.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_max, gpa, "value_weighted_cum_max", &group_cum_weighted_max_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_max_abs = try weighted_table.withGroupCumulativeWeightedMaxAbs("bucket", "value", "weight", "value_weighted_cum_max_abs");
    defer group_cum_weighted_max_abs.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_max_abs, gpa, "value_weighted_cum_max_abs", &group_cum_weighted_max_abs_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_min_abs = try weighted_table.withGroupCumulativeWeightedMinAbs("bucket", "value", "weight", "value_weighted_cum_min_abs");
    defer group_cum_weighted_min_abs.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_min_abs, gpa, "value_weighted_cum_min_abs", &group_cum_weighted_min_abs_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_geometric = try weighted_table.withGroupCumulativeWeightedGeoMean("bucket", "value", "weight", "value_weighted_cum_geometric");
    defer group_cum_weighted_geometric.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_geometric, gpa, "value_weighted_cum_geometric", &group_cum_weighted_geometric_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_harmonic = try weighted_table.withGroupCumulativeWeightedHarmonicMean("bucket", "value", "weight", "value_weighted_cum_harmonic");
    defer group_cum_weighted_harmonic.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_harmonic, gpa, "value_weighted_cum_harmonic", &group_cum_weighted_harmonic_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_logsumexp = try weighted_table.withGroupCumulativeWeightedLogsumexp("bucket", "value", "weight", "value_weighted_cum_logsumexp");
    defer group_cum_weighted_logsumexp.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_logsumexp, gpa, "value_weighted_cum_logsumexp", &group_cum_weighted_logsumexp_expected, &.{ true, true, true, true, true, false, true, true });
    ...
    var group_cum_weighted_variance = try weighted_table.withGroupCumulativeWeightedVar("bucket", "value", "weight", "value_weighted_cum_variance");
    defer group_cum_weighted_variance.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_variance, gpa, "value_weighted_cum_variance", &group_cum_weighted_variance_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_stddev = try weighted_table.withGroupCumulativeWeightedStddev("bucket", "value", "weight", "value_weighted_cum_stddev");
    ...
    const group_cum_weighted_skew_expected = [_]f64{ std.math.nan(f64), -2.0 / std.math.sqrt(@as(f64, 3.0)), weighted_skew_expected[0], std.math.nan(f64), 0.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    const group_cum_weighted_kurt_expected = [_]f64{ std.math.nan(f64), -2.0 / 3.0, weighted_kurt_expected[0], std.math.nan(f64), -2.0, 0.0, std.math.nan(f64), std.math.nan(f64) };
    ...
    var group_cum_weighted_skew = try weighted_table.withGroupCumulativeWeightedSkewness("bucket", "value", "weight", "value_weighted_cum_skew");
    defer group_cum_weighted_skew.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_skew, gpa, "value_weighted_cum_skew", &group_cum_weighted_skew_expected, &.{ true, true, true, true, true, false, true, true });

    var group_cum_weighted_kurt = try weighted_table.withGroupCumulativeWeightedKurtosis("bucket", "value", "weight", "value_weighted_cum_kurt");
    defer group_cum_weighted_kurt.deinit();
    try expectF64ColumnApproxOrNanWithValidity(group_cum_weighted_kurt, gpa, "value_weighted_cum_kurt", &group_cum_weighted_kurt_expected, &.{ true, true, true, true, true, false, true, true });
    ...
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedMeanAbs("bucket", "value", "weight", "value_weighted_cum_mean_abs_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedL1Norm("bucket", "value", "weight", "value_weighted_cum_l1_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedL2Norm("bucket", "value", "weight", "value_weighted_cum_l2_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedMin("bucket", "value", "weight", "value_weighted_cum_min_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedMax("bucket", "value", "weight", "value_weighted_cum_max_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedMaxAbs("bucket", "value", "weight", "value_weighted_cum_max_abs_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedMinAbs("bucket", "value", "weight", "value_weighted_cum_min_abs_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedGeoMean("bucket", "value", "weight", "value_weighted_cum_geometric_lazy");
    ...
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedSkewness("bucket", "value", "weight", "value_weighted_cum_skew_lazy");
    try cumulative_weighted_moment_plan.withGroupCumulativeWeightedKurtosis("bucket", "value", "weight", "value_weighted_cum_kurt_lazy");
    ...
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_moment_explained, "group_cumulative_weighted_mean_abs([bucket], value=value, weight=weight->value_weighted_cum_mean_abs_lazy)") != null);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_moment_explained, "group_cumulative_weighted_min([bucket], value=value, weight=weight->value_weighted_cum_min_lazy)") != null);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_moment_explained, "group_cumulative_weighted_max([bucket], value=value, weight=weight->value_weighted_cum_max_lazy)") != null);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_moment_explained, "group_cumulative_weighted_geometric_mean([bucket], value=value, weight=weight->value_weighted_cum_geometric_lazy)") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_moment_explained, "group_cumulative_weighted_skewness([bucket], value=value, weight=weight->value_weighted_cum_skew_lazy)") != null);
    try std.testing.expect(std.mem.indexOf(u8, cumulative_weighted_moment_explained, "group_cumulative_weighted_kurtosis([bucket], value=value, weight=weight->value_weighted_cum_kurt_lazy)") != null);
    ...
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_mean_abs_lazy", &group_cum_weighted_mean_abs_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_l1_lazy", &group_cum_weighted_l1_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_l2_lazy", &group_cum_weighted_l2_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_min_lazy", &group_cum_weighted_min_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_max_lazy", &group_cum_weighted_max_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_max_abs_lazy", &group_cum_weighted_max_abs_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_min_abs_lazy", &group_cum_weighted_min_abs_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_geometric_lazy", &group_cum_weighted_geometric_expected, &.{ true, true, true, true, true, false, true, true });
    ...
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_skew_lazy", &group_cum_weighted_skew_expected, &.{ true, true, true, true, true, false, true, true });
    try expectF64ColumnApproxOrNanWithValidity(lazy_cumulative_weighted_moments, gpa, "value_weighted_cum_kurt_lazy", &group_cum_weighted_kurt_expected, &.{ true, true, true, true, true, false, true, true });
    ...
    const weighted_lazy_cases = [_]struct {
        ...
        .{ .method = .weighted_max, .output_name = "value_weighted_max_lazy", .explain = "group_by_weighted_max(bucket, value=value, weight=weight -> value_weighted_max_lazy)", .expected = &weighted_max_expected },
        .{ .method = .weighted_mean_abs, .output_name = "value_weighted_mean_abs_lazy", .explain = "group_by_weighted_mean_abs(bucket, value=value, weight=weight -> value_weighted_mean_abs_lazy)", .expected = &weighted_mean_abs_expected },
        .{ .method = .weighted_l1_norm, .output_name = "value_weighted_l1_lazy", .explain = "group_by_weighted_l1_norm(bucket, value=value, weight=weight -> value_weighted_l1_lazy)", .expected = &weighted_l1_expected },
        .{ .method = .weighted_l2_norm, .output_name = "value_weighted_l2_lazy", .explain = "group_by_weighted_l2_norm(bucket, value=value, weight=weight -> value_weighted_l2_lazy)", .expected = &weighted_l2_expected },
        .{ .method = .weighted_max_abs, .output_name = "value_weighted_max_abs_lazy", .explain = "group_by_weighted_max_abs(bucket, value=value, weight=weight -> value_weighted_max_abs_lazy)", .expected = &weighted_max_abs_expected },
        .{ .method = .weighted_min_abs, .output_name = "value_weighted_min_abs_lazy", .explain = "group_by_weighted_min_abs(bucket, value=value, weight=weight -> value_weighted_min_abs_lazy)", .expected = &weighted_min_abs_expected },
        .{ .method = .weighted_geometric_mean, .output_name = "value_weighted_geometric_lazy", .explain = "group_by_weighted_geometric_mean(bucket, value=value, weight=weight -> value_weighted_geometric_lazy)", .expected = &weighted_geometric_expected },
    ...
    for (weighted_lazy_cases) |case| {
        ...
        try switch (case.method) {
            ...
            .weighted_max => plan.groupByWeightedMax("bucket", "value", "weight", case.output_name),
            .weighted_mean_abs => plan.groupByWeightedMeanAbs("bucket", "value", "weight", case.output_name),
            .weighted_l1_norm => plan.groupByWeightedL1Norm("bucket", "value", "weight", case.output_name),
            .weighted_l2_norm => plan.groupByWeightedL2Norm("bucket", "value", "weight", case.output_name),
            .weighted_max_abs => plan.groupByWeightedMaxAbs("bucket", "value", "weight", case.output_name),
            .weighted_min_abs => plan.groupByWeightedMinAbs("bucket", "value", "weight", case.output_name),
            .weighted_geometric_mean => plan.groupByWeightedGeoMean("bucket", "value", "weight", case.output_name),
