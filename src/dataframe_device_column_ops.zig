...
pub fn l1Norm(self: anytype) array_mod.ArrayError!options_mod.DeviceScalar {
    const value = columnValue(self);
    return switch (value) {
        .bool, .c64, .c128 => error.TypeUnsupported,
        inline else => |typed| .{ .f64 = try typed.l1Norm() },
    };
}

pub fn l2Norm(self: anytype) array_mod.ArrayError!options_mod.DeviceScalar {
    const value = columnValue(self);
    return switch (value) {
        .bool, .c64, .c128 => error.TypeUnsupported,
        inline else => |typed| .{ .f64 = try typed.l2Norm() },
    };
}

pub fn geometricMean(self: anytype) array_mod.ArrayError!options_mod.DeviceScalar {
    const value = columnValue(self);
    return switch (value) {
        .bool, .c64, .c128 => error.TypeUnsupported,
        inline else => |typed| .{ .f64 = try typed.geometricMean() },
    };
}

pub fn harmonicMean(self: anytype) array_mod.ArrayError!options_mod.DeviceScalar {
    const value = columnValue(self);
    return switch (value) {
        .bool, .c64, .c128 => error.TypeUnsupported,
        inline else => |typed| .{ .f64 = try typed.harmonicMean() },
    };
}

pub fn mad(self: anytype) array_mod.ArrayError!options_mod.DeviceScalar {
    const value = columnValue(self);
    return switch (value) {
        .bool, .c64, .c128 => error.TypeUnsupported,
        inline else => |typed| .{ .f64 = try typed.mad() },
    };
}

pub fn iqr(self: anytype) array_mod.ArrayError!options_mod.DeviceScalar {
    const value = columnValue(self);
    return switch (value) {
        .bool, .c64, .c128 => error.TypeUnsupported,
        inline else => |typed| .{ .f64 = try typed.iqr() },
    };
}
