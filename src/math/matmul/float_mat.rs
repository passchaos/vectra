        ...
        match policy {
            ...
            MatmulPolicy::LoopRecorderSimd => {
                ...
                for i in 0..m {
                    for l in 0..k {
                        ...
                        let a_v = unsafe { vld1q_dup_f32(&self.data[i * l_s_r + l * l_s_c]) };
            ...
            MatmulPolicy::Blas => {
                ...
                let (transa, transb, lda, ldb) = match (self.major_order, rhs.major_order) {
                    ...
                    (MajorOrder::ColumnMajor, MajorOrder::ColumnMajor) => (b'T', b'T', k, m),
                };
            ...
            MatmulPolicy::LoopRecorderSimd => {
                ...
                for i in 0..m {
                    for l in 0..k {
                        ...
                        let a_v = unsafe { vld1q_dup_f64(&self.data[i * l_s_r + l * l_s_c]) };
