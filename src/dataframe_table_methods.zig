...
const keys_mod = @import("dataframe/keys.zig");
...
pub fn withRowCumulativeWeightedManhattanDistance(self: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedManhattanDistance(FrameType(@TypeOf(self)), frameValue(self), lhs_names, rhs_names, weight_names, output_names);
}
...
pub fn withRowCumulativeWeightedChebyshevDistance(self: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedChebyshevDistance(FrameType(@TypeOf(self)), frameValue(self), lhs_names, rhs_names, weight_names, output_names);
}
...
pub fn withRowCumulativeWeightedBrayCurtisDistance(self: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedBrayCurtisDistance(FrameType(@TypeOf(self)), frameValue(self), lhs_names, rhs_names, weight_names, output_names);
}
...
pub fn withRowCumulativeWeightedMae(self: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedMae(FrameType(@TypeOf(self)), frameValue(self), lhs_names, rhs_names, weight_names, output_names);
}
...
pub fn withRowCumulativeWeightedMse(self: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedMse(FrameType(@TypeOf(self)), frameValue(self), lhs_names, rhs_names, weight_names, output_names);
}
...
pub fn withRowCumulativeWeightedMape(self: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedMape(FrameType(@TypeOf(self)), frameValue(self), lhs_names, rhs_names, weight_names, output_names);
}
...
pub fn withRowCumulativeWeightedSmape(self: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedSmape(FrameType(@TypeOf(self)), frameValue(self), lhs_names, rhs_names, weight_names, output_names);
}
...
pub fn withRowCumulativeWeightedProduct(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedProduct(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_names);
}

pub fn withRowCumulativeWeightedGeometricMean(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedGeometricMean(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_names);
}

pub fn withRowCumulativeWeightedHarmonicMean(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedHarmonicMean(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_names);
}

pub fn withRowCumulativeWeightedLogSumExp(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedLogSumExp(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_names);
}

pub fn withRowCumulativeWeightedLogMeanExp(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowCumulativeWeightedLogMeanExp(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_names);
}
...
pub fn withRowWeightedMin(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowWeightedMin(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_name);
}

pub fn withRowWeightedMax(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowWeightedMax(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_name);
}

pub fn withRowWeightedMaxAbs(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowWeightedMaxAbs(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_name);
}

pub fn withRowWeightedMinAbs(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowWeightedMinAbs(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_name);
}

pub fn withRowWeightedRange(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowWeightedRange(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_name);
}

pub fn withRowWeightedMidrange(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowWeightedMidrange(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_name);
}

pub fn withRowWeightedRangeCoeff(self: anytype, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return dataframe_array_mod.withRowWeightedRangeCoeff(FrameType(@TypeOf(self)), frameValue(self), value_names, weight_names, output_name);
}
