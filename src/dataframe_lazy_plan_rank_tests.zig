...
test "device lazy frame collects plan operations" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, explained, "raw_ops=61") != null);
    try std.testing.expect(std.mem.indexOf(u8, explained, "optimized_ops=59") != null);
    ...
    try std.testing.expectEqual(@as(usize, 57), result.width());
