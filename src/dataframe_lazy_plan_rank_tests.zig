...
test "device lazy frame collects plan operations" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, explained, "raw_ops=70") != null);
    try std.testing.expect(std.mem.indexOf(u8, explained, "optimized_ops=68") != null);
