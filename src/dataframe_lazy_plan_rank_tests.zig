...
test "device lazy frame collects plan operations" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, explained, "raw_ops=84") != null);
    try std.testing.expect(std.mem.indexOf(u8, explained, "optimized_ops=82") != null);
    ...
    try std.testing.expectEqual(@as(usize, 80), result.width());
