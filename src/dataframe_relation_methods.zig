...
pub fn withGroupCumulativeMeanAbsDev(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeMeanAbsDevOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeMeanAbsDevOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeMeanAbsDevOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}

pub fn withGroupCumulativeMeanAbsDevRatio(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeMeanAbsDevRatioOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeMeanAbsDevRatioOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeMeanAbsDevRatioOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}

pub fn withGroupCumulativeGiniMeanDiff(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeGiniMeanDiffOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeGiniMeanDiffOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeGiniMeanDiffOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}

pub fn withGroupCumulativeGiniCoefficient(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeGiniCoefficientOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeGiniCoefficientOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeGiniCoefficientOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}
...
pub fn withGroupCumulativeIqr(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeIqrOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeIqrOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeIqrOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}
...
pub fn withGroupCumulativeMad(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeMadOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeMadOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeMadOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}
...
pub fn withGroupCumulativeWinsorizedMean(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8, winsor_fraction: f64) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWinsorizedMeanOn(self, key_names[0..], value_name, output_name, winsor_fraction);
}

pub fn withGroupCumulativeWinsorizedMeanOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8, winsor_fraction: f64) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWinsorizedMeanOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name, winsor_fraction);
}
...
pub fn withGroupCumulativeInterdecileRangeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeInterdecileRangeOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}
...
pub fn withGroupCumulativeMidhinge(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeMidhingeOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeMidhingeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeMidhingeOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}

pub const withGroupCumMidhinge = withGroupCumulativeMidhinge;
pub const withGroupCumMidhingeOn = withGroupCumulativeMidhingeOn;

pub fn withGroupCumulativeTrimean(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeTrimeanOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeTrimeanOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeTrimeanOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}

pub const withGroupCumTrimean = withGroupCumulativeTrimean;
pub const withGroupCumTrimeanOn = withGroupCumulativeTrimeanOn;

pub fn withGroupCumulativeBowleySkewness(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeBowleySkewnessOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeBowleySkewnessOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeBowleySkewnessOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}
...
pub fn withGroupCumulativeQuartileCoeffDispersion(self: anytype, key_name: []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeQuartileCoeffDispersionOn(self, key_names[0..], value_name, output_name);
}

pub fn withGroupCumulativeQuartileCoeffDispersionOn(self: anytype, key_names: []const []const u8, value_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeQuartileCoeffDispersionOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, output_name);
}
...
pub fn withGroupCumulativeWeightedMean(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMeanOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMeanOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMeanOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedSum(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedSumOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedSumOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedSumOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedMedianOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMedianOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedQuantile(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8, q: f64) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedQuantileOn(self, key_names[0..], value_name, weight_name, output_name, q);
}

pub fn withGroupCumulativeWeightedQuantileOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8, q: f64) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedQuantileOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name, q);
}

pub fn withGroupCumulativeWeightedIqr(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedIqrOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedIqrOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedIqrOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMad(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMadOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMadOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMadOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedModeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedModeOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeWeight(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedModeWeightOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeWeightOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedModeWeightOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeRatio(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedModeRatioOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeRatioOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedModeRatioOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeMargin(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedModeMarginOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeMarginOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedModeMarginOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeMarginRatio(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedModeMarginRatioOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedModeMarginRatioOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedModeMarginRatioOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedEntropy(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedEntropyOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedEntropyOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedEntropyOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedGiniImpurity(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedGiniImpurityOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedGiniImpurityOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedGiniImpurityOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedPerplexity(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedPerplexityOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedPerplexityOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedPerplexityOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedInverseSimpson(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedInverseSimpsonOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedInverseSimpsonOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedInverseSimpsonOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedSimpsonConcentration(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedSimpsonConcentrationOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedSimpsonConcentrationOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedSimpsonConcentrationOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedEvenness(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedEvennessOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedEvennessOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedEvennessOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMeanAbsDev(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMeanAbsDevOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMeanAbsDevOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMeanAbsDevOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMeanAbsDevRatio(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMeanAbsDevRatioOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMeanAbsDevRatioOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMeanAbsDevRatioOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedGiniMeanDiff(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedGiniMeanDiffOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedGiniMeanDiffOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedGiniMeanDiffOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedGiniCoefficient(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedGiniCoefficientOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedGiniCoefficientOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedGiniCoefficientOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedSem(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedSemOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedSemOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedSemOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedCv(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedCvOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedCvOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedCvOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedFano(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedFanoOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedFanoOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedFanoOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedSkewness(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedSkewnessOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedSkewnessOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedSkewnessOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedKurtosis(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedKurtosisOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedKurtosisOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedKurtosisOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedMeanSquare(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMeanSquareOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMeanSquareOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMeanSquareOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedRms(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedRmsOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedRmsOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedRmsOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedMin(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMinOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMinOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMinOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMax(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMaxOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMaxOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMaxOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedRange(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedRangeOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedRangeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedRangeOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMidrange(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMidrangeOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMidrangeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedMidrangeOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedRangeCoeff(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedRangeCoeffOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedRangeCoeffOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.withGroupCumulativeWeightedRangeCoeffOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn groupByWeightedSum(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedSumOn(self, key_names[0..], value_name, weight_name, output_name);
}
...
pub fn groupByWeightedMeanSquareOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedMeanSquareOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn groupByWeightedRms(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedRmsOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedRmsOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedRmsOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn groupByWeightedMin(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedMinOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedMinOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedMinOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn groupByWeightedMax(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedMaxOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedMaxOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedMaxOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn groupByWeightedRange(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedRangeOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedRangeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedRangeOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn groupByWeightedMidrange(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedMidrangeOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedMidrangeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedMidrangeOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn groupByWeightedRangeCoeff(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedRangeCoeffOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedRangeCoeffOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedRangeCoeffOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
...
pub fn groupByWeightedMeanAbsDev(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedMeanAbsDevOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedMeanAbsDevOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedMeanAbsDevOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn groupByWeightedMeanAbsDevRatio(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedMeanAbsDevRatioOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedMeanAbsDevRatioOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedMeanAbsDevRatioOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn groupByWeightedGiniMeanDiff(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedGiniMeanDiffOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedGiniMeanDiffOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedGiniMeanDiffOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}

pub fn groupByWeightedGiniCoefficient(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    const key_names = [_][]const u8{key_name};
    return groupByWeightedGiniCoefficientOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn groupByWeightedGiniCoefficientOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!FrameType(@TypeOf(self)) {
    return group_multi_mod.groupByWeightedGiniCoefficientOn(FrameType(@TypeOf(self)), frameValue(self), key_names, value_name, weight_name, output_name);
}
