...
pub fn planLazyScanPushdown(allocator: std.mem.Allocator, ops: anytype) std.mem.Allocator.Error!LazyScanPushdown {
    ...
    op_loop: for (ops) |op| {
        switch (op) {
            ...
            .row_centered, .row_zscore, .row_robust_zscore, .row_iqr_outlier, .row_tukey_winsorize, .row_minmax_scale, .row_l2_normalize, .row_l1_normalize, .row_sum_normalize, .row_mean_normalize, .row_max_abs_normalize, .row_softmax, .row_log_softmax, .row_softmin, .row_log_softmin => |row_outputs| {
