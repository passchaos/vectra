...
pub fn planLazyScanPushdown(allocator: std.mem.Allocator, ops: anytype) std.mem.Allocator.Error!LazyScanPushdown {
    ...
    op_loop: for (ops) |op| {
        switch (op) {
            ...
            .row_cumulative_weighted_sum, .row_cumulative_weighted_mean, .row_cumulative_weighted_weight_sum, .row_cumulative_weighted_positive_count, .row_cumulative_weighted_effective_n => |row_weighted_outputs| {
