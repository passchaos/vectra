...
pub fn planLazyScanPushdown(allocator: std.mem.Allocator, ops: anytype) std.mem.Allocator.Error!LazyScanPushdown {
    ...
    op_loop: for (ops) |op| {
        switch (op) {
            ...
            .filter_mask, .slice_rows, .drop_rows, .drop_row_range, .drop_last_rows, .slice_rows_step, .stride_rows, .take_rows, .take_rows_optional, .take_rows_mode, .take_rows_signed, .take_rows_signed_mode, .repeat_rows, .sample_rows, .sample_rows_with_replacement, .roll_rows, .reverse_rows, .head, .tail => {},
