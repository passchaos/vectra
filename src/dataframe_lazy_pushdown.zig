...
pub fn planLazyScanPushdown(allocator: std.mem.Allocator, ops: anytype) std.mem.Allocator.Error!LazyScanPushdown {
    ...
    op_loop: for (ops) |op| {
        switch (op) {
            ...
            .row_weighted_mean, .row_dot, .row_cosine_similarity, .row_squared_euclidean_distance, .row_euclidean_distance, .row_manhattan_distance, .row_mean_error, .row_mae, .row_mse, .row_rmse, .row_mape, .row_smape => |row_weighted| {
