...
const profile_payloads = @import("op_profile_payloads.zig");
...
pub fn DeviceLazyPayloads(comptime DeviceDataFrame: type, comptime DeviceColumn: type) type {
    return struct {
        ...
        pub const RowWeightedColumnOutputs = struct {
            value_names: [][]const u8,
            weight_names: [][]const u8,
            output_names: [][]const u8,
        };
        pub const RowWeightedColumnOutputsDispersion = struct {
            value_names: [][]const u8,
            weight_names: [][]const u8,
            output_names: [][]const u8,
            correction: f64,
        };
        pub const RowWeightedColumnOutputsQuantile = struct {
            value_names: [][]const u8,
            weight_names: [][]const u8,
            output_names: [][]const u8,
            q: f64,
        ...
        pub const RowWeightedPairColumnOutputsDispersion = struct {
            lhs_names: [][]const u8,
            rhs_names: [][]const u8,
            weight_names: [][]const u8,
            output_names: [][]const u8,
