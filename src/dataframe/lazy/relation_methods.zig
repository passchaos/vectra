...
const lazy_group_mod = @import("group_plan.zig");
const lazy_join_mod = @import("join_plan.zig");
...
pub fn withGroupCumulativeWeightedProduct(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedProductOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedProductOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedProduct(self, key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedWeightSum(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedWeightSumOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedWeightSumOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedWeightSum(self, key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedPositiveCount(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedPositiveCountOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedPositiveCountOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedPositiveCount(self, key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedEffectiveN(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedEffectiveNOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedEffectiveNOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedEffectiveN(self, key_names, value_name, weight_name, output_name);
}
...
pub fn withGroupCumulativeWeightedTrimmedMean(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8, trim_fraction: f64) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedTrimmedMeanOn(self, key_names[0..], value_name, weight_name, output_name, trim_fraction);
}

pub fn withGroupCumulativeWeightedTrimmedMeanOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8, trim_fraction: f64) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedTrimmedMean(self, key_names, value_name, weight_name, output_name, trim_fraction);
}

pub fn withGroupCumulativeWeightedWinsorizedMean(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8, winsor_fraction: f64) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedWinsorizedMeanOn(self, key_names[0..], value_name, weight_name, output_name, winsor_fraction);
}

pub fn withGroupCumulativeWeightedWinsorizedMeanOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8, winsor_fraction: f64) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedWinsorizedMean(self, key_names, value_name, weight_name, output_name, winsor_fraction);
}

pub fn withGroupCumulativeWeightedInterdecileRange(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedInterdecileRangeOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedInterdecileRangeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedInterdecileRange(self, key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMidhinge(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedMidhingeOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedMidhingeOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedMidhinge(self, key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedTrimean(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedTrimeanOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedTrimeanOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedTrimean(self, key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedBowleySkewness(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedBowleySkewnessOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedBowleySkewnessOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedBowleySkewness(self, key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedQuartileCoeffDispersion(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedQuartileCoeffDispersionOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedQuartileCoeffDispersionOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedQuartileCoeffDispersion(self, key_names, value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedKelleySkewness(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    const key_names = [_][]const u8{key_name};
    return withGroupCumulativeWeightedKelleySkewnessOn(self, key_names[0..], value_name, weight_name, output_name);
}

pub fn withGroupCumulativeWeightedKelleySkewnessOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return lazy_group_mod.withGroupCumulativeWeightedKelleySkewness(self, key_names, value_name, weight_name, output_name);
}
...
pub fn groupByWeightedProduct(self: anytype, key_name: []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return self.groupByWeighted(key_name, value_name, weight_name, output_name, .weighted_product);
}

pub fn groupByWeightedProductOn(self: anytype, key_names: []const []const u8, value_name: []const u8, weight_name: []const u8, output_name: []const u8) DeviceDataError!void {
    return self.groupByWeightedOn(key_names, value_name, weight_name, output_name, .weighted_product);
}
