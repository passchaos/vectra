...
const lazy_relation_methods_mod = @import("relation_methods.zig");
...
pub fn DeviceLazyTypes(
    ...
    return struct {
        ...
        pub const DeviceLazyFrame = struct {
            ...
            pub fn columnIsNumericMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .numeric);
            }
            ...
            pub fn columnIsRealMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .real);
            }
            ...
            pub fn columnIsFloatMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .float);
            }
            ...
            pub fn columnIsIntegerMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .integer);
            }
            ...
            pub fn columnIsSignedIntegerMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .signed_integer);
            }
            ...
            pub fn columnIsUnsignedIntegerMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .unsigned_integer);
            }
            ...
            pub fn columnIsBoolMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .bool);
            }
            ...
            pub fn columnIsComplexMaskProjection(self: *const DeviceLazyFrame, allocator: std.mem.Allocator, names: []const []const u8) ParquetInteropError![]bool {
                return self.columnDTypeClassMaskProjection(allocator, names, .complex);
            }
            ...
            pub fn withRowCumulativeWeightedDot(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedDot(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedEuclideanDistance(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedEuclideanDistance(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedManhattanDistance(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedManhattanDistance(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedChebyshevDistance(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedChebyshevDistance(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedCanberraDistance(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedCanberraDistance(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedMeanError(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedMeanError(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedMae(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedMae(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedMse(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedMse(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedRmse(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedRmse(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedSmape(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedSmape(self, lhs_names, rhs_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedCovariance(self: *DeviceLazyFrame, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8, correction: f64) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedCovariance(self, lhs_names, rhs_names, weight_names, output_names, correction);
            }
            ...
            pub fn withRowCumulativeWeightedMeanSquare(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedMeanSquare(self, value_names, weight_names, output_names);
            }

            pub fn withRowCumulativeWeightedRms(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedRms(self, value_names, weight_names, output_names);
            }

            pub fn withRowCumulativeWeightedMeanAbs(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedMeanAbs(self, value_names, weight_names, output_names);
            }

            pub fn withRowCumulativeWeightedL1Norm(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedL1Norm(self, value_names, weight_names, output_names);
            }

            pub fn withRowCumulativeWeightedL2Norm(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedL2Norm(self, value_names, weight_names, output_names);
            }
            ...
            pub fn withRowCumulativeWeightedPositiveCount(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedPositiveCount(self, value_names, weight_names, output_names);
            }

            pub fn withRowCumulativeWeightedEffectiveN(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedEffectiveN(self, value_names, weight_names, output_names);
            }
            ...
            pub fn withRowWeightedMin(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedMin(self, value_names, weight_names, output_name);
            }

            pub const withRowWeightedMinimum = withRowWeightedMin;

            pub fn withRowWeightedMax(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedMax(self, value_names, weight_names, output_name);
            }

            pub const withRowWeightedMaximum = withRowWeightedMax;

            pub fn withRowWeightedMaxAbs(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedMaxAbs(self, value_names, weight_names, output_name);
            }
            ...
            pub fn withRowWeightedMidrange(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedMidrange(self, value_names, weight_names, output_name);
            }

            pub fn withRowWeightedRangeCoeff(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedRangeCoeff(self, value_names, weight_names, output_name);
            }
            ...
            pub fn withRowWeightedHarmonicMean(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedHarmonicMean(self, value_names, weight_names, output_name);
            }

            pub const withRowWeightedHarmMean = withRowWeightedHarmonicMean;

            pub fn withRowWeightedLogSumExp(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedLogSumExp(self, value_names, weight_names, output_name);
            }

            pub const withRowWeightedLogsumexp = withRowWeightedLogSumExp;

            pub fn withRowWeightedLogMeanExp(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedLogMeanExp(self, value_names, weight_names, output_name);
            }
            ...
            pub fn withRowCumulativeWeightedMad(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedMad(self, value_names, weight_names, output_names);
            }

            pub fn withRowCumulativeWeightedTrimmedMean(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8, trim_fraction: f64) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedTrimmedMean(self, value_names, weight_names, output_names, trim_fraction);
            }

            pub fn withRowCumulativeWeightedWinsorizedMean(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8, winsor_fraction: f64) DeviceDataError!void {
                return lazy_expr_mod.withRowCumulativeWeightedWinsorizedMean(self, value_names, weight_names, output_names, winsor_fraction);
            }
            ...
            pub fn withRowWeightedInterdecileRange(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedInterdecileRange(self, value_names, weight_names, output_name);
            }

            pub const withRowWeightedIdr = withRowWeightedInterdecileRange;
            pub const withRowWeightedIDR = withRowWeightedInterdecileRange;

            pub fn withRowWeightedMidhinge(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedMidhinge(self, value_names, weight_names, output_name);
            }

            pub fn withRowWeightedTrimean(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedTrimean(self, value_names, weight_names, output_name);
            }

            pub fn withRowWeightedBowleySkewness(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedBowleySkewness(self, value_names, weight_names, output_name);
            }

            pub const withRowWeightedBowleySkew = withRowWeightedBowleySkewness;

            pub fn withRowWeightedQuartileCoeffDispersion(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedQuartileCoeffDispersion(self, value_names, weight_names, output_name);
            }

            pub const withRowWeightedQcd = withRowWeightedQuartileCoeffDispersion;
            pub const withRowWeightedQCD = withRowWeightedQuartileCoeffDispersion;

            pub fn withRowWeightedKelleySkewness(self: *DeviceLazyFrame, value_names: []const []const u8, weight_names: []const []const u8, output_name: []const u8) DeviceDataError!void {
                return lazy_expr_mod.withRowWeightedKelleySkewness(self, value_names, weight_names, output_name);
            }
