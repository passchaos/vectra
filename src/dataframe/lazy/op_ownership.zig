...
const clone_profile_mod = @import("op_clone_profile.zig");
const deinit_mod = @import("op_deinit.zig");
...
fn cloneRowWeightedPairColumnOutputsPayload(
    comptime Self: type,
    allocator: std.mem.Allocator,
    row_weighted: anytype,
    comptime tag_name: []const u8,
    comptime include_correction: bool,
) DeviceDataError!Self {
    const lhs_names = try cloneNameList(allocator, row_weighted.lhs_names);
    errdefer freeNameList(allocator, lhs_names);
    const rhs_names = try cloneNameList(allocator, row_weighted.rhs_names);
...
fn cloneRowWeightedPairColumnOutputs(
    ...
    return cloneRowWeightedPairColumnOutputsPayload(Self, allocator, row_weighted, tag_name, false);
}

fn cloneRowWeightedPairColumnOutputsDispersion(
    comptime Self: type,
    allocator: std.mem.Allocator,
    row_weighted: anytype,
    comptime tag_name: []const u8,
) DeviceDataError!Self {
    return cloneRowWeightedPairColumnOutputsPayload(Self, allocator, row_weighted, tag_name, true);
}
...
pub fn clone(comptime Self: type, self: Self, allocator: std.mem.Allocator) DeviceDataError!Self {
    return switch (self) {
        ...
        .row_cumulative_weighted_manhattan_distance => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_manhattan_distance"),
        .row_cumulative_weighted_chebyshev_distance => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_chebyshev_distance"),
        .row_cumulative_weighted_canberra_distance => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_canberra_distance"),
        .row_cumulative_weighted_bray_curtis_distance => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_bray_curtis_distance"),
        .row_cumulative_weighted_mean_error => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mean_error"),
        .row_cumulative_weighted_mae => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mae"),
        .row_cumulative_weighted_mse => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mse"),
        .row_cumulative_weighted_rmse => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_rmse"),
        .row_cumulative_weighted_mape => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mape"),
        .row_cumulative_weighted_smape => |row_weighted| try cloneRowWeightedPairColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_smape"),
        .row_cumulative_weighted_covariance => |row_weighted| try cloneRowWeightedPairColumnOutputsDispersion(Self, allocator, row_weighted, "row_cumulative_weighted_covariance"),
        ...
        .row_cumulative_weighted_mode_weight => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mode_weight"),
        .row_cumulative_weighted_mode_ratio => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mode_ratio"),
        .row_cumulative_weighted_mode_margin => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mode_margin"),
        .row_cumulative_weighted_mode_margin_ratio => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mode_margin_ratio"),
        .row_cumulative_weighted_entropy => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_entropy"),
        .row_cumulative_weighted_gini_impurity => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_gini_impurity"),
        .row_cumulative_weighted_perplexity => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_perplexity"),
        .row_cumulative_weighted_inverse_simpson => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_inverse_simpson"),
        .row_cumulative_weighted_simpson_concentration => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_simpson_concentration"),
        .row_cumulative_weighted_evenness => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_evenness"),
        .row_cumulative_weighted_mean_abs_dev => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mean_abs_dev"),
        .row_cumulative_weighted_mean_abs_dev_ratio => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_mean_abs_dev_ratio"),
        .row_cumulative_weighted_gini_mean_diff => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_gini_mean_diff"),
        .row_cumulative_weighted_gini_coefficient => |row_weighted| try cloneRowWeightedColumnOutputs(Self, allocator, row_weighted, "row_cumulative_weighted_gini_coefficient"),
