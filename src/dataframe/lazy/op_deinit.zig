...
const profile_deinit_mod = @import("op_deinit_profile.zig");
...
fn freeRowWeightedPairColumnOutputs(allocator: std.mem.Allocator, row_weighted: anytype) void {
