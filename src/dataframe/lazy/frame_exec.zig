...
pub fn collect(comptime DeviceDataFrame: type, comptime DeviceLazyOp: type, self: anytype) ParquetInteropError!DeviceDataFrame {
    ...
    for (optimized.items) |op| {
        const next = switch (op) {
            ...
            .row_weighted_pair_weight_sum => |row_weighted| try current.withRowWeightedPairWeightSum(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_pair_positive_count => |row_weighted| try current.withRowWeightedPairPositiveCount(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_pair_effective_n => |row_weighted| try current.withRowWeightedPairEffectiveN(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_cumulative_weighted_pair_weight_sum => |row_weighted| try current.withRowCumulativeWeightedPairWeightSum(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_pair_positive_count => |row_weighted| try current.withRowCumulativeWeightedPairPositiveCount(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_pair_effective_n => |row_weighted| try current.withRowCumulativeWeightedPairEffectiveN(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_dot => |row_weighted| try current.withRowCumulativeWeightedDot(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_cosine_similarity => |row_weighted| try current.withRowCumulativeWeightedCosineSimilarity(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_squared_euclidean_distance => |row_weighted| try current.withRowCumulativeWeightedSquaredEuclideanDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_euclidean_distance => |row_weighted| try current.withRowCumulativeWeightedEuclideanDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_manhattan_distance => |row_weighted| try current.withRowCumulativeWeightedManhattanDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_chebyshev_distance => |row_weighted| try current.withRowCumulativeWeightedChebyshevDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            ...
            .row_cumulative_weighted_mse => |row_weighted| try current.withRowCumulativeWeightedMse(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_rmse => |row_weighted| try current.withRowCumulativeWeightedRmse(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mape => |row_weighted| try current.withRowCumulativeWeightedMape(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_smape => |row_weighted| try current.withRowCumulativeWeightedSmape(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_covariance => |row_weighted| try current.withRowCumulativeWeightedCovariance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_names, row_weighted.correction),
            ...
            .row_cumulative_weighted_mean => |row_weighted| try current.withRowCumulativeWeightedMean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mean_square => |row_weighted| try current.withRowCumulativeWeightedMeanSquare(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_rms => |row_weighted| try current.withRowCumulativeWeightedRms(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mean_abs => |row_weighted| try current.withRowCumulativeWeightedMeanAbs(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_l1_norm => |row_weighted| try current.withRowCumulativeWeightedL1Norm(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_l2_norm => |row_weighted| try current.withRowCumulativeWeightedL2Norm(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_min => |row_weighted| try current.withRowCumulativeWeightedMin(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_max => |row_weighted| try current.withRowCumulativeWeightedMax(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_max_abs => |row_weighted| try current.withRowCumulativeWeightedMaxAbs(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_min_abs => |row_weighted| try current.withRowCumulativeWeightedMinAbs(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_range => |row_weighted| try current.withRowCumulativeWeightedRange(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_midrange => |row_weighted| try current.withRowCumulativeWeightedMidrange(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_range_coeff => |row_weighted| try current.withRowCumulativeWeightedRangeCoeff(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_product => |row_weighted| try current.withRowCumulativeWeightedProduct(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_geometric_mean => |row_weighted| try current.withRowCumulativeWeightedGeometricMean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_harmonic_mean => |row_weighted| try current.withRowCumulativeWeightedHarmonicMean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_logsumexp => |row_weighted| try current.withRowCumulativeWeightedLogSumExp(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_logmeanexp => |row_weighted| try current.withRowCumulativeWeightedLogMeanExp(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_variance => |row_weighted| try current.withRowCumulativeWeightedVariance(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names, row_weighted.correction),
            .row_cumulative_weighted_stddev => |row_weighted| try current.withRowCumulativeWeightedStddev(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names, row_weighted.correction),
            ...
            .row_weighted_weight_sum => |row_weighted| try current.withRowWeightedWeightSum(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_positive_count => |row_weighted| try current.withRowWeightedPositiveCount(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_effective_n => |row_weighted| try current.withRowWeightedEffectiveN(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_mean_square => |row_weighted| try current.withRowWeightedMeanSquare(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_rms => |row_weighted| try current.withRowWeightedRms(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_mean_abs => |row_weighted| try current.withRowWeightedMeanAbs(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_l1_norm => |row_weighted| try current.withRowWeightedL1Norm(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_l2_norm => |row_weighted| try current.withRowWeightedL2Norm(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_min => |row_weighted| try current.withRowWeightedMin(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_max => |row_weighted| try current.withRowWeightedMax(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_max_abs => |row_weighted| try current.withRowWeightedMaxAbs(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_min_abs => |row_weighted| try current.withRowWeightedMinAbs(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_range => |row_weighted| try current.withRowWeightedRange(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_midrange => |row_weighted| try current.withRowWeightedMidrange(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_range_coeff => |row_weighted| try current.withRowWeightedRangeCoeff(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_product => |row_weighted| try current.withRowWeightedProduct(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_geometric_mean => |row_weighted| try current.withRowWeightedGeometricMean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_harmonic_mean => |row_weighted| try current.withRowWeightedHarmonicMean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_logsumexp => |row_weighted| try current.withRowWeightedLogsumexp(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_logmeanexp => |row_weighted| try current.withRowWeightedLogMeanExp(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            ...
            .row_weighted_sem => |row_weighted| try current.withRowWeightedSem(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name, row_weighted.correction),
            .row_weighted_cv => |row_weighted| try current.withRowWeightedCv(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name, row_weighted.correction),
            .row_weighted_fano => |row_weighted| try current.withRowWeightedFano(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name, row_weighted.correction),
            .row_weighted_skewness => |row_weighted| try current.withRowWeightedSkewness(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_kurtosis => |row_weighted| try current.withRowWeightedKurtosis(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            ...
            .row_cumulative_weighted_trimmed_mean => |row_weighted| try current.withRowCumulativeWeightedTrimmedMean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names, row_weighted.q),
            .row_cumulative_weighted_winsorized_mean => |row_weighted| try current.withRowCumulativeWeightedWinsorizedMean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names, row_weighted.q),
            .row_cumulative_weighted_interdecile_range => |row_weighted| try current.withRowCumulativeWeightedInterdecileRange(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_midhinge => |row_weighted| try current.withRowCumulativeWeightedMidhinge(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_trimean => |row_weighted| try current.withRowCumulativeWeightedTrimean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_bowley_skewness => |row_weighted| try current.withRowCumulativeWeightedBowleySkewness(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_quartile_coeff_dispersion => |row_weighted| try current.withRowCumulativeWeightedQuartileCoeffDispersion(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_kelley_skewness => |row_weighted| try current.withRowCumulativeWeightedKelleySkewness(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mode => |row_weighted| try current.withRowCumulativeWeightedMode(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mode_weight => |row_weighted| try current.withRowCumulativeWeightedModeWeight(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mode_ratio => |row_weighted| try current.withRowCumulativeWeightedModeRatio(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mode_margin => |row_weighted| try current.withRowCumulativeWeightedModeMargin(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mode_margin_ratio => |row_weighted| try current.withRowCumulativeWeightedModeMarginRatio(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_entropy => |row_weighted| try current.withRowCumulativeWeightedEntropy(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_gini_impurity => |row_weighted| try current.withRowCumulativeWeightedGiniImpurity(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_perplexity => |row_weighted| try current.withRowCumulativeWeightedPerplexity(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_inverse_simpson => |row_weighted| try current.withRowCumulativeWeightedInverseSimpson(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_simpson_concentration => |row_weighted| try current.withRowCumulativeWeightedSimpsonConcentration(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_evenness => |row_weighted| try current.withRowCumulativeWeightedEvenness(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mean_abs_dev => |row_weighted| try current.withRowCumulativeWeightedMeanAbsDev(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_mean_abs_dev_ratio => |row_weighted| try current.withRowCumulativeWeightedMeanAbsDevRatio(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_gini_mean_diff => |row_weighted| try current.withRowCumulativeWeightedGiniMeanDiff(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            .row_cumulative_weighted_gini_coefficient => |row_weighted| try current.withRowCumulativeWeightedGiniCoefficient(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_names),
            ...
            .row_weighted_euclidean_distance => |row_weighted| try current.withRowWeightedEuclideanDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_manhattan_distance => |row_weighted| try current.withRowWeightedManhattanDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_chebyshev_distance => |row_weighted| try current.withRowWeightedChebyshevDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_canberra_distance => |row_weighted| try current.withRowWeightedCanberraDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_bray_curtis_distance => |row_weighted| try current.withRowWeightedBrayCurtisDistance(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_mean_error => |row_weighted| try current.withRowWeightedMeanError(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_mae => |row_weighted| try current.withRowWeightedMae(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_mse => |row_weighted| try current.withRowWeightedMse(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_rmse => |row_weighted| try current.withRowWeightedRmse(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_mape => |row_weighted| try current.withRowWeightedMape(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_smape => |row_weighted| try current.withRowWeightedSmape(row_weighted.lhs_names, row_weighted.rhs_names, row_weighted.weight_names, row_weighted.output_name),
            ...
            .row_weighted_interdecile_range => |row_weighted| try current.withRowWeightedInterdecileRange(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_midhinge => |row_weighted| try current.withRowWeightedMidhinge(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_trimean => |row_weighted| try current.withRowWeightedTrimean(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_bowley_skewness => |row_weighted| try current.withRowWeightedBowleySkewness(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_quartile_coeff_dispersion => |row_weighted| try current.withRowWeightedQuartileCoeffDispersion(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_kelley_skewness => |row_weighted| try current.withRowWeightedKelleySkewness(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            ...
            .row_weighted_mean_abs_dev => |row_weighted| try current.withRowWeightedMeanAbsDev(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_mean_abs_dev_ratio => |row_weighted| try current.withRowWeightedMeanAbsDevRatio(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_gini_mean_diff => |row_weighted| try current.withRowWeightedGiniMeanDiff(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            .row_weighted_gini_coefficient => |row_weighted| try current.withRowWeightedGiniCoefficient(row_weighted.value_names, row_weighted.weight_names, row_weighted.output_name),
            ...
            .group_is_first_row => |row_count| try current.withGroupIsFirstRowOn(row_count.names, row_count.output_name),
            .group_is_last_row => |row_count| try current.withGroupIsLastRowOn(row_count.names, row_count.output_name),
            ...
            .group_nth_valid_value => |shift| try current.withGroupNthValidValueOn(shift.names, shift.value_name, shift.output_name, shift.offset),
            .group_fill_null_forward => |shift| try current.withGroupFillNullForwardOn(shift.names, shift.value_name, shift.output_name),
            .group_fill_null_backward => |shift| try current.withGroupFillNullBackwardOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_valid_count => |shift| try current.withGroupCumulativeValidCountOn(shift.names, shift.value_name, shift.output_name),
            ...
            .group_cumulative_first_valid_index => |shift| try current.withGroupCumulativeFirstValidIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_valid_index => |shift| try current.withGroupCumulativeLastValidIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_null_index => |shift| try current.withGroupCumulativeFirstNullIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_null_index => |shift| try current.withGroupCumulativeLastNullIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_nan_count => |shift| try current.withGroupCumulativeNaNCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_nan_ratio => |shift| try current.withGroupCumulativeNaNRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_inf_count => |shift| try current.withGroupCumulativeInfCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_inf_ratio => |shift| try current.withGroupCumulativeInfRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_positive_inf_count => |shift| try current.withGroupCumulativePositiveInfCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_positive_inf_ratio => |shift| try current.withGroupCumulativePositiveInfRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_negative_inf_count => |shift| try current.withGroupCumulativeNegativeInfCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_negative_inf_ratio => |shift| try current.withGroupCumulativeNegativeInfRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_finite_count => |shift| try current.withGroupCumulativeFiniteCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_finite_ratio => |shift| try current.withGroupCumulativeFiniteRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_normal_count => |shift| try current.withGroupCumulativeNormalCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_normal_ratio => |shift| try current.withGroupCumulativeNormalRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_subnormal_count => |shift| try current.withGroupCumulativeSubnormalCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_subnormal_ratio => |shift| try current.withGroupCumulativeSubnormalRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_non_finite_count => |shift| try current.withGroupCumulativeNonFiniteCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_non_finite_ratio => |shift| try current.withGroupCumulativeNonFiniteRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_zero_count => |shift| try current.withGroupCumulativeZeroCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_zero_ratio => |shift| try current.withGroupCumulativeZeroRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_positive_zero_count => |shift| try current.withGroupCumulativePositiveZeroCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_positive_zero_ratio => |shift| try current.withGroupCumulativePositiveZeroRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_negative_zero_count => |shift| try current.withGroupCumulativeNegativeZeroCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_negative_zero_ratio => |shift| try current.withGroupCumulativeNegativeZeroRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_non_zero_count => |shift| try current.withGroupCumulativeNonZeroCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_non_zero_ratio => |shift| try current.withGroupCumulativeNonZeroRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_positive_count => |shift| try current.withGroupCumulativePositiveCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_positive_ratio => |shift| try current.withGroupCumulativePositiveRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_signbit_count => |shift| try current.withGroupCumulativeSignBitCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_signbit_ratio => |shift| try current.withGroupCumulativeSignBitRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_negative_count => |shift| try current.withGroupCumulativeNegativeCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_negative_ratio => |shift| try current.withGroupCumulativeNegativeRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_nan_index => |shift| try current.withGroupCumulativeFirstNaNIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_nan_index => |shift| try current.withGroupCumulativeLastNaNIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_inf_index => |shift| try current.withGroupCumulativeFirstInfIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_inf_index => |shift| try current.withGroupCumulativeLastInfIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_positive_inf_index => |shift| try current.withGroupCumulativeFirstPositiveInfIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_positive_inf_index => |shift| try current.withGroupCumulativeLastPositiveInfIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_negative_inf_index => |shift| try current.withGroupCumulativeFirstNegativeInfIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_negative_inf_index => |shift| try current.withGroupCumulativeLastNegativeInfIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_finite_index => |shift| try current.withGroupCumulativeFirstFiniteIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_finite_index => |shift| try current.withGroupCumulativeLastFiniteIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_normal_index => |shift| try current.withGroupCumulativeFirstNormalIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_normal_index => |shift| try current.withGroupCumulativeLastNormalIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_subnormal_index => |shift| try current.withGroupCumulativeFirstSubnormalIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_subnormal_index => |shift| try current.withGroupCumulativeLastSubnormalIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_non_finite_index => |shift| try current.withGroupCumulativeFirstNonFiniteIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_non_finite_index => |shift| try current.withGroupCumulativeLastNonFiniteIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_zero_index => |shift| try current.withGroupCumulativeFirstZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_zero_index => |shift| try current.withGroupCumulativeLastZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_positive_zero_index => |shift| try current.withGroupCumulativeFirstPositiveZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_positive_zero_index => |shift| try current.withGroupCumulativeLastPositiveZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_negative_zero_index => |shift| try current.withGroupCumulativeFirstNegativeZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_negative_zero_index => |shift| try current.withGroupCumulativeLastNegativeZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_non_zero_index => |shift| try current.withGroupCumulativeFirstNonZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_non_zero_index => |shift| try current.withGroupCumulativeLastNonZeroIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_positive_index => |shift| try current.withGroupCumulativeFirstPositiveIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_positive_index => |shift| try current.withGroupCumulativeLastPositiveIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_signbit_index => |shift| try current.withGroupCumulativeFirstSignBitIndexOn(shift.names, shift.value_name, shift.output_name),
            ...
            .group_cumulative_mode => |shift| try current.withGroupCumulativeModeOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mode_count => |shift| try current.withGroupCumulativeModeCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mode_ratio => |shift| try current.withGroupCumulativeModeRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mode_margin => |shift| try current.withGroupCumulativeModeMarginOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mode_margin_ratio => |shift| try current.withGroupCumulativeModeMarginRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_entropy => |shift| try current.withGroupCumulativeEntropyOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_gini_impurity => |shift| try current.withGroupCumulativeGiniImpurityOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_perplexity => |shift| try current.withGroupCumulativePerplexityOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_inverse_simpson => |shift| try current.withGroupCumulativeInverseSimpsonOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_simpson_concentration => |shift| try current.withGroupCumulativeSimpsonConcentrationOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_evenness => |shift| try current.withGroupCumulativeEvennessOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mean_abs_dev => |shift| try current.withGroupCumulativeMeanAbsDevOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mean_abs_dev_ratio => |shift| try current.withGroupCumulativeMeanAbsDevRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_gini_mean_diff => |shift| try current.withGroupCumulativeGiniMeanDiffOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_gini_coefficient => |shift| try current.withGroupCumulativeGiniCoefficientOn(shift.names, shift.value_name, shift.output_name),
            ...
            .group_cumulative_kelley_skewness => |shift| try current.withGroupCumulativeKelleySkewnessOn(shift.names, shift.value_name, shift.output_name),
            ...
            .group_cumulative_false_count => |shift| try current.withGroupCumulativeFalseCountOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_true_ratio => |shift| try current.withGroupCumulativeTrueRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_false_ratio => |shift| try current.withGroupCumulativeFalseRatioOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_true_index => |shift| try current.withGroupCumulativeFirstTrueIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_last_true_index => |shift| try current.withGroupCumulativeLastTrueIndexOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_first_false_index => |shift| try current.withGroupCumulativeFirstFalseIndexOn(shift.names, shift.value_name, shift.output_name),
            ...
            .group_cumulative_weighted_weight_sum => |shift| try current.withGroupCumulativeWeightedWeightSumOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_positive_count => |shift| try current.withGroupCumulativeWeightedPositiveCountOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_effective_n => |shift| try current.withGroupCumulativeWeightedEffectiveNOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            ...
            .group_cumulative_weighted_interdecile_range => |shift| try current.withGroupCumulativeWeightedInterdecileRangeOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_midhinge => |shift| try current.withGroupCumulativeWeightedMidhingeOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_trimean => |shift| try current.withGroupCumulativeWeightedTrimeanOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_bowley_skewness => |shift| try current.withGroupCumulativeWeightedBowleySkewnessOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_quartile_coeff_dispersion => |shift| try current.withGroupCumulativeWeightedQuartileCoeffDispersionOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_kelley_skewness => |shift| try current.withGroupCumulativeWeightedKelleySkewnessOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            ...
            .group_cumulative_weighted_mode_margin => |shift| try current.withGroupCumulativeWeightedModeMarginOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mode_margin_ratio => |shift| try current.withGroupCumulativeWeightedModeMarginRatioOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_entropy => |shift| try current.withGroupCumulativeWeightedEntropyOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_gini_impurity => |shift| try current.withGroupCumulativeWeightedGiniImpurityOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_perplexity => |shift| try current.withGroupCumulativeWeightedPerplexityOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_inverse_simpson => |shift| try current.withGroupCumulativeWeightedInverseSimpsonOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_simpson_concentration => |shift| try current.withGroupCumulativeWeightedSimpsonConcentrationOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_evenness => |shift| try current.withGroupCumulativeWeightedEvennessOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mean_abs_dev => |shift| try current.withGroupCumulativeWeightedMeanAbsDevOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mean_abs_dev_ratio => |shift| try current.withGroupCumulativeWeightedMeanAbsDevRatioOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_gini_mean_diff => |shift| try current.withGroupCumulativeWeightedGiniMeanDiffOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_gini_coefficient => |shift| try current.withGroupCumulativeWeightedGiniCoefficientOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_dot => |shift| try current.withGroupCumulativeWeightedDotOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_cosine_similarity => |shift| try current.withGroupCumulativeWeightedCosineSimilarityOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_squared_euclidean_distance => |shift| try current.withGroupCumulativeWeightedSquaredEuclideanDistanceOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_euclidean_distance => |shift| try current.withGroupCumulativeWeightedEuclideanDistanceOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_manhattan_distance => |shift| try current.withGroupCumulativeWeightedManhattanDistanceOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_chebyshev_distance => |shift| try current.withGroupCumulativeWeightedChebyshevDistanceOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_canberra_distance => |shift| try current.withGroupCumulativeWeightedCanberraDistanceOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_bray_curtis_distance => |shift| try current.withGroupCumulativeWeightedBrayCurtisDistanceOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mean_error => |shift| try current.withGroupCumulativeWeightedMeanErrorOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mae => |shift| try current.withGroupCumulativeWeightedMaeOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mse => |shift| try current.withGroupCumulativeWeightedMseOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_rmse => |shift| try current.withGroupCumulativeWeightedRmseOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mape => |shift| try current.withGroupCumulativeWeightedMapeOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_smape => |shift| try current.withGroupCumulativeWeightedSmapeOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_covariance => |shift| try current.withGroupCumulativeWeightedCovarianceOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name, shift.correction),
            .group_cumulative_weighted_correlation => |shift| try current.withGroupCumulativeWeightedCorrelationOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name, shift.correction),
            .group_cumulative_weighted_beta => |shift| try current.withGroupCumulativeWeightedBetaOn(shift.names, shift.lhs_name, shift.rhs_name, shift.weight_name, shift.output_name, shift.correction),
            .group_cumulative_weighted_min => |shift| try current.withGroupCumulativeWeightedMinOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_max => |shift| try current.withGroupCumulativeWeightedMaxOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_mean_abs => |shift| try current.withGroupCumulativeWeightedMeanAbsOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_l1_norm => |shift| try current.withGroupCumulativeWeightedL1NormOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_l2_norm => |shift| try current.withGroupCumulativeWeightedL2NormOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_max_abs => |shift| try current.withGroupCumulativeWeightedMaxAbsOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_min_abs => |shift| try current.withGroupCumulativeWeightedMinAbsOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_geometric_mean => |shift| try current.withGroupCumulativeWeightedGeometricMeanOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_harmonic_mean => |shift| try current.withGroupCumulativeWeightedHarmonicMeanOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_logsumexp => |shift| try current.withGroupCumulativeWeightedLogSumExpOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_logmeanexp => |shift| try current.withGroupCumulativeWeightedLogMeanExpOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_range => |shift| try current.withGroupCumulativeWeightedRangeOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_midrange => |shift| try current.withGroupCumulativeWeightedMidrangeOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            .group_cumulative_weighted_range_coeff => |shift| try current.withGroupCumulativeWeightedRangeCoeffOn(shift.names, shift.value_name, shift.weight_name, shift.output_name),
            ...
            .group_cumulative_sem => |shift| try current.withGroupCumulativeSemOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_cv => |shift| try current.withGroupCumulativeCvOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_fano => |shift| try current.withGroupCumulativeFanoOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_skewness => |shift| try current.withGroupCumulativeSkewnessOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_kurtosis => |shift| try current.withGroupCumulativeKurtosisOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mean_abs => |shift| try current.withGroupCumulativeMeanAbsOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_mean_square => |shift| try current.withGroupCumulativeMeanSquareOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_rms => |shift| try current.withGroupCumulativeRmsOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_max_abs => |shift| try current.withGroupCumulativeMaxAbsOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_min_abs => |shift| try current.withGroupCumulativeMinAbsOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_l1_norm => |shift| try current.withGroupCumulativeL1NormOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_l2_norm => |shift| try current.withGroupCumulativeL2NormOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_range => |shift| try current.withGroupCumulativeRangeOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_midrange => |shift| try current.withGroupCumulativeMidrangeOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_range_coeff => |shift| try current.withGroupCumulativeRangeCoeffOn(shift.names, shift.value_name, shift.output_name),
            .group_cumulative_logsumexp => |shift| try current.withGroupCumulativeLogSumExpOn(shift.names, shift.value_name, shift.output_name),
            ...
            .group_by_rows_on => |group| if (group.keep_tail)
                ...
                try current.groupBySliceRowsStepOn(group.key_names, group.start, group.n, group.step),
            .group_by_sorted_rows => |group| if (group.keep_bottom)
                try current.groupByBottomRows(group.key_name, group.sort_name, group.n, group.options)
            else
                try current.groupByTopRows(group.key_name, group.sort_name, group.n, group.options),
            .group_by_sorted_rows_on => |group| if (group.keep_bottom)
                try current.groupByBottomRowsOn(group.key_names, group.sort_name, group.n, group.options)
            else
                try current.groupByTopRowsOn(group.key_names, group.sort_name, group.n, group.options),
            .group_by_sorted_rows_columns => |group| if (group.keep_bottom)
                try current.groupByBottomRowsByColumns(group.key_name, group.sort_names, group.n, group.options)
            else
                try current.groupByTopRowsByColumns(group.key_name, group.sort_names, group.n, group.options),
            .group_by_sorted_rows_columns_on => |group| if (group.keep_bottom)
                try current.groupByBottomRowsByColumnsOn(group.key_names, group.sort_names, group.n, group.options)
            else
                try current.groupByTopRowsByColumnsOn(group.key_names, group.sort_names, group.n, group.options),
            ...
            .group_by_weighted => |group| switch (group.aggregation) {
                ...
                .weighted_min => try current.groupByWeightedMin(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_max => try current.groupByWeightedMax(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_mean_abs => try current.groupByWeightedMeanAbs(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_l1_norm => try current.groupByWeightedL1Norm(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_l2_norm => try current.groupByWeightedL2Norm(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_max_abs => try current.groupByWeightedMaxAbs(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_min_abs => try current.groupByWeightedMinAbs(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_geometric_mean => try current.groupByWeightedGeometricMean(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_harmonic_mean => try current.groupByWeightedHarmonicMean(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_logsumexp => try current.groupByWeightedLogSumExp(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_logmeanexp => try current.groupByWeightedLogMeanExp(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_range => try current.groupByWeightedRange(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_midrange => try current.groupByWeightedMidrange(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_range_coeff => try current.groupByWeightedRangeCoeff(group.key_name, group.value_name, group.weight_name, group.output_name),
                ...
                .weighted_sem => try current.groupByWeightedSem(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_cv => try current.groupByWeightedCv(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_fano => try current.groupByWeightedFano(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_skewness => try current.groupByWeightedSkewness(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_kurtosis => try current.groupByWeightedKurtosis(group.key_name, group.value_name, group.weight_name, group.output_name),
                ...
                .weighted_trimmed_mean => try current.groupByWeightedTrimmedMean(group.key_name, group.value_name, group.weight_name, group.output_name, group.quantile),
                .weighted_winsorized_mean => try current.groupByWeightedWinsorizedMean(group.key_name, group.value_name, group.weight_name, group.output_name, group.quantile),
                .weighted_interdecile_range => try current.groupByWeightedInterdecileRange(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_midhinge => try current.groupByWeightedMidhinge(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_trimean => try current.groupByWeightedTrimean(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_bowley_skewness => try current.groupByWeightedBowleySkewness(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_quartile_coeff_dispersion => try current.groupByWeightedQuartileCoeffDispersion(group.key_name, group.value_name, group.weight_name, group.output_name),
                .weighted_kelley_skewness => try current.groupByWeightedKelleySkewness(group.key_name, group.value_name, group.weight_name, group.output_name),
            ...
            .group_by_weighted_on => |group| switch (group.aggregation) {
                ...
                .weighted_min => try current.groupByWeightedMinOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_max => try current.groupByWeightedMaxOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_mean_abs => try current.groupByWeightedMeanAbsOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_l1_norm => try current.groupByWeightedL1NormOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_l2_norm => try current.groupByWeightedL2NormOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_max_abs => try current.groupByWeightedMaxAbsOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_min_abs => try current.groupByWeightedMinAbsOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_geometric_mean => try current.groupByWeightedGeometricMeanOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_harmonic_mean => try current.groupByWeightedHarmonicMeanOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_logsumexp => try current.groupByWeightedLogSumExpOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_logmeanexp => try current.groupByWeightedLogMeanExpOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_range => try current.groupByWeightedRangeOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_midrange => try current.groupByWeightedMidrangeOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_range_coeff => try current.groupByWeightedRangeCoeffOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                ...
                .weighted_sem => try current.groupByWeightedSemOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_cv => try current.groupByWeightedCvOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_fano => try current.groupByWeightedFanoOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_skewness => try current.groupByWeightedSkewnessOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_kurtosis => try current.groupByWeightedKurtosisOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                ...
                .weighted_trimmed_mean => try current.groupByWeightedTrimmedMeanOn(group.key_names, group.value_name, group.weight_name, group.output_name, group.quantile),
                .weighted_winsorized_mean => try current.groupByWeightedWinsorizedMeanOn(group.key_names, group.value_name, group.weight_name, group.output_name, group.quantile),
                .weighted_interdecile_range => try current.groupByWeightedInterdecileRangeOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_midhinge => try current.groupByWeightedMidhingeOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_trimean => try current.groupByWeightedTrimeanOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_bowley_skewness => try current.groupByWeightedBowleySkewnessOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_quartile_coeff_dispersion => try current.groupByWeightedQuartileCoeffDispersionOn(group.key_names, group.value_name, group.weight_name, group.output_name),
                .weighted_kelley_skewness => try current.groupByWeightedKelleySkewnessOn(group.key_names, group.value_name, group.weight_name, group.output_name),
