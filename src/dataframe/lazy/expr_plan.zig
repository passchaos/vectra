...
const RowCumulativeWeightedPairMetric = enum { dot, cosine, squared_euclidean, euclidean, manhattan, chebyshev, canberra, bray_curtis, mean_error, mae, mse, rmse, mape, smape, covariance };

fn withRowCumulativeWeightedPairMetric(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8, correction: f64, comptime metric: RowCumulativeWeightedPairMetric) DeviceDataError!void {
    const owned_lhs = try cloneNameList(frame.allocator, lhs_names);
    errdefer freeNameList(frame.allocator, owned_lhs);
    const owned_rhs = try cloneNameList(frame.allocator, rhs_names);
    errdefer freeNameList(frame.allocator, owned_rhs);
    ...
    try frame.ops.append(frame.allocator, switch (metric) {
        ...
        .mae => .{ .row_cumulative_weighted_mae = .{ .lhs_names = owned_lhs, .rhs_names = owned_rhs, .weight_names = owned_weights, .output_names = owned_outputs } },
        ...
        .covariance => .{ .row_cumulative_weighted_covariance = .{ .lhs_names = owned_lhs, .rhs_names = owned_rhs, .weight_names = owned_weights, .output_names = owned_outputs, .correction = correction } },
    });
}
...
pub fn withRowCumulativeWeightedDot(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .dot);
}
...
pub fn withRowCumulativeWeightedCosineSimilarity(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .cosine);
}
...
pub fn withRowCumulativeWeightedSquaredEuclideanDistance(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .squared_euclidean);
}
...
pub fn withRowCumulativeWeightedEuclideanDistance(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .euclidean);
}
...
pub fn withRowCumulativeWeightedManhattanDistance(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .manhattan);
}
...
pub fn withRowCumulativeWeightedChebyshevDistance(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .chebyshev);
}
...
pub fn withRowCumulativeWeightedCanberraDistance(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .canberra);
}
...
pub fn withRowCumulativeWeightedBrayCurtisDistance(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .bray_curtis);
}
...
pub fn withRowCumulativeWeightedMeanError(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .mean_error);
}
...
pub fn withRowCumulativeWeightedMae(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .mae);
}
...
pub fn withRowCumulativeWeightedMse(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .mse);
}
...
pub fn withRowCumulativeWeightedRmse(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .rmse);
}
...
pub fn withRowCumulativeWeightedMape(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .mape);
}
...
pub fn withRowCumulativeWeightedSmape(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, 0.0, .smape);
}
...
pub fn withRowCumulativeWeightedCovariance(frame: anytype, lhs_names: []const []const u8, rhs_names: []const []const u8, weight_names: []const []const u8, output_names: []const []const u8, correction: f64) DeviceDataError!void {
    return withRowCumulativeWeightedPairMetric(frame, lhs_names, rhs_names, weight_names, output_names, correction, .covariance);
}
