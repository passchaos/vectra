...
pub fn DeviceParquetScan(
    ...
    return struct {
        ...
        pub const parquetRowGroupRowCounts = scan_metadata_mod.parquetRowGroupRowCounts;
        pub const parquetRowGroupColumnChunkCounts = scan_metadata_mod.parquetRowGroupColumnChunkCounts;
        pub const parquetRowGroupTotalNbytes = scan_metadata_mod.parquetRowGroupTotalNbytes;
        pub const parquetRowGroupTotalCompressedNbytes = scan_metadata_mod.parquetRowGroupTotalCompressedNbytes;
        ...
        pub const parquetFieldCompressionRatios = scan_metadata_mod.parquetFieldCompressionRatios;
        pub const parquetFieldCompressionRatiosProjection = scan_metadata_mod.parquetFieldCompressionRatiosProjection;
        pub const parquetCompressionRatioProjection = scan_metadata_mod.parquetCompressionRatioProjection;
        ...
        pub const arrowFieldDataNbytes = scan_metadata_mod.arrowFieldDataNbytes;
        pub const arrowFieldDataNbytesProjection = scan_metadata_mod.arrowFieldDataNbytesProjection;
        pub const arrowFieldValidityNbytes = scan_metadata_mod.arrowFieldValidityNbytes;
        pub const arrowFieldValidityNbytesProjection = scan_metadata_mod.arrowFieldValidityNbytesProjection;
        pub const arrowFieldTotalNbytes = scan_metadata_mod.arrowFieldTotalNbytes;
        pub const arrowFieldTotalNbytesProjection = scan_metadata_mod.arrowFieldTotalNbytesProjection;
        pub const arrowDataNbytes = scan_metadata_mod.arrowDataNbytes;
        pub const arrowDataNbytesProjection = scan_metadata_mod.arrowDataNbytesProjection;
        pub const arrowValidityNbytes = scan_metadata_mod.arrowValidityNbytes;
        pub const arrowValidityNbytesProjection = scan_metadata_mod.arrowValidityNbytesProjection;
        pub const arrowTotalNbytes = scan_metadata_mod.arrowTotalNbytes;
        pub const arrowTotalNbytesProjection = scan_metadata_mod.arrowTotalNbytesProjection;
        ...
        pub const arrowSchemaEqualsFrame = scan_metadata_mod.arrowSchemaEqualsFrame;
        pub const arrowSameSchemaFrame = scan_metadata_mod.arrowSameSchemaFrame;
        pub const arrowSchemaCompatibleFrame = scan_metadata_mod.arrowSchemaCompatibleFrame;
