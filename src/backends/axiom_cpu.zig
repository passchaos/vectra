...
pub fn trySquareF32(input: array_mod.Array(f32)) array_mod.ArrayError!?array_mod.Array(f32) {
...
pub fn tryAsinF32(input: array_mod.Array(f32)) array_mod.ArrayError!?array_mod.Array(f32) {
    return tryUnaryElementwise(f32, .asin, input);
}

pub fn tryAcosF32(input: array_mod.Array(f32)) array_mod.ArrayError!?array_mod.Array(f32) {
    return tryUnaryElementwise(f32, .acos, input);
}

pub fn tryAtanF32(input: array_mod.Array(f32)) array_mod.ArrayError!?array_mod.Array(f32) {
    return tryUnaryElementwise(f32, .atan, input);
}
...
pub fn tryExp2F64(input: array_mod.Array(f64)) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryUnaryElementwise(f64, .exp2, input);
}

pub fn tryExpm1F64(input: array_mod.Array(f64)) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryUnaryElementwise(f64, .expm1, input);
}

pub fn tryLog1pF64(input: array_mod.Array(f64)) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryUnaryElementwise(f64, .log1p, input);
}

pub fn tryLog2F64(input: array_mod.Array(f64)) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryUnaryElementwise(f64, .log2, input);
}
...
pub fn tryAsinF64(input: array_mod.Array(f64)) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryUnaryElementwise(f64, .asin, input);
}

pub fn tryAcosF64(input: array_mod.Array(f64)) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryUnaryElementwise(f64, .acos, input);
}

pub fn tryAtanF64(input: array_mod.Array(f64)) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryUnaryElementwise(f64, .atan, input);
}
...
pub fn tryMatmulAddScaledF32(lhs: array_mod.Array(f32), rhs: array_mod.Array(f32), addend: array_mod.Array(f32), alpha: f32, beta: f32) array_mod.ArrayError!?array_mod.Array(f32) {
    return tryMatmulAddScaledTyped(f32, lhs, rhs, addend, alpha, beta);
}

pub fn tryMatmulAddScaledF64(lhs: array_mod.Array(f64), rhs: array_mod.Array(f64), addend: array_mod.Array(f64), alpha: f32, beta: f32) array_mod.ArrayError!?array_mod.Array(f64) {
    return tryMatmulAddScaledTyped(f64, lhs, rhs, addend, alpha, beta);
}
...
fn tryMatmulAddTyped(comptime T: type, lhs: array_mod.Array(T), rhs: array_mod.Array(T), addend: array_mod.Array(T)) array_mod.ArrayError!?array_mod.Array(T) {
    return tryMatmulAddScaledTyped(T, lhs, rhs, addend, 1.0, 1.0);
}

fn tryMatmulAddScaledTyped(comptime T: type, lhs: array_mod.Array(T), rhs: array_mod.Array(T), addend: array_mod.Array(T), alpha: f32, beta: f32) array_mod.ArrayError!?array_mod.Array(T) {
    if (!build_options.enable_axiom_cpu_dispatch) return null;
    if (!supportedMatmul2dContiguous(T, lhs, rhs)) return null;
