...
pub const Histogram2DExtremaOp = impl.Histogram2DExtremaOp;
pub const Histogram2DExtremaSession = impl.Histogram2DExtremaSession;
pub const Histogram2DSumSession = impl.Histogram2DSumSession;
pub const CategoricalHistogram2DCountSession = impl.CategoricalHistogram2DCountSession;
