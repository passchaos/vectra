...
pub fn main(init: std.process.Init) !void {
    ...
    const ok = add_ok and sub_ok and mul_ok and div_ok and add_scalar_ok and mul_scalar_ok and div_scalar_ok and broadcast_add_ok and broadcast_sub_ok and matmul_ok;

    var stdout_buffer: [2048]u8 = undefined;
    var stdout = std.Io.File.stdout().writerStreaming(init.io, &stdout_buffer);
    try stdout.interface.print(
        "{{\"kind\":\"vectra_axiom_cuda_dispatch_smoke\",\"ok\":{},\"add_ok\":{},\"sub_ok\":{},\"mul_ok\":{},\"div_ok\":{},\"add_scalar_ok\":{},\"mul_scalar_ok\":{},\"div_scalar_ok\":{},\"broadcast_add_ok\":{},\"broadcast_sub_ok\":{},\"matmul_ok\":{},\"add0\":{d},\"matmul3\":{d}}}\n",
        .{ ok, add_ok, sub_ok, mul_ok, div_ok, add_scalar_ok, mul_scalar_ok, div_scalar_ok, broadcast_add_ok, broadcast_sub_ok, matmul_ok, add.data[0], matmul.data[3] },
    );
