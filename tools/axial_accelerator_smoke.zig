...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.interface.print(
        "\"pipeline_sync\":{d},\"pipeline_await\":{d},\"pipeline_async_on\":{d},\"pipeline_event\":{d},\"wait_pipeline\":{d},\"context_pipeline\":{d},\"zip_group\":{d},\"zip_join\":{d},\"cuda_unit\":{d},\"cuda_unit_commands\":{d},\"tensor\":{d},\"tensor_creation\":{d},\"tensor_grid_x\":{d},\"tensor_mapped\":{d},\"tensor_mapped_grid_x\":{d},\"partition\":{d},\"partition_grid_x\":{d},\"family_launch\":{d},\"family_variant\":\"{s}\",\"module\":{d},\"module_launch\":{d},\"module_family\":{d},\"typed_module\":{d},\"typed_module_launch\":{d},\"typed_module_async\":{d},\"typed_module_pipeline\":{d},\"typed_module_sync\":{d},\"intrinsics\":{d},\"device_contract\":{d},\"typed_slice\":{d},\"route\":\"{s}\",\"status\":\"{s}\"}}\n",
        .{ pipeline_sync.fingerprint(), pipeline_await.fingerprint(), pipeline_async_on.fingerprint(), pipeline_event.fingerprint(), wait_pipeline.fingerprint(), scheduled_context_pipeline.fingerprint(), scheduled_zip.fingerprint(), zip_join.fingerprint(), cuda_unit.fingerprint(), cuda_unit.commandCount(), tensor.fingerprint(), tensor_creation.fingerprint(), tensor_grid.x, tensor_mapped.fingerprint(), tensor_mapped_grid.x, partition_metadata.fingerprint(), partition_grid.x, family_launch.fingerprint(), family_launch.selection.variant.id, loaded_module.fingerprint(), module_launch.fingerprint(), module_family_launch.fingerprint(), typed_module.fingerprint(), typed_module_launch.fingerprint(), typed_module_async.fingerprint(), typed_module_pipeline.fingerprint(), typed_module_sync.fingerprint(), intrinsics.fingerprint(), device_contract.fingerprint(), typed_slice.fingerprint(), route.route.label(), route.status.label() },
    );
