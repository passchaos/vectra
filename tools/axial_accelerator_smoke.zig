...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.interface.print(
        "\"shared_output\":{d},\"shared_left\":{d},\"shared_right\":{d},\"typed_module_load\":{d},\"typed_module_load_pipeline\":{d},\"intrinsics\":{d},\"device_contract\":{d},\"typed_slice\":{d},\"route\":\"{s}\",\"status\":\"{s}\"}}\n",
        .{ shared_output.fingerprint(), shared_left.fingerprint(), shared_right.fingerprint(), typed_module_load.fingerprint(), typed_module_load_pipeline.fingerprint(), intrinsics.fingerprint(), device_contract.fingerprint(), typed_slice.fingerprint(), route.route.label(), route.status.label() },
    );
