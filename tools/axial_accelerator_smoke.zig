...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.interface.print(
        "{{\"kind\":\"vectra_axial_accelerator_smoke\",\"ok\":{},\"metadata_ok\":{},\"bounds_ok\":{},\"policy_ok\":{},\"cuda_attempted\":{},\"cuda_launched\":{},\"context\":{d},\"allocation\":{d},\"free\":{d},\"alloc_pipeline\":{d},\"registry\":{d},\"wrapped_launch\":{d},\"call_launch\":{d},\"generated_call\":{d},\"lazy_op\":{d},\"lazy_stream\":{d},\"graph\":{d},\"graph_update\":{d},\"graph_scope\":{d},\"graph_ops\":{d},\"pipeline\":{d},\"pipeline_ops\":{d},",
        .{ ok, metadata_ok, bounds_ok, policy_ok, cuda_attempted, cuda_launched, context.fingerprint(), allocation.fingerprint(), free.fingerprint(), allocation_pipeline.fingerprint(), registry.fingerprint(), wrapped_launch.fingerprint(), call_launch.fingerprint(), generated_call.fingerprint(), scheduled_op.fingerprint(), scheduled_op.stream.stream_id, graph_launch.fingerprint(), graph_update.fingerprint(), graph_scoped_capture.fingerprint(), graph_capture.operation_count, replay_pipeline.fingerprint(), replay_pipeline.count },
    );
    try stdout.interface.print(
