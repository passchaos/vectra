...
fn benchType(comptime T: type, init: std.process.Init, options: Options) !void {
    ...
    stdout.print(
        "vectra_matmul_materialize dtype={s} shape={d}x{d}x{d} iters={d} column_ns={} column_gflops={d:.3} clone_materialize_ns={} copy_to_slice_ns={} matmul_ns={} matmul_add_ns={} matmul_add_sqrt_ns={}\n",
        .{
            @typeName(T),
            shape.m,
            shape.n,
