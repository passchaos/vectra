...
pub fn main(init: std.process.Init) !void {
    ...
    const ok_without_stats = if (available)
        report.ok() and roundtrip_ok and copy_ok and shape_ok and fill_ok and elementwise_ok and scalar_ok and unary_ok and f16_elementwise_ok and f16_scalar_ok and f16_unary_ok and f16_matmul_ok and f16_matmul_add_ok and f16_vector_matmul_ok and f16_metric_ok and f16_transpose_ok and f16_broadcast_ok and f16_reduction_ok and f16_softmax_ok and f16_log_softmax_ok and f16_softmin_ok and f16_log_softmin_ok and f16_activation_ok and f16_activation_compose_ok and f16_pow_ok and f16_loss_ok and bf16_elementwise_ok and bf16_scalar_ok and bf16_unary_ok and bf16_matmul_ok and bf16_matmul_add_ok and bf16_vector_matmul_ok and bf16_metric_ok and bf16_transpose_ok and bf16_broadcast_ok and bf16_reduction_ok and bf16_softmax_ok and bf16_log_softmax_ok and bf16_softmin_ok and bf16_log_softmin_ok and bf16_activation_ok and bf16_activation_compose_ok and bf16_pow_ok and bf16_loss_ok and matmul_ok and matmul_add_ok and vector_matmul_ok and metric_ok and transpose_ok and broadcast_ok and reduction_ok and minmax_ok and activation_ok and activation_compose_ok and pow_ok and ternary_ok and loss_ok and softmax_ok and log_softmax_ok and logsumexp_ok and softmin_ok and log_softmin_ok and bytes != 0
    else
    ...
    try stdout.interface.print(
        ",\"roundtrip_ok\":{},\"copy_ok\":{},\"shape_ok\":{},\"fill_ok\":{},\"elementwise_ok\":{},\"scalar_ok\":{},\"unary_ok\":{},\"f16_elementwise_ok\":{},\"f16_scalar_ok\":{},\"f16_unary_ok\":{},\"f16_matmul_ok\":{},\"f16_matmul_add_ok\":{},\"f16_vector_matmul_ok\":{},\"f16_metric_ok\":{},\"f16_transpose_ok\":{},\"f16_broadcast_ok\":{},\"f16_reduction_ok\":{},\"f16_stats_ok\":{},\"f16_softmax_ok\":{},\"f16_log_softmax_ok\":{},\"f16_softmin_ok\":{},\"f16_log_softmin_ok\":{},\"f16_activation_ok\":{},\"f16_activation_compose_ok\":{},\"f16_pow_ok\":{},\"f16_loss_ok\":{}",
        .{ roundtrip_ok, copy_ok, shape_ok, fill_ok, elementwise_ok, scalar_ok, unary_ok, f16_elementwise_ok, f16_scalar_ok, f16_unary_ok, f16_matmul_ok, f16_matmul_add_ok, f16_vector_matmul_ok, f16_metric_ok, f16_transpose_ok, f16_broadcast_ok, f16_reduction_ok, f16_stats_ok, f16_softmax_ok, f16_log_softmax_ok, f16_softmin_ok, f16_log_softmin_ok, f16_activation_ok, f16_activation_compose_ok, f16_pow_ok, f16_loss_ok },
    );
    try stdout.interface.print(
        ",\"bf16_elementwise_ok\":{},\"bf16_scalar_ok\":{},\"bf16_unary_ok\":{},\"bf16_matmul_ok\":{},\"bf16_matmul_add_ok\":{},\"bf16_vector_matmul_ok\":{},\"bf16_metric_ok\":{},\"bf16_transpose_ok\":{},\"bf16_broadcast_ok\":{},\"bf16_reduction_ok\":{},\"bf16_stats_ok\":{},\"bf16_softmax_ok\":{},\"bf16_log_softmax_ok\":{},\"bf16_softmin_ok\":{},\"bf16_log_softmin_ok\":{},\"bf16_activation_ok\":{},\"bf16_activation_compose_ok\":{},\"bf16_pow_ok\":{},\"bf16_loss_ok\":{}",
        .{ bf16_elementwise_ok, bf16_scalar_ok, bf16_unary_ok, bf16_matmul_ok, bf16_matmul_add_ok, bf16_vector_matmul_ok, bf16_metric_ok, bf16_transpose_ok, bf16_broadcast_ok, bf16_reduction_ok, bf16_stats_ok, bf16_softmax_ok, bf16_log_softmax_ok, bf16_softmin_ok, bf16_log_softmin_ok, bf16_activation_ok, bf16_activation_compose_ok, bf16_pow_ok, bf16_loss_ok },
    );
    try stdout.interface.print(
        ",\"matmul_ok\":{},\"matmul_add_ok\":{},\"vector_matmul_ok\":{},\"metric_ok\":{},\"transpose_ok\":{},\"broadcast_ok\":{},\"reduction_ok\":{},\"stats_ok\":{},\"minmax_ok\":{},\"activation_ok\":{},\"activation_compose_ok\":{},\"pow_ok\":{},\"ternary_ok\":{},\"loss_ok\":{},\"softmax_ok\":{},\"log_softmax_ok\":{},\"logsumexp_ok\":{},\"softmin_ok\":{},\"log_softmin_ok\":{}",
        .{ matmul_ok, matmul_add_ok, vector_matmul_ok, metric_ok, transpose_ok, broadcast_ok, reduction_ok, stats_ok, minmax_ok, activation_ok, activation_compose_ok, pow_ok, ternary_ok, loss_ok, softmax_ok, log_softmax_ok, logsumexp_ok, softmin_ok, log_softmin_ok },
    );
    try stdout.interface.print(
