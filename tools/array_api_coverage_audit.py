...
KNOWN_GAPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "reason": "dtype-promotion-smoke checks the full current Vectra DType pair matrix plus representative promoted array, scalar, and reverse-scalar values; exact NumPy/PyTorch scalar edge-case compatibility still needs expansion.",
        "target_layer": "vectra",
    },
    {
        "name": "einsum_and_general_contraction_syntax",
        "reason": "A bounded einsum-smoke exists for common binary contractions, output reordering, implicit output inference, and common unary transpose/reduction/diagonal/trace forms including batched diagonals, same-label binary elementwise/reduction forms, 2D and shared-prefix batched three-operand matrix-chain forms, plus explicit shared-prefix and ellipsis batched matmul, matvec, vecmat, and batched-dot spellings; full NumPy einsum syntax is not covered yet.",
