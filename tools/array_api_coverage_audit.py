...
KNOWN_GAPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "reason": "Axiom supports contiguous/padded row-major f32/f64/f16/BF16 GEMM and matmul-add memrefs plus f32/f64/f16/BF16 transposed/non-row-major GEMM through copy-pack/GEMM/copy-unpack runtime seeds; fused pack/unpack kernels and batched device GEMM layouts still need lowering; negative-stride GEMM enters the same copy-pack/GEMM/copy-unpack runtime route in Axiom.",
        "target_layer": "axiom",
    },
    {
