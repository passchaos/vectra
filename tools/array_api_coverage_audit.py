...
KNOWN_GAPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "reason": "Axiom now owns a real Metal/MPS device, command-queue, shared-buffer storage ABI, and executable f32 2D Metal kernels for elementwise/scalar/unary, matmul, transpose, broadcast-add, reductions, softmax, and logSoftmax covered by axiom-mps-storage-smoke; remaining MPS dtypes/shapes still need runtime parity.",
        "target_layer": "axiom",
    },
    {
