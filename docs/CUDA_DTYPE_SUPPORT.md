...
The CUDA smoke JSON includes `strided_add_ok`, `strided_sub_ok`, `strided_mul_ok`, `strided_div_ok`, `direct_softmax_ok`, `direct_log_softmax_ok`, `f16_add_ok`, `f16_matmul_ok`, `bf16_add_ok`,
