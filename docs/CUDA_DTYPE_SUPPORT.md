...
The CUDA smoke JSON includes `strided_add_ok`, `strided_sub_ok`, `strided_mul_ok`, `strided_div_ok`, `strided_abs_ok`, `strided_sqrt_ok`, `strided_exp_ok`, `strided_memref_legality_fingerprint`, `strided_scalar_memref_legality_fingerprint`, `strided_scalar_add_ok`, `strided_scalar_sub_ok`, `strided_scalar_mul_ok`, `strided_scalar_div_ok`, `f64_strided_add_ok`, `f64_strided_sub_ok`, `f64_strided_mul_ok`, `f64_strided_div_ok`, `f64_strided_abs_ok`, `f64_strided_sqrt_ok`, `f64_strided_exp_ok`, `f64_strided_memref_legality_fingerprint`, `f64_strided_scalar_memref_legality_fingerprint`, `f64_strided_scalar_add_ok`, `f64_strided_scalar_sub_ok`, `f64_strided_scalar_mul_ok`, `f64_strided_scalar_div_ok`, `f16_strided_add_ok`, `f16_strided_sub_ok`, `f16_strided_mul_ok`, `f16_strided_div_ok`, `f16_strided_scalar_add_ok`, `f16_strided_scalar_sub_ok`, `f16_strided_scalar_mul_ok`, `f16_strided_scalar_div_ok`, `bf16_strided_add_ok`, `bf16_strided_sub_ok`, `bf16_strided_mul_ok`, `bf16_strided_div_ok`, `bf16_strided_scalar_add_ok`, `bf16_strided_scalar_sub_ok`, `bf16_strided_scalar_mul_ok`, `bf16_strided_scalar_div_ok`, `direct_softmax_ok`, `direct_log_softmax_ok`, `f16_add_ok`, `f16_matmul_ok`, `bf16_add_ok`,
