...
- `Array(f32)` and `Array(f64)` are native CUDA seed paths; f64 currently covers same-shape/scalar elementwise, neg/abs/reciprocal/square/sqrt/exp, DGEMM matmul, and matmulAdd/fusion.
