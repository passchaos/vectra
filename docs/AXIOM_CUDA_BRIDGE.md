...
- CUDA `Array(f32).neg/abs/reciprocal/square/sqrt/exp/relu/sigmoid/silu` and `Array(f64).neg/abs/reciprocal/square/sqrt/exp` use Axiom device unary/elementwise
  elementwise kernels.
