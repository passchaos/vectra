...
- CUDA `Array(f32).add/sub/mul/div/maximum/minimum/addcmul/addcdiv/lerp/neg/abs/reciprocal/square/sqrt/exp/relu/threshold/leakyRelu/relu6/clip/clipArray/elu/celu/sigmoid/silu/hardsigmoid/hardswish/softsign/softshrink` and `Array(f64).maximum/addcmul/addcdiv/lerp/neg/abs/reciprocal/square/sqrt/exp/relu/threshold/leakyRelu/clip/sigmoid/silu/hardsigmoid/hardswish/softsign` use Axiom device unary/elementwise
