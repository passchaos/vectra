...
plus Frobenius/one/inf/two/nuclear matrix norms, SVD, singular values, matrix rank, and condition number route through Axiom CPU lowering to
...
triangular solve, Frobenius/one/inf/two/nuclear matrix norms, SVD, singular values, matrix rank, and condition number through Axiom
...
- `vx.axiom_cpu.tryMatvecF32/F64`, `tryVecmatF32/F64`, `tryDotF32/F64`,
  ...
  `trySingularValuesF32/F64`, `tryMatrixRankF32/F64`, `tryCondF32/F64` for CPU
  matrix-vector, vector-matrix, dot/vdot, trace, determinant, inverse, solve,
  Cholesky, QR, LU, triangular-solve, Frobenius/one/inf/two/nuclear matrix-norm, SVD, singular-value, matrix-rank, and condition-number
