...
elementwise/scalar/unary (`sqrt/exp/exp2/expm1/log/log1p/log2/log10/square`)/matmul, matrix-vector, vector-matrix, dot/vdot, trace,
...
Supported CPU routes currently cover f32/f64 same-shape add/sub/mul/div, sqrt/exp/exp2/expm1/log/log1p/log2/log10/square, scalar
...
- Automatic Axiom dispatch covers contiguous same-shape elementwise,
  CPU f32/f64 sqrt/exp/exp2/expm1/log/log1p/log2/log10/square, scalar/one-element scalar-broadcast, CPU f32/f64
