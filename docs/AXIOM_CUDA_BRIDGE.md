...
- CUDA `Array(f32).add/sub/mul/div/maximum/minimum/addcmul/addcdiv/lerp/neg/abs/reciprocal/square/sqrt/exp/relu/leakyRelu/relu6/clip/elu/celu/sigmoid/silu/hardsigmoid/hardswish/softsign` and `Array(f64).neg/abs/reciprocal/square/sqrt/exp` use Axiom device unary/elementwise
  elementwise kernels.
