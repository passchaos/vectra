...
plus Frobenius/one/inf matrix norms, SVD, singular values, matrix rank, and condition number route through Axiom CPU lowering to
...
triangular solve, Frobenius/one/inf matrix norms, SVD, singular values, matrix rank, and condition number through Axiom
...
- `vx.axiom_cpu.tryMatvecF32/F64`, `tryVecmatF32/F64`, `tryDotF32/F64`,
  ...
  Cholesky, QR, LU, triangular-solve, Frobenius/one/inf matrix-norm, SVD, singular-value, matrix-rank, and condition-number
