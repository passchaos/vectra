...
contract adapters (`vx.CudaKernelDeviceContract`), and CUDA graph adapters
(`vx.CudaGraphCapture`, `vx.CudaGraphExecutable`) only as adapter conveniences; the host+kernel facade remains owned by Axial and
