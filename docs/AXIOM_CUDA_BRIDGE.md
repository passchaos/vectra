...
broadcast-add, sum/prod/min/max reductions, softmax, and logSoftmax, plus BF16
same-shape elementwise/scalar/abs/square/sqrt/exp, 2D matmul, transpose,
...
- General non-f32/f64/f16/BFloat16 reduction/broadcast/transpose CUDA eager execution, non-f32/f64/general softmax, non-f32/distribution CUDA random creation, and
