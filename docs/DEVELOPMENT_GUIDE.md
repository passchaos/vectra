...
- `rowNnz/columnNnz`、`rowSums/columnSums`、`rowMeans/columnMeans`、`rowAbsSums/columnAbsSums`、`rowNorms/columnNorms`、`mean/oneNorm/infNorm`、`minValue/maxValue/minAbsValue/maxAbsValue`：COO 行列统计、矩阵范数与存储值极值。
...
- `sum/absSum/mean/frobeniusNorm/density`、`minValue/maxValue/minAbsValue/maxAbsValue`：基础 sparse 统计。
- `rowNnz/columnNnz`、`rowSums/columnSums`、`rowMeans/columnMeans`、`rowAbsSums/columnAbsSums`、`rowNorms/columnNorms`、`oneNorm/infNorm`：CSR 行列统计与矩阵范数，f64 路径优先复用 Veyra。
...
- `rowNnz/columnNnz`、`rowSums/columnSums`、`rowMeans/columnMeans`、`rowAbsSums/columnAbsSums`、`rowNorms/columnNorms`、`oneNorm/infNorm`、`density`：CSC 行列统计与矩阵范数。
- `sum/absSum/mean/frobeniusNorm`、`minValue/maxValue/minAbsValue/maxAbsValue`：基础 CSC 统计。
