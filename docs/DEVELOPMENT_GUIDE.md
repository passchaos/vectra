...
- 数学/NN：`neg/negative`、`positive`、`abs/absolute/fabs`、`astype`、promoted mixed-dtype variants（`addPromote/subPromote/mulPromote/divPromote/maximumPromote/minimumPromote`）、`square`、`reciprocal`、`sign/signbit`、`nextAfter/nextafter`、`ldexp`、`frexp`、`exp/exp2/expm1`、`log/log1p/log2/log10`、`sqrt/rsqrt/cbrt`、`floor`、`ceil`、`round`、`trunc`、`deg2rad/radians`、`rad2deg/degrees`、`sinc`、`logit`、`expit`、`sin`、`cos`、`tan`、`asin/arcsin`、`acos/arccos`、`atan/arctan`、`atan2/arctan2`、`hypot`、`copysign`、`heaviside`、`sinh`、`cosh`、`tanh`、`asinh/arcsinh`、`acosh/arccosh`、`atanh/arctanh`、`relu/leakyRelu`、`sigmoid`、`softplus`、`softsign`、`gelu`、`softmax`、`logsumexp`、`logSoftmax/log_softmax`、`clip/clamp`、`clipMin/clipMax/clampMin/clampMax`、`isNan/isnan`、`isInf/isinf`、`isPosInf/isposinf`、`isNegInf/isneginf`、`isFinite/isfinite`。
...
- ArrayView 也支持常用 dtype/逐元素/广播 materializing 包装：`astype`、promoted mixed-dtype variants（`addPromote/subPromote/mulPromote/divPromote/maximumPromote/minimumPromote`）、`neg/negative`、`positive`、`abs/absolute/fabs`、`square`、`reciprocal`、`sign/signbit`、`exp/exp2/expm1`、`log/log1p/log2/log10`、`sqrt/rsqrt/cbrt`、`floor/ceil/round/trunc`、`deg2rad/radians`、`rad2deg/degrees`、`sinc/logit/expit`、三角/双曲函数（含 `arcsin/arccos/arctan/arctan2` 与 `asinh/acosh/atanh/arcsinh/arccosh/arctanh`）、`relu/leakyRelu`、`sigmoid`、`softplus`、`softsign`、`gelu`、`clip`、`clipMin/clipMax/clampMin/clampMax`、`pow/floorDiv/mod/remainder`、`maximum/minimum`、`hypot/atan2`、`logAddExp/logAddExp2/xlogy`、`nextAfter/copysign/heaviside`、advanced scalar variants（`powScalar/floorDivScalar/modScalar/maximumScalar/...`）、`ldexpScalar`、`clipArray`、`isNan/isInf/isFinite`、`isclose/iscloseScalar/allclose/allcloseScalar`、comparison aliases（`equal/greater/less`）、bool `logicalNot/logicalAnd/logicalOr/logicalXor` wrappers。
