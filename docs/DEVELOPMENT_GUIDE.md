...
- 形状：对象/类型方法 `reshape/view`、`reshapeInfer/viewInfer`（单个 `-1` 推断维度）、`flatten/ravel`、`flattenAxes`、`unflatten`、`atLeast1d/atLeast2d/atLeast3d`、`squeeze/unsqueeze`、`transpose`、`matrixTranspose/matrix_transpose/mT`、`adjoint/mH/H_`、`permute`、`swapaxes`、`movedim`、`broadcastTo/expand/expandAs`、`repeat`、`repeatInterleave/repeatInterleaveScalar`、`tile`、`slice/sliceAxis/slice1d`、`split/chunk`、`hstack/vstack/dstack/columnStack`、`flip/flipAxes/fliplr/flipud`、`roll/rollFlat/rollAxes`、`rot90`、`padConstant/padEdge/padReflect/padWrap/padSymmetric`；非复制视图基础包括 `ArrayView/NDArrayView`、`asView`、安全 `asStrided`、PyTorch-like `unfold`、`sliceAxisView/sliceView`、`selectView/narrowView`、`narrowSigned`、`permuteView/transposeView/T_/matrixTranspose/mT/adjoint/swapaxesView/movedimView`、`view/viewInfer`、`broadcastView/expandView`、`atLeast1d/atLeast2d/atLeast3d`、共享存储 mutation 与 `toArray/contiguous` materialization。
