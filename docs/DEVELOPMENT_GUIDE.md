...
- `CsrMatrix.sameStructure()/dotSameStructure()/maxAbsDiffSameStructure()/maxAbsDiffSameStructureMeetsBound()/squaredDistanceSameStructure()/squaredDistanceSameStructureMeetsBound()/frobeniusDistanceSameStructure()/frobeniusDistanceSameStructureMeetsBound()`：CSR 精确压缩结构比较、同结构存储值点积与距离诊断。
...
- `CscMatrix.sameStructure()/dotSameStructure()/maxAbsDiffSameStructure()/maxAbsDiffSameStructureMeetsBound()/squaredDistanceSameStructure()/squaredDistanceSameStructureMeetsBound()/frobeniusDistanceSameStructure()/frobeniusDistanceSameStructureMeetsBound()`：CSC 精确压缩结构比较、同结构存储值点积与距离诊断。
