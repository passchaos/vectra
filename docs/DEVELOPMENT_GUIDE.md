...
- 数学/神经网络常用函数：neg/abs/square/reciprocal/sign、nextAfter/ldexp/frexp、exp/log/log2/log10/sqrt、log1p/expm1、floor/ceil/round/trunc、deg2rad/rad2deg、sinc/logit/expit、三角/反三角/双曲函数、copysign/heaviside、isnan/isinf/isfinite、relu、sigmoid、tanh、softmax、log_softmax、cross_entropy 相关基础。
...
- 数学/NN：`neg`、`abs`、`astype`、promoted mixed-dtype variants（`addPromote/subPromote/mulPromote/divPromote/maximumPromote/minimumPromote`）、`square`、`reciprocal`、`sign/signbit`、`nextAfter/nextafter`、`ldexp`、`frexp`、`exp/expm1`、`log/log1p/log2/log10`、`sqrt`、`floor`、`ceil`、`round`、`trunc`、`deg2rad/rad2deg`、`sinc`、`logit`、`expit`、`sin`、`cos`、`tan`、`asin`、`acos`、`atan`、`atan2`、`hypot`、`copysign`、`heaviside`、`sinh`、`cosh`、`tanh`、`relu/leakyRelu`、`sigmoid`、`softplus`、`softsign`、`gelu`、`softmax`、`logsumexp`、`logSoftmax/log_softmax`、`clip/clamp`、`isNan/isnan`、`isInf/isinf`、`isPosInf/isposinf`、`isNegInf/isneginf`、`isFinite/isfinite`。
