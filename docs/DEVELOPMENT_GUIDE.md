...
- 形状变换：reshape/view、flatten/ravel、squeeze/unsqueeze、transpose/permute/swapaxes/movedim、broadcast、repeat/tile、slice/sliceAxis/slice1d、split/splitWithSizes/splitAtIndices/chunk/unbind、hstack/vstack/dstack/columnStack、flip、roll、padConstant。
