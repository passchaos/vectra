...
- 归约与统计：sum、prod、min、max、mean、var、std、median、quantile/percentile、weighted mean/quantile、cov/corrcoef、nan_to_num 与 nan-aware 统计、argmin、argmax、cumsum、cumprod。
...
- 数学/神经网络常用函数：neg/abs/square/reciprocal/sign、exp/log/log2/log10/sqrt、log1p/expm1、floor/ceil/round/trunc、deg2rad/rad2deg、三角/反三角/双曲函数、copysign/heaviside、isnan/isinf/isfinite、relu、sigmoid、tanh、softmax、log_softmax、cross_entropy 相关基础。
...
- 归约/统计：方法与顶层包装形式的 `sum`、`prod`、`min`、`max`、`allAxis/anyAxis`、`mean`、`variance`、`stddev`、`median`、`quantile`、`percentile`、`weightedMean`、`average`、`weightedQuantile`、`weightedMedian`、`cov`、`corrcoef`、`nanToNum/nan_to_num`、`nansum`、`nanmean`、`nanvar`、`nanstd`、`nanmin`、`nanmax`、`nanmedian`、`nanquantile`、`nanpercentile`、`norm`、`logsumexp`、`cumsum`、`cumprod`、`cumsumAxis/cumprodAxis`、`diff`、`argmin`、`argmax`、`argminAxis/argmaxAxis`。
