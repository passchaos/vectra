...
- `sum/absSum/mean/variance/stddev/sampleVariance/sampleStddev/frobeniusNorm/density`、`minValue/maxValue/minAbsValue/maxAbsValue`、`valueRangeInRange/absValueRangeInRange/valueDynamicRange/valueDynamicRangeMeetsBound`、`nonFiniteCount/allFinite`：基础 sparse 统计、存储值范围与有限性诊断。
...
- `rowNnz/columnNnz`、`averageRowNnz/averageColumnNnz`、`averageRowNnzInRange/averageColumnNnzInRange`、`emptyRowCount/emptyColumnCount`、`emptyRowFraction/emptyColumnFraction`、`emptyRowFractionInRange/emptyColumnFractionInRange`、`minRowNnz/maxRowNnz/minColumnNnz/maxColumnNnz`、`rowNnzRangeInRange/columnNnzRangeInRange`、`rowNnzSpread/columnNnzSpread`、`rowNnzSpreadMeetsBound/columnNnzSpreadMeetsBound`、`rowSums/columnSums`、`rowMeans/columnMeans`、`rowMins/columnMins`、`rowMaxes/columnMaxes`、`rowMinAbs/columnMinAbs`、`rowMaxAbs/columnMaxAbs`（按存储值统计）、`rowVariances/columnVariances`、`rowStddevs/columnStddevs`、`rowSampleVariances/columnSampleVariances`、`rowSampleStddevs/columnSampleStddevs`、`rowAbsSums/columnAbsSums`、`rowNorms/columnNorms`、`rowNonFiniteCounts/columnNonFiniteCounts`、`oneNorm/infNorm`、`density`：CSC 行列统计与矩阵范数。
