...
- `rowNnz/columnNnz`、`rowSums/columnSums`、`rowMeans/columnMeans`、`rowAbsSums/columnAbsSums`、`rowNorms/columnNorms`、`mean/variance/stddev/oneNorm/infNorm`、`minValue/maxValue/minAbsValue/maxAbsValue`：COO 行列统计、矩阵范数与存储值极值。
...
- `sum/absSum/mean/variance/stddev/frobeniusNorm/density`、`minValue/maxValue/minAbsValue/maxAbsValue`：基础 sparse 统计。
