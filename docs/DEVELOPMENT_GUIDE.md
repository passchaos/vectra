...
- 形状变换：reshape/view/reshapeAs/viewAs、flatten/ravel/flattenRange/flattenFrom、squeeze/unsqueeze/squeezeDim/unsqueezeDim、transpose/permute/swapaxes/swapDims/movedim/moveaxis、broadcast、repeat/tile、slice/sliceAxis/slice1d、split/splitWithSizes/splitAtIndices/chunk/unbind、hstack/vstack/dstack/columnStack、flip、roll、padConstant。
