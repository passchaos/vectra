...
- 数学/NN：`neg`、`abs`、`astype`、promoted mixed-dtype variants（`addPromote/subPromote/mulPromote/divPromote/maximumPromote/minimumPromote`）、`square`、`reciprocal`、`sign/signbit`、`nextAfter/nextafter`、`ldexp`、`frexp`、`exp/expm1`、`log/log1p/log2/log10`、`sqrt`、`floor`、`ceil`、`round`、`trunc`、`deg2rad/rad2deg`、`sin`、`cos`、`tan`、`asin`、`acos`、`atan`、`atan2`、`hypot`、`copysign`、`heaviside`、`sinh`、`cosh`、`tanh`、`relu`、`sigmoid`、`softmax`、`logsumexp`、`logSoftmax/log_softmax`、`clip/clamp`、`isNan/isnan`、`isInf/isinf`、`isPosInf/isposinf`、`isNegInf/isneginf`、`isFinite/isfinite`。
