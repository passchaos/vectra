...
- 广播逐元素运算：加减乘除、幂、floorDiv/mod/remainder、hypot/atan2、比较及 scalar 比较、逻辑运算及 scalar 逻辑、where、clip/clamp/clipArray、maximum/minimum。
...
- 广播与逐元素：`add/sub/mul/div/pow`、`floorDiv`、`mod/remainder`、scalar variants、`maximum/minimum`、`hypot`、`atan2`、`whereMask`、`eq/equal`、`ne/notEqual`、`gt/greater`、`ge/greaterEqual`、`lt/less`、`le/lessEqual`、scalar 比较、`logicalNot/logicalAnd/logicalOr/logicalXor`、scalar 逻辑、`allclose`。
