...
- `sum/absSum/mean/variance/stddev/sampleVariance/sampleStddev/frobeniusNorm/density`、`minValue/maxValue/minAbsValue/maxAbsValue`、`nonFiniteCount/allFinite`：基础 sparse 统计与存储值有限性诊断。
...
- `sum/absSum/mean/variance/stddev/sampleVariance/sampleStddev/frobeniusNorm`、`minValue/maxValue/minAbsValue/maxAbsValue`、`nonFiniteCount/allFinite`：基础 CSC 统计与存储值有限性诊断。
