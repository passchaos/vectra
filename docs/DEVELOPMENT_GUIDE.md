...
- `sum/sumInRange/absSum/absSumInRange/mean/meanInRange/variance/varianceInRange/stddev/stddevInRange/sampleVariance/sampleVarianceInRange/sampleStddev/sampleStddevInRange/frobeniusNorm/frobeniusNormMeetsBound/density/densityInRange`、`minValue/minValueIndex/maxValue/maxValueIndex/minAbsValue/minAbsValueIndex/maxAbsValue/maxAbsValueIndex`、`valueRangeInRange/absValueRangeInRange/valueDynamicRange/valueDynamicRangeMeetsBound`、`nonFiniteCount/allFinite`：基础 sparse 统计、存储值范围与有限性诊断。
...
- `sum/sumInRange/absSum/absSumInRange/mean/meanInRange/variance/varianceInRange/stddev/stddevInRange/sampleVariance/sampleVarianceInRange/sampleStddev/sampleStddevInRange/frobeniusNorm/frobeniusNormMeetsBound`、`minValue/minValueIndex/maxValue/maxValueIndex/minAbsValue/minAbsValueIndex/maxAbsValue/maxAbsValueIndex`、`valueRangeInRange/absValueRangeInRange/valueDynamicRange/valueDynamicRangeMeetsBound`、`nonFiniteCount/allFinite`：基础 CSC 统计、存储值范围与有限性诊断。
