...
- `sum/absSum/mean/variance/stddev/sampleVariance/sampleStddev/frobeniusNorm/density/densityInRange`、`minValue/minValueIndex/maxValue/maxValueIndex/minAbsValue/minAbsValueIndex/maxAbsValue/maxAbsValueIndex`、`valueRangeInRange/absValueRangeInRange/valueDynamicRange/valueDynamicRangeMeetsBound`、`nonFiniteCount/allFinite`：基础 sparse 统计、存储值范围与有限性诊断。
...
- `sum/absSum/mean/variance/stddev/sampleVariance/sampleStddev/frobeniusNorm`、`minValue/minValueIndex/maxValue/maxValueIndex/minAbsValue/minAbsValueIndex/maxAbsValue/maxAbsValueIndex`、`valueRangeInRange/absValueRangeInRange/valueDynamicRange/valueDynamicRangeMeetsBound`、`nonFiniteCount/allFinite`：基础 CSC 统计、存储值范围与有限性诊断。
