...
- `CsrMatrix.matvec()`：f64 路径复用 `veyra.csrMatvec`，其它 numeric dtype 保留泛型回退；`matvecResidualNorm/matvecResidualNormMeetsBound/matvecRelativeResidualNorm/matvecRelativeResidualNormMeetsBound` 提供 Ax≈b 诊断。
...
- `rowNnz/columnNnz`、`averageRowNnz/averageColumnNnz`、`averageRowNnzInRange/averageColumnNnzInRange`、`emptyRowCount/emptyColumnCount`、`emptyRowFraction/emptyColumnFraction`、`emptyRowFractionInRange/emptyColumnFractionInRange`、`minRowNnz/maxRowNnz/minColumnNnz/maxColumnNnz`、`rowNnzRangeInRange/columnNnzRangeInRange`、`rowNnzSpread/columnNnzSpread`、`rowNnzSpreadMeetsBound/columnNnzSpreadMeetsBound`、`rowSums/columnSums`、`rowMeans/columnMeans`、`rowMins/columnMins`、`rowMaxes/columnMaxes`、`rowMinAbs/columnMinAbs`、`rowMaxAbs/columnMaxAbs`（按存储值统计）、`rowVariances/columnVariances`、`rowStddevs/columnStddevs`、`rowSampleVariances/columnSampleVariances`、`rowSampleStddevs/columnSampleStddevs`、`rowAbsSums/columnAbsSums`、`rowNorms/columnNorms`、`rowNonFiniteCounts/columnNonFiniteCounts`、`oneNorm/infNorm`：CSR 行列统计与矩阵范数，f64 路径优先复用 Veyra。
- ``：CSR 结构诊断，重复坐标按 dense materialization 语义聚合；`normalizedTrace` 返回 `trace / rows` 的 `f64` 结果；profile 返回 `SparseProfile{ .lower, .upper }`。
- `transposeMatvec/transposeMatmat`：CSR 转置乘法，f64 路径复用 Veyra；`transposeMatvecResidualNorm/transposeMatvecResidualNormMeetsBound/transposeMatvecRelativeResidualNorm/transposeMatvecRelativeResidualNormMeetsBound` 提供 Aᵀx≈b 诊断。
...
- `matvec/matmat`：f64 路径复用 `veyra.cscMatvec/cscMatmat`；`matvecResidualNorm/matvecResidualNormMeetsBound/matvecRelativeResidualNorm/matvecRelativeResidualNormMeetsBound` 提供 Ax≈b 诊断；`matmulSparse()` 支持 CSC×CSC 稀疏矩阵乘法并保持 CSC 输出。
- `transposeMatvec/transposeMatmat`：CSC 转置乘法，f64 路径复用 Veyra；`transposeMatvecResidualNorm/transposeMatvecResidualNormMeetsBound/transposeMatvecRelativeResidualNorm/transposeMatvecRelativeResidualNormMeetsBound` 提供 Aᵀx≈b 诊断。
- `rowNnz/columnNnz`、`averageRowNnz/averageColumnNnz`、`averageRowNnzInRange/averageColumnNnzInRange`、`emptyRowCount/emptyColumnCount`、`emptyRowFraction/emptyColumnFraction`、`emptyRowFractionInRange/emptyColumnFractionInRange`、`minRowNnz/maxRowNnz/minColumnNnz/maxColumnNnz`、`rowNnzRangeInRange/columnNnzRangeInRange`、`rowNnzSpread/columnNnzSpread`、`rowNnzSpreadMeetsBound/columnNnzSpreadMeetsBound`、`rowSums/columnSums`、`rowMeans/columnMeans`、`rowMins/columnMins`、`rowMaxes/columnMaxes`、`rowMinAbs/columnMinAbs`、`rowMaxAbs/columnMaxAbs`（按存储值统计）、`rowVariances/columnVariances`、`rowStddevs/columnStddevs`、`rowSampleVariances/columnSampleVariances`、`rowSampleStddevs/columnSampleStddevs`、`rowAbsSums/columnAbsSums`、`rowNorms/columnNorms`、`rowNonFiniteCounts/columnNonFiniteCounts`、`oneNorm/infNorm`、`density/densityInRange`：CSC 行列统计与矩阵范数。
...
- ``：CSC 结构诊断，重复坐标按 dense materialization 语义聚合；`normalizedTrace` 返回 `trace / rows` 的 `f64` 结果；profile 返回 `SparseProfile{ .lower, .upper }`。
