...
- 归约与统计：sum、prod、min、max、mean、var、std、median、quantile/percentile、weighted mean/var/std/quantile、cov/corrcoef、nan_to_num 与 nan-aware 统计、argmin、argmax、cumsum、cumprod。
